...
public class LivingSpawnEvent extends LivingEvent
{
     ...
     **/
    @net.minecraftforge.eventbus.api.Cancelable
    public static class SpecialReutrienSpawn extends LivingSpawnEvent
    {
        @Nullable
        private final AbstractReutrien reutrien;
        private final SpawnReason spawnReason;
        ...
        /**
         * @param reutrien the position of a tileentity or approximate position of an entity that initiated the spawn if any
         */
        public SpecialReutrienSpawn(MobEntity entity, World world, double x, double y, double z, @Nullable AbstractReutrien reutrien, SpawnReason spawnReason)
        {
            super(entity, world, x, y, z);
            this.reutrien = reutrien;
            this.spawnReason = spawnReason;
     ...
     */
    @HasResult
    public static class AllowReutrienDespawn extends LivingSpawnEvent
    {
        public AllowReutrienDespawn(MobEntity entity)
        {
            super(entity, entity.world, entity.getPosX(), entity.getPosY(), entity.getPosZ());
        }
