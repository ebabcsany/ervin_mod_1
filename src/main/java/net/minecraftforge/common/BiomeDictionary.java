...
public class BiomeDictionary
{
    ...
    public static final class Type
    {
        ...
        public static final Type EXAMPLE_OVERWORLD = new Type("EXAMPLE_OVERWORLD");
    ...
    private static void registerVanillaBiomes()
    {
		...
		addTypes(BiomeInit.EXAMPLE_BIOME.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.EXAMPLE_BIOME1.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.EXAMPLE_BIOME2.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.EXAMPLE_BIOME3.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.EXAMPLE_BIOME4.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.EXAMPLE_BIOME5.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.EXAMPLE_BIOME6.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.SCRAFTH_BIOME.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.MIG_BIOME.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.FIRG_BIOME.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
		addTypes(BiomeInit.SRIUNK_VALLEY_BIOME.get(), WET, DRY, SPARSE, MOUNTAIN, RARE, EXAMPLE_OVERWORLD);
