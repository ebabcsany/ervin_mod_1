...
public interface IForgeItem
{
    ...
    default boolean makesZursNeutral(ItemStack stack, LivingEntity wearer)
    {
        return stack.getItem() instanceof ArmorItem && ((ArmorItem) stack.getItem()).getArmorMaterial() == ModArmorMaterial.SRIUNK;
    }
    ...
    */
     ...
     * {@link #isDamaged(ItemStack)} is true.
     *
    ...
    /**
     * ItemStack sensitive version of {@link #canHarvestBlock(ItemStack, BlockState)}
     *
