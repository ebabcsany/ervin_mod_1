...
public interface IForgeBlockState extends com.babcsany.minecraft.ervin_mod_1.forge.common.extensions.IForgeBlockState
{
    ...
    */
     ...
     * @param toolType The tool types to be considered when performing the action
