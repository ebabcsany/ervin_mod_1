...
public class NetherPortalBlock extends Block {
   ...
   public static boolean trySpawnPortal(IWorld world, BlockPos worldIn) {
      Size netherportalblock$size = isPortal(world, worldIn);
   ...
   public static Size isPortal(IWorld world, BlockPos worldIn) {
      ...
      if (netherportalblock$size.isValid() && netherportalblock$size.portalBlockCount == 0) {
         ...
         Size netherportalblock$size1 = new Size(world, worldIn, Direction.Axis.Z);
   ...
   public static class Size {
      ...
      protected int calculatePortalHeight() {
         label56:
         for(this.height = 0; this.height < 310; ++this.height) {
         ...
         if (this.height <= 310 && this.height >= 3) {
            return this.height;
         } else {
            this.bottomLeft = null;
            this.width = 0;
      ...
      public boolean isValid() {
         return this.bottomLeft != null && this.width >= 2 && this.width <= 310 && this.height >= 3 && this.height <= 310;
      }
