...
public class ComposterBlock extends Block implements ISidedInventoryProvider {
   ...
   public static void init() {
      ...
      registerCompostable(0.3F, ItemInit.TARG_SEEDS.get());
      ...
      registerCompostable(0.65F, ItemInit.TARG.get());
      ...
      registerCompostable(1.0F, ItemInit.FIRG.get());
      registerCompostable(1.0F, ItemInit.FRIM.get());
      registerCompostable(1.25F, ItemInit.CHAK.get());
   }
