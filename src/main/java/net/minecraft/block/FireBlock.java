...
public class FireBlock extends AbstractFireBlock {
   ...
   protected boolean canDie(iorld worldIn, BlockPos pos) {
   ...
   private void tryCatchFire(iorld worldIn, BlockPos pos, int chance, Random random, int age, Direction face) {
