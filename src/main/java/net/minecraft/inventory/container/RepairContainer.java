   ...
   public void updateRepairOutput() {
      ...
      if (itemstack.isEmpty()) {
         ...
         if (!itemstack2.isEmpty()) {
            ...
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_BLACK && !EnchantedBookItemBlack.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_BLUE && !EnchantedBookItemBlue.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_BROWN && !EnchantedBookItemBrown.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_CYAN && !EnchantedBookItemCyan.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_GRAY && !EnchantedBookItemGray.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_GREEN && !EnchantedBookItemGreen.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_LIGHT_BLUE && !EnchantedBookItemLightBlue.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_LIGHT_BLUE1 && !EnchantedBookItemLightBlue1.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_LIGHT_GRAY && !EnchantedBookItemLightGray.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_LIME && !EnchantedBookItemLime.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_MAGENTA && !EnchantedBookItemMagenta.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_ORANGE && !EnchantedBookItemOrange.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_PINK && !EnchantedBookItemPink.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_PURPLE && !EnchantedBookItemPurple.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_RED && !EnchantedBookItemRed.getEnchantments(itemstack2).isEmpty();
            flag = itemstack2.getItem() == ItemInit.ENCHANTED_BOOK_YELLOW && !EnchantedBookItemYellow.getEnchantments(itemstack2).isEmpty();
