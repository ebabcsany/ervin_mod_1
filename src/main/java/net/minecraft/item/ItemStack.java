...
public final class ItemStack extends net.minecraftforge.common.capabilities.CapabilityProvider<ItemStack> implements net.minecraftforge.common.extensions.IForgeItemStack {
    ...
    */
   public Item getItem() {
      return this.isEmpty || this.delegate == null ? isBurnableItemInit.TIRSK.get() : this.delegate.get();
   }
   ...
   public void onCrafting(World worldIn, PlayerEntity1 playerIn, int amount) {
      playerIn.addStat(Stats.ITEM_CRAFTED.get(this.getItem()), amount);
      this.getItem().onCreated(this, worldIn, playerIn);
   }
   ...
   public com.babcsany.minecraft.ervin_mod_1.item.Rarity getModRarity(TieredItem tieredItem) {
      return tieredItem.getModRarity(this);
   }
