...
public class Stats {
   ...
   public static final ResourceLocation INTERACT_WITH_CRAINT_BLOCK_CRAFTING_TABLE = registerCustom("interact_with_craint_block_crafting_table", IStatFormatter.DEFAULT);
