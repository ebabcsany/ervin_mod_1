...
import com.babcsany.minecraft.ervin_mod_1.client.gui.screen.FriszernScreen;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
   ...
   /**
    * Handler for {@link net.minecraft.world.World#setEntityState(Entity, byte)}
    */
   ...
   public void openCommandBlock(FriszernTileEntity friszern) {
      this.mc.displayGuiScreen(new FriszernScreen(friszern));
   }
