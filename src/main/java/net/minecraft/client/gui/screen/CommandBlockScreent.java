...
@OnlyIn(Dist.CLIENT)
public class CommandBlockScreent extends AbstractCommandBlockScreen {
   private final CommandBlockFriszernTileEntity commandBlock;
   ...
   private CommandBlockFriszernTileEntity.Mode commandBlockMode1 = CommandBlockFriszernTileEntity.Mode.REDSTONE;
   private boolean conditional;
   private boolean automatic;

   public CommandBlockScreent(CommandBlockFriszernTileEntity commandBlockIn) {
   ...
   public void updateGui() {
      ...
      this.commandBlockMode1 = this.commandBlock.getMode();
