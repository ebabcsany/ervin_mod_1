...
public class Biome extends net.minecraftforge.registries.ForgeRegistryEntry<Biome> {
   ...
   public static final Codec<Biome> field_235051_b_ = RecordCodecBuilder.create((p_235064_0_) -> {
      return p_235064_0_.group(RainType.RAIN_TYPE_CODEC.fieldOf("precipitation").forGetter((p_235088_0_) -> {
         return p_235088_0_.precipitation;
      }), Category.field_235102_r_.fieldOf("category").forGetter((p_235087_0_) -> {
      ...
      }), Codec.simpleMap(EntityClassification.CLASSIFICATION_CODEC, SpawnListEntry.SPAWN_LIST_ENTRY_CODEC.listOf().promotePartial(Util.func_240982_a_("Spawn data: ", LOGGER::error)), IStringSerializable.createKeyable(EntityClassification.values())).fieldOf("spawners").forGetter((p_235073_0_) -> {
         return p_235073_0_.spawns;
      }), Attributes.field_235104_a_.listOf().fieldOf("climate_parameters").forGetter((p_235070_0_) -> {
   ...
   private final Map<EntityClassification, List<SpawnListEntry>> spawns;
   ...
   protected Biome(Builder biomeBuilder) {
      if (biomeBuilder.surfaceBuilder != null && biomeBuilder.precipitation != null && biomeBuilder.category != null && biomeBuilder.depth != null && biomeBuilder.scale != null && biomeBuilder.temperature != null && biomeBuilder.downfall != null && biomeBuilder.field_235096_j_ != null) {
         ...
         this.field_235054_x_ = (List<Attributes>)(biomeBuilder.field_235095_i_ != null ? biomeBuilder.field_235095_i_ : ImmutableList.of());
   ...
   public static class Attributes {
      public static final Codec<Attributes> field_235104_a_ = RecordCodecBuilder.create((p_235111_0_) -> {
         ...
         })).apply(p_235111_0_, Attributes::new);
      });
   ...
   public static class Builder {
      ...
      public <SC extends ISurfaceBuilderConfig> Builder surfaceBuilder(SurfaceBuilder<SC> surfaceBuilderIn, SC surfaceBuilderConfigIn) {
         this.surfaceBuilder = new ConfiguredSurfaceBuilder<>(surfaceBuilderIn, surfaceBuilderConfigIn);
         return this;
      }

      public Builder surfaceBuilder(ConfiguredSurfaceBuilder<?> surfaceBuilderIn) {
      ...
      public Builder parent(@Nullable String parentIn) {
   ...
   public static enum Category implements IStringSerializable {
      ...
      public static final Codec<Category> field_235102_r_ = IStringSerializable.createEnumCodec(Category::values, Category::func_235103_a_);
      private static final Map<String, Category> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Category::getName, (p_222353_0_) -> {
         return p_222353_0_;
      }));
   ...
   public static enum RainType implements IStringSerializable {
      ...
      public static final Codec<RainType> RAIN_TYPE_CODEC = IStringSerializable.createEnumCodec(RainType::values, RainType::getRainType);
      private static final Map<String, RainType> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(RainType::getName, (p_222360_0_) -> {
         return p_222360_0_;
      }));
      private final String name;
