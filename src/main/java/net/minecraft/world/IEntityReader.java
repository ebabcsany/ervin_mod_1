...
public interface IEntityReader {
   ...
   @Nullable
   default <T extends Entity> T func_225318_c(Class<? extends T> p_225318_1_, EntityPredicate p_225318_2_, @Nullable LivingEntity p_225318_3_, double p_225318_4_, double p_225318_6_, double p_225318_8_, AxisAlignedBB p_225318_10_) {
      return this.getClosestEntity1(this.getLoadedEntitiesWithinAABB(p_225318_1_, p_225318_10_, (Predicate<? super T>)null), p_225318_2_, p_225318_3_, p_225318_4_, p_225318_6_, p_225318_8_);
   }
   ...
   @Nullable
   default <T extends Entity> T getClosestEntity1(List<? extends T> entities, EntityPredicate predicate, @Nullable LivingEntity target, double x, double y, double z) {
      double d0 = -1.0D;
      T t = null;
