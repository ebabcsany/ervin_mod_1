...
public final class BambooJungleHillsBiome extends Biome {
   public BambooJungleHillsBiome() {
      super((new Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(RainType.RAIN).category(Category.JUNGLE).depth(0.45F).scale(0.3F).temperature(0.95F).downfall(0.9F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).parent((String)null).func_235098_a_(ImmutableList.of(new Attributes(0.5F, 0.5F, 0.25F, 0.2F, 1.0F))));
      ...
      this.addSpawn(EntityClassification.CREATURE, new SpawnListEntry(EntityType.PARROT, 10, 1, 1));
