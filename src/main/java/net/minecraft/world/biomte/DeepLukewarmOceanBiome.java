...
public class DeepLukewarmOceanBiome extends Biome {
   public DeepLukewarmOceanBiome() {
      ...
      this.addSpawn(EntityClassification.WATER_CREATURE, new SpawnListEntry(EntityType.SQUID, 8, 1, 4));
      this.addSpawn(EntityClassification.WATER_AMBIENT, new SpawnListEntry(EntityType.COD, 8, 3, 6));
