...
public final class ModifiedBadlandsPlateauBiome extends Biome {
   public ModifiedBadlandsPlateauBiome() {
      super((new Builder()).surfaceBuilder(SurfaceBuilder.BADLANDS, SurfaceBuilder.RED_SAND_WHITE_TERRACOTTA_GRAVEL_CONFIG).precipitation(RainType.NONE).category(Category.MESA).depth(0.45F).scale(0.3F).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).parent("badlands_plateau"));
