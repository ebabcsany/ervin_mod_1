...
public final class ModifiedJungleEdgeBiome extends Biome {
   public ModifiedJungleEdgeBiome() {
      super((new Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(RainType.RAIN).category(Category.JUNGLE).depth(0.2F).scale(0.4F).temperature(0.95F).downfall(0.8F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).parent("jungle_edge"));
