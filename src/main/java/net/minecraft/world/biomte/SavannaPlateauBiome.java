...
public final class SavannaPlateauBiome extends Biome {
   protected SavannaPlateauBiome() {
      ...
      this.addSpawn(EntityClassification.CREATURE, new SpawnListEntry(EntityType.LLAMA, 8, 4, 4));
