...
public class Brain<E extends LivingEntity> {
   ...
   private final Map<Integer, Map<Activity, Set<com.babcsany.minecraft.ervin_mod_1.entity.ai.brain.task.Task<? super E>>>> field_218232_c_ = Maps.newTreeMap();
   ...
   public static <E extends LivingEntity> BrainCodec<E> func_233705_a_(Collection<? extends MemoryModuleType<?>> p_233705_0_, Collection<? extends SensorType<? extends Sensor<? super E>>> p_233705_1_) {
      return new BrainCodec<>(p_233705_0_, p_233705_1_);
   }
      ...
      mutableobject.setValue((new MapCodec<Brain<E>>() {
         ...
         public <T> DataResult<Brain<E>> decode(DynamicOps<T> p_decode_1_, MapLike<T> p_decode_2_) {
            ...
            p_decode_2_.entries().forEach((p_233732_3_) -> {
               ...
               DataResult<? extends MemoryCodec<?>> dataresult1 = dataresult.flatMap((p_233729_3_) -> {
            ...
            ImmutableList<MemoryCodec<?>> immutablelist = mutableobject1.getValue().resultOrPartial(Brain.field_233688_a_::error).map(Builder::build).orElseGet(ImmutableList::of);
            return DataResult.success(new Brain<>(p_233710_0_, p_233710_1_, immutablelist, mutableobject::getValue));
         }

         private <T, U> DataResult<MemoryCodec<U>> func_233728_a_(MemoryModuleType<U> p_233728_1_, DynamicOps<T> p_233728_2_, T p_233728_3_) {
            return p_233728_1_.getMemoryCodec().map(DataResult::success).orElseGet(() -> {
               ...
               return new MemoryCodec<>(p_233728_1_, Optional.of(p_233726_1_));
            });
         }
   ...
   public Brain(Collection<? extends MemoryModuleType<?>> p_i231494_1_, Collection<? extends SensorType<? extends Sensor<? super E>>> p_i231494_2_, ImmutableList<MemoryCodec<?>> p_i231494_3_, Supplier<Codec<Brain<E>>> p_i231494_4_) {
      ...
      for(MemoryCodec<?> memorycodec : p_i231494_3_) {
   ...
   private Stream<MemoryCodec<?>> func_233720_j_() {
      return this.memories.entrySet().stream().map((p_233707_0_) -> {
         return MemoryCodec.func_233743_b_(p_233707_0_.getKey(), p_233707_0_.getValue());
      });
   }
   ...
   private void func_233701_a_1(Activity p_233701_1_, ImmutableList<? extends Pair<Integer, ? extends com.babcsany.minecraft.ervin_mod_1.entity.ai.brain.task.Task<? super E>>> p_233701_2_, Set<Pair<MemoryModuleType<?>, MemoryModuleStatus>> p_233701_3_, Set<MemoryModuleType<?>> p_233701_4_) {
      ...
      for(Pair<Integer, ? extends com.babcsany.minecraft.ervin_mod_1.entity.ai.brain.task.Task<? super E>> pair : p_233701_2_) {
         this.field_218232_c_.computeIfAbsent(pair.getFirst(), (p_233703_0_) -> Maps.newHashMap()).computeIfAbsent(p_233701_1_, (p_233717_0_) -> Sets.newLinkedHashSet()).add(pair.getSecond());
      }
   ...
   ImmutableList<? extends Pair<Integer, ? extends com.babcsany.minecraft.ervin_mod_1.entity.ai.brain.task.Task<? super E>>> func_233692_a_1(int p_233692_1_, ImmutableList<? extends com.babcsany.minecraft.ervin_mod_1.entity.ai.brain.task.Task<? super E>> p_233692_2_) {
      int i = p_233692_1_;
      Builder<Pair<Integer, ? extends com.babcsany.minecraft.ervin_mod_1.entity.ai.brain.task.Task<? super E>>> builder = ImmutableList.builder();
   ...
   public static final class MemoryCodec<U> {
      ...
      private static <U> MemoryCodec<U> func_233743_b_(MemoryModuleType<U> p_233743_0_, Optional<? extends Memory<?>> p_233743_1_) {
         return new MemoryCodec<>(p_233743_0_, (Optional<? extends Memory<U>>) p_233743_1_);
      }
