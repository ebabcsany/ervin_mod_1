...
public abstract class Entity extends net.minecraftforge.common.capabilities.CapabilityProvider<Entity> implements INameable, ICommandSource, net.minecraftforge.common.extensions.IForgeEntity {
    ...
    *  
    * For general purposes, use {@link #getWidth()} and {@link #getHeight()}.
    *  
    ...
    * CommandBlockMinecartEntity#ignoreItemEntityData()} () command block minecarts} and {@link
    * SpawnerMinecartEntity#ignoreItemEntityData()} () mob spawner minecarts} (spawning command
   ...
   /**
    * Directly updates the {@link #getPosX()}, {@link #getPosY()}, and {@link #getPosZ()} fields, without performing any collision
