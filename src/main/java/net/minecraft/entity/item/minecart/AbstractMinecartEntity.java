...
public abstract class AbstractMinecartEntity extends Entity implements net.minecraftforge.common.extensions.IForgeEntityMinecart {
   ...
   protected AbstractMinecartEntity(EntityType<?> type, iorld worldIn) {
      super(type, worldIn);
      this.preventEntitySpawning = true;
   }

   protected AbstractMinecartEntity(EntityType<?> type, iorld worldIn, double posX, double posY, double posZ) {
      this(type, worldIn);
   ...
   public static AbstractMinecartEntity create(iorld worldIn, double x, double y, double z, Type typeIn) {
   ...
   public void tick() {
      ...
      if (this.world.isRemote) {
         ...
         if (canUseRail() && AbstractRailBlock.isRail(blockstate)) {
            ...
            if (blockstate.getBlock() instanceof com.babcsany.minecraft.ervin_mod_1.block.PoweredRailBlock && ((com.babcsany.minecraft.ervin_mod_1.block.PoweredRailBlock) blockstate.getBlock()).isActivatorRail()) {
               this.onActivatorRailPass(i, j, k, blockstate.get(com.babcsany.minecraft.ervin_mod_1.block.PoweredRailBlock.POWERED));
            }
         } else {
   ...
   protected void moveAlongTrack(BlockPos pos, BlockState state) {
      ...
      if (abstractrailblock instanceof com.babcsany.minecraft.ervin_mod_1.block.PoweredRailBlock && !((com.babcsany.minecraft.ervin_mod_1.block.PoweredRailBlock) abstractrailblock).isActivatorRail()) {
         flag = state.get(com.babcsany.minecraft.ervin_mod_1.block.PoweredRailBlock.POWERED);
         flag1 = !flag;
      }
