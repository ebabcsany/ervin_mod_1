...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public static Optional<Vector3d> func_234567_a_(ServerWorld p_234567_0_, BlockPos p_234567_1_, boolean p_234567_2_, boolean p_234567_3_) {
      ...
      if (block instanceof RespawnAnchorBlock && blockstate.get(RespawnAnchorBlock.CHARGES) > 0 && RespawnAnchorBlock.doesRespawnAnchorWork(p_234567_0_)) {
         ...
         if (!p_234567_3_ && optional.isPresent()) {
            p_234567_0_.setBlockState(p_234567_1_, blockstate.with(RespawnAnchorBlock.CHARGES, blockstate.get(RespawnAnchorBlock.CHARGES) - 1), 3);
         }
   ...
   public static Optional<Vector3d> func_234567_b_(ServerWorld p_234567_0_, BlockPos p_234567_1_, boolean p_234567_2_, boolean p_234567_3_) {
      BlockState blockstate = p_234567_0_.getBlockState(p_234567_1_);
      Block block = blockstate.getBlock();
      if (block instanceof Hurvruj && blockstate.get(Hurvruj.CHARGES) > 0 && Hurvruj.doesHurvrujWork(p_234567_0_)) {
         ...
         if (!p_234567_3_ && optional.isPresent()) {
            p_234567_0_.setBlockState(p_234567_1_, blockstate.with(RespawnAnchorBlock.CHARGES, blockstate.get(Hurvruj.CHARGES) - 1), 15);
         }
