...
public abstract class LivingEntity extends Entity {
   ...
   protected LivingEntity(EntityType<? extends LivingEntity> type, iorld worldIn) {
      super(type, worldIn);
   ...
   protected void onDeathUpdate() {
      ...
      if (this.deathTime == 20) {
         this.remove(this instanceof ServerPlayerEntity); //Forge keep data until we revive player
   ...
   public ItemStack onFoodEaten(iorld p_213357_1_, ItemStack p_213357_2_) {
   ...
   private void applyFoodEffects(ItemStack p_213349_1_, iorld p_213349_2_, LivingEntity p_213349_3_) {
