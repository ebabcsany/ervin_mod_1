...
public abstract class TileEntity extends net.minecraftforge.common.capabilities.CapabilityProvider<TileEntity> implements net.minecraftforge.common.extensions.IForgeTileEntity {
    ...
    * many blocks change at once. This compound comes back to you clientside in {@link //tandleUpdateTag}
    */
   ...
   /**
    * See {@link net.minecraft.block.Block#eventReceived} for more information. This must return true serverside before it is called
    * clientside.
    */
