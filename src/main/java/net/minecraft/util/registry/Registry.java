...
public abstract class Registry<T> implements Codec<T>, Keyable, IObjectIntIterable<T> {
   ...
   public static final RegistryKey<Registry<iorld>> WORLD_KEY = createKey("dimension");
   ...
   public static <T> DefaultedRegistry<T> registerDefaulted(RegistryKey<Registry<T>> registryKey, String defaultedValueKey, Supplier<T> supplier) {
   ...
   public static <T extends net.minecraftforge.registries.IForgeRegistryEntry<T>> Registry<T> forge(RegistryKey<Registry<T>> key, Class<? super T> cls, Supplier<T> def) {
      return func_239743_a_(key, net.minecraftforge.registries.GameData.<T>getWrapper(cls), def);
   }

   public static <T extends net.minecraftforge.registries.IForgeRegistryEntry<T>> DefaultedRegistry<T> forgeDefaulted(RegistryKey<Registry<T>> key, Class<? super T> cls, Supplier<T> def) {
