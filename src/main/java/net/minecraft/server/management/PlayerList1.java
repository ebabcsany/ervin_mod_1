...
public abstract class PlayerList1 extends PlayerList {
    ...
    public PlayerList1(MinecraftServer p_i231425_1_, DynamicRegistries.Impl p_i231425_2_, PlayerData p_i231425_3_, int p_i231425_4_) {
    ...
    public void func_212504_a(ServerWorld p_212504_1_) {
        p_212504_1_.getWorldBorder().addListener(new IBorderListener() {
            public void onSizeChanged(WorldBorder border, double newSize) {
                PlayerList1.this.sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.SET_SIZE));
            }

            public void onTransitionStarted(WorldBorder border, double oldSize, double newSize, long time) {
                PlayerList1.this.sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.LERP_SIZE));
            }

            public void onCenterChanged(WorldBorder border, double x, double z) {
                PlayerList1.this.sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.SET_CENTER));
            }

            public void onWarningTimeChanged(WorldBorder border, int newTime) {
                PlayerList1.this.sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.SET_WARNING_TIME));
            }

            public void onWarningDistanceChanged(WorldBorder border, int newDistance) {
                PlayerList1.this.sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.SET_WARNING_BLOCKS));
            }
    ...
    protected void setPlayerGameTypeBasedOnOther(ServerPlayerEntity target, @Nullable ServerPlayerEntity source, ServerWorld worldIn) {
        if (source != null) {
    ...
    protected void putUUIDToPlayerMap(UUID playerUUID, ServerPlayerEntity entityIn) {
        this.uuidToPlayerMap.put(playerUUID, entityIn);
    }
