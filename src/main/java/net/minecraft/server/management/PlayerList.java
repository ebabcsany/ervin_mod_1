...
import com.babcsany.minecraft.ervin_mod_1.entity.player.ServerPlayerEntity1;
...
public abstract class PlayerList {
   ...
   public ServerStatisticsManager getPlayerStats(PlayerEntity1 playerIn) {
      UUID uuid = playerIn.getUniqueID();
      ServerStatisticsManager serverstatisticsmanager = uuid == null ? null : this.playerStatFiles.get(uuid);
      if (serverstatisticsmanager == null) {
         File file1 = this.server.func_240776_a_(FolderName.field_237246_b_).toFile();
   ...
   public PlayerAdvancements getPlayerAdvancements(ServerPlayerEntity1 p_192054_1_) {
      UUID uuid = p_192054_1_.getUniqueID();
      PlayerAdvancements playeradvancements = this.advancements.get(uuid);
      if (playeradvancements == null) {
         File file1 = this.server.func_240776_a_(FolderName.field_237245_a_).toFile();
