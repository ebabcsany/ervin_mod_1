...
public class BredDgrurbAnimalsTrigger extends AbstractCriterionTrigger<BredDgrurbAnimalsTrigger.Instance> {
   private static final ResourceLocation ID = new ResourceLocation("ervin_mod_1:bred_dgrurb_animals");
   ...
   public void trigger(ServerPlayerEntity player, AnimalDgrurbEntity parent1, AnimalDgrurbEntity parent2, @Nullable DgrurbAgeableEntity child) {
   ...
   public static class Instance extends CriterionInstance {
      ...
      public Instance(EntityPredicate.AndPredicate player, EntityPredicate.AndPredicate parent, EntityPredicate.AndPredicate partner, EntityPredicate.AndPredicate child) {
         super(BredDgrurbAnimalsTrigger.ID, player);
         this.parent = parent;
