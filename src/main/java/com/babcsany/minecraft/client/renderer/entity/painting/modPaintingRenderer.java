package com.babcsany.minecraft.client.renderer.entity.painting;
...
@OnlyIn(Dist.CLIENT)
public class modPaintingRenderer extends EntityRenderer<modPainting_Entity> {
   public modPaintingRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn);
   }

   public void render(modPainting_Entity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
      matrixStackIn.rotate(Vector3f.YP.rotationDegrees(180.0F - entityYaw));
      modPainting_Type paintingtype = entityIn.art;
      float f = 0.0625F;
      ...
      modPaintingSpriteUploader paintingspriteuploader = Minecraft.getModInstance().getModPaintingSpriteUploader();
    ...
    */
   public ResourceLocation getEntityTexture(modPainting_Entity entity) {
      return Minecraft.getModInstance().getModPaintingSpriteUploader().getBackSprite().getAtlasTexture().getTextureLocation();
   }

   private void func_229122_a_(MatrixStack p_229122_1_, IVertexBuilder p_229122_2_, modPainting_Entity p_229122_3_, int p_229122_4_, int p_229122_5_, TextureAtlasSprite p_229122_6_, TextureAtlasSprite p_229122_7_) {
