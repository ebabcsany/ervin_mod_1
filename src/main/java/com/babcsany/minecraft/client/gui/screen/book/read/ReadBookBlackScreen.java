package com.babcsany.minecraft.client.gui.screen.book.read;
...
@OnlyIn(Dist.CLIENT)
public class ReadBookBlackScreen extends Screen {
   public static final ReadBookBlackScreen.IBookInfo EMPTY_BOOK = new ReadBookBlackScreen.IBookInfo() {
      /**
   ...
   public static final ResourceLocation BOOK_TEXTURES = new ResourceLocation(Ervin_mod_1.MOD_ID,"textures/gui/book/paper/black.png");
   private ReadBookBlackScreen.IBookInfo bookInfo;
   ...
   public ReadBookBlackScreen(ReadBookBlackScreen.IBookInfo bookInfoIn) {
      this(bookInfoIn, true);
   }

   public ReadBookBlackScreen() {
      this(EMPTY_BOOK, false);
   }

   private ReadBookBlackScreen(ReadBookBlackScreen.IBookInfo bookInfoIn, boolean pageTurnSoundsIn) {
      super(NarratorChatListener.EMPTY);
      this.bookInfo = bookInfoIn;
      this.pageTurnSounds = pageTurnSoundsIn;
   }

   public void func_214155_a(ReadBookBlackScreen.IBookInfo p_214155_1_) {
   ...
   public interface IBookInfo {
      ...
      static ReadBookBlackScreen.IBookInfo func_216917_a(ItemStack p_216917_0_) {
         Item item = p_216917_0_.getItem();
         if (item == Items.WRITTEN_BOOK) {
            return new ReadBookBlackScreen.WrittenBookInfo(p_216917_0_);
         } else {
            return (ReadBookBlackScreen.IBookInfo)(item == Items.WRITABLE_BOOK ? new ReadBookBlackScreen.UnwrittenBookInfo(p_216917_0_) : ReadBookBlackScreen.EMPTY_BOOK);
         }
      }
   }

   @OnlyIn(Dist.CLIENT)
   public static class UnwrittenBookInfo implements ReadBookBlackScreen.IBookInfo {
      ...
      private static List<String> func_216919_b(ItemStack p_216919_0_) {
         ...
         return (List<String>)(compoundnbt != null ? ReadBookBlackScreen.nbtPagesToStrings(compoundnbt) : ImmutableList.of());
      }
   ...
   @OnlyIn(Dist.CLIENT)
   public static class WrittenBookInfo implements ReadBookBlackScreen.IBookInfo {
      private final List<String> pages;
