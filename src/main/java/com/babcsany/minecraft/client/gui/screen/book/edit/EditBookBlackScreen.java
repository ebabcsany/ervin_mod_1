package com.babcsany.minecraft.client.gui.screen.book.edit;

import com.babcsany.minecraft.client.gui.screen.book.read.ReadBookBlackScreen;
...
@OnlyIn(Dist.CLIENT)
public class EditBookBlackScreen extends Screen {
   ...
   @Nullable
   private EditBookBlackScreen.BookPage field_238747_F_ = EditBookBlackScreen.BookPage.field_238779_a_;

   public EditBookBlackScreen(PlayerEntity player, ItemStack bookIn, Hand handIn) {
   ...
   private void func_238778_z_() {
      EditBookBlackScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();
      int i = this.field_238748_u_.getEndIndex();
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.minecraft.getTextureManager().bindTexture(ReadBookBlackScreen.BOOK_TEXTURES);
      int i = (this.width - 192) / 2;
      int j = 2;
      ...
      if (this.bookGettingSigned) {
         ...
         for(EditBookBlackScreen.BookLine editbookscreen$bookline : editbookscreen$bookpage.field_238784_f_) {
   ...
   private void func_238756_a_(MatrixStack p_238756_1_, EditBookBlackScreen.Point p_238756_2_, boolean p_238756_3_) {
      if (this.updateCount / 6 % 2 == 0) {
   ...
   private EditBookBlackScreen.Point func_238758_a_(EditBookBlackScreen.Point p_238758_1_) {
      return new EditBookBlackScreen.Point(p_238758_1_.x - (this.width - 192) / 2 - 36, p_238758_1_.y - 32);
   }

   private EditBookBlackScreen.Point func_238767_b_(EditBookBlackScreen.Point p_238767_1_) {
      return new EditBookBlackScreen.Point(p_238767_1_.x + (this.width - 192) / 2 + 36, p_238767_1_.y + 32);
   }
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      if (super.mouseClicked(mouseX, mouseY, p_231044_5_)) {
         ...
         if (p_231044_5_ == 0) {
            ...
            EditBookBlackScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();
            int j = editbookscreen$bookpage.func_238789_a_(this.font, this.func_238758_a_(new EditBookBlackScreen.Point((int)mouseX, (int)mouseY)));
            if (j >= 0) {
   ...
   public boolean mouseDragged(double p_231045_1_, double p_231045_3_, int p_231045_5_, double p_231045_6_, double p_231045_8_) {
      if (super.mouseDragged(p_231045_1_, p_231045_3_, p_231045_5_, p_231045_6_, p_231045_8_)) {
         ...
         if (p_231045_5_ == 0) {
            EditBookBlackScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();
            int i = editbookscreen$bookpage.func_238789_a_(this.font, this.func_238758_a_(new EditBookBlackScreen.Point((int)p_231045_1_, (int)p_231045_3_)));
   ...
   private EditBookBlackScreen.BookPage func_238750_B_() {
   ...
   private EditBookBlackScreen.BookPage func_238753_E_() {
      String s = this.getCurrPageText();
      if (s.isEmpty()) {
         return EditBookBlackScreen.BookPage.field_238779_a_;
      } else {
         int i = this.field_238748_u_.getEndIndex();
         int j = this.field_238748_u_.getStartIndex();
         IntList intlist = new IntArrayList();
         List<EditBookBlackScreen.BookLine> list = Lists.newArrayList();
         ...
         charactermanager.func_238353_a_(s, 114, Style.EMPTY, true, (p_238762_6_, p_238762_7_, p_238762_8_) -> {
            ...
            int l3 = k3 * 9;
            EditBookBlackScreen.Point editbookscreen$point1 = this.func_238767_b_(new EditBookBlackScreen.Point(0, l3));
            intlist.add(p_238762_7_);
            list.add(new EditBookBlackScreen.BookLine(p_238762_6_, s3, editbookscreen$point1.x, editbookscreen$point1.y));
         });
         int[] aint = intlist.toIntArray();
         boolean flag = i == s.length();
         EditBookBlackScreen.Point editbookscreen$point;
         if (flag && mutableboolean.isTrue()) {
            editbookscreen$point = new EditBookBlackScreen.Point(0, list.size() * 9);
         } else {
            int k = func_238768_b_(aint, i);
            int l = this.font.getStringWidth(s.substring(aint[k], i));
            editbookscreen$point = new EditBookBlackScreen.Point(l, k * 9);
         }
         ...
         if (i != j) {
            ...
            if (j1 == k1) {
               ...
               for(int j3 = j1 + 1; j3 < k1; ++j3) {
                  ...
                  list1.add(this.func_238759_a_(new EditBookBlackScreen.Point(0, j2), new EditBookBlackScreen.Point(k2, j2 + 9)));
               }
         ...
         return new EditBookBlackScreen.BookPage(s, editbookscreen$point, flag, aint, list.toArray(new EditBookBlackScreen.BookLine[0]), list1.toArray(new Rectangle2d[0]));
      }
   }
   ...
   private Rectangle2d func_238761_a_(String p_238761_1_, CharacterManager p_238761_2_, int p_238761_3_, int p_238761_4_, int p_238761_5_, int p_238761_6_) {
      ...
      EditBookBlackScreen.Point editbookscreen$point = new EditBookBlackScreen.Point((int)p_238761_2_.func_238350_a_(s), p_238761_5_);
      EditBookBlackScreen.Point editbookscreen$point1 = new EditBookBlackScreen.Point((int)p_238761_2_.func_238350_a_(s1), p_238761_5_ + 9);
      return this.func_238759_a_(editbookscreen$point, editbookscreen$point1);
   }

   private Rectangle2d func_238759_a_(EditBookBlackScreen.Point p_238759_1_, EditBookBlackScreen.Point p_238759_2_) {
      EditBookBlackScreen.Point editbookscreen$point = this.func_238767_b_(p_238759_1_);
      EditBookBlackScreen.Point editbookscreen$point1 = this.func_238767_b_(p_238759_2_);
   ...
   static class BookPage {
      private static final EditBookBlackScreen.BookPage field_238779_a_ = new EditBookBlackScreen.BookPage("", new EditBookBlackScreen.Point(0, 0), true, new int[]{0}, new EditBookBlackScreen.BookLine[]{new EditBookBlackScreen.BookLine(Style.EMPTY, "", 0, 0)}, new Rectangle2d[0]);
      private final String field_238780_b_;
      private final EditBookBlackScreen.Point field_238781_c_;
      private final boolean field_238782_d_;
      private final int[] field_238783_e_;
      private final EditBookBlackScreen.BookLine[] field_238784_f_;
      private final Rectangle2d[] field_238785_g_;

      public BookPage(String p_i232288_1_, EditBookBlackScreen.Point p_i232288_2_, boolean p_i232288_3_, int[] p_i232288_4_, EditBookBlackScreen.BookLine[] p_i232288_5_, Rectangle2d[] p_i232288_6_) {
      ...
      public int func_238789_a_(FontRenderer p_238789_1_, EditBookBlackScreen.Point p_238789_2_) {
         ...
         if (i < 0) {
            ...
            EditBookBlackScreen.BookLine editbookscreen$bookline = this.field_238784_f_[i];
      ...
      public int func_238788_a_(int p_238788_1_, int p_238788_2_) {
         int i = EditBookBlackScreen.func_238768_b_(this.field_238783_e_, p_238788_1_);
         int j = i + p_238788_2_;
         int k;
      ...
      public int func_238787_a_(int p_238787_1_) {
         int i = EditBookBlackScreen.func_238768_b_(this.field_238783_e_, p_238787_1_);
         return this.field_238783_e_[i];
      }

      public int func_238791_b_(int p_238791_1_) {
         int i = EditBookBlackScreen.func_238768_b_(this.field_238783_e_, p_238791_1_);
