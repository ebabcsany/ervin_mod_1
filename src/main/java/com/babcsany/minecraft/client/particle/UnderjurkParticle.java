...
@OnlyIn(Dist.CLIENT)
public class UnderjurkParticle extends SpriteTexturedParticle {
   private UnderjurkParticle(ClientWorld p_i232437_1_, double p_i232437_2_, double p_i232437_4_, double p_i232437_6_) {
   ...
   private UnderjurkParticle(ClientWorld p_i232438_1_, double p_i232438_2_, double p_i232438_4_, double p_i232438_6_, double p_i232438_8_, double p_i232438_10_, double p_i232438_12_) {
   ...
   public static class CrimsonSporeFactory implements IParticleFactory<BasicParticleType> {
      ...
      public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         ...
         UnderjurkParticle underwaterparticle = new UnderjurkParticle(worldIn, x, y, z, d0, d1, d2);
         underwaterparticle.selectSpriteRandomly(this.field_239199_a_);
         underwaterparticle.setColor(0.5F, 0.4F, 0.9F);
         return underwaterparticle;
      }
   }

   @OnlyIn(Dist.CLIENT)
   public static class UnderjurkFactory implements IParticleFactory<BasicParticleType> {
      private final IAnimatedSprite field_239200_a_;

      public UnderjurkFactory(IAnimatedSprite p_i232442_1_) {
         this.field_239200_a_ = p_i232442_1_;
      }

      public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         UnderjurkParticle underwaterparticle = new UnderjurkParticle(worldIn, x, y, z);
   ...
   public static class WarpedSporeFactory implements IParticleFactory<BasicParticleType> {
      ...
      public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         ...
         UnderjurkParticle underwaterparticle = new UnderjurkParticle(worldIn, x, y, z, 0.0D, d0, 0.0D);
