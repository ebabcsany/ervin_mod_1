package com.babcsany.minecraft.server.management;

import com.babcsany.minecraft.ervin_mod_1.entity.player.ModPlayerEntity;
...
//        private final WhiteList whiteListedPlayers = super.getWhitelistedPlayers();
...
//        private final OpList ops = new OpList(FILE_OPS);
        private final PlayerData playerDataManager = playerData;
//        private boolean whiteListEnforced;
        private final DynamicRegistries.Impl field_232639_s_ = impl;
...
//        private boolean commandsAllowedForAll;
        ...
        public void initializeConnectionToPlayer(NetworkManager netManager, ServerPlayerEntity playerIn) {
            ...
            this.players.forEach(serverPlayer -> playerIn.connection.sendPacket(new SPlayerListItemPacket(SPlayerListItemPacket.Action.ADD_PLAYER, serverPlayer)));
        ...
        protected void sendScoreboard(ServerScoreboard scoreboardIn, ServerPlayerEntity playerIn) {
            super.sendScoreboard(scoreboardIn, playerIn);
        }
        ...
        public void func_212504_a(ServerWorld p_212504_1_) {
            p_212504_1_.getWorldBorder().addListener(new IBorderListener() {
                public void onSizeChanged(WorldBorder border, double newSize) {
                    sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.SET_SIZE));
                }

                public void onTransitionStarted(WorldBorder border, double oldSize, double newSize, long time) {
                    sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.LERP_SIZE));
                }

                public void onCenterChanged(WorldBorder border, double x, double z) {
                    sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.SET_CENTER));
                }

                public void onWarningTimeChanged(WorldBorder border, int newTime) {
                    sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.SET_WARNING_TIME));
                }

                public void onWarningDistanceChanged(WorldBorder border, int newDistance) {
                    sendPacketToAllPlayers(new SWorldBorderPacket(border, SWorldBorderPacket.Action.SET_WARNING_BLOCKS));
                }
        ...
        public ServerPlayerEntity createPlayerForUser(GameProfile profile) {
            ...
            List<ServerPlayerEntity> list = this.players.stream().filter(serverplayerentity -> serverplayerentity.getUniqueID().equals(uuid)).collect(Collectors.toList());
        ...
        public ServerPlayerEntity func_232644_a_(ServerPlayerEntity p_232644_1_, boolean p_232644_2_) {
            ...
            if (serverworld != null && blockpos != null) {
                optional = ModPlayerEntity.findRespawnPoint(serverworld, blockpos, f, flag, p_232644_2_);
            } else {
            ...
            if (optional.isPresent()) {
                ...
                boolean flag0 = blockstate.matchesBlock(Blocks.RESPAWN_ANCHOR);
                boolean flag1 = blockstate.isIn(ModBlockTags.RESPAWN_BLOCKS);
        ...
        public void updatePermissionLevel(ServerPlayerEntity player) {
            super.updatePermissionLevel(player);
        }
        ...
        public void sendPacketToAllPlayers(IPacket<?> packetIn) {
            this.players.forEach(serverPlayer -> serverPlayer.connection.sendPacket(packetIn));
        }

        @Override
        public void func_232642_a_(IPacket<?> packetIn, RegistryKey<World> worldKey) {
            this.players.stream().filter(serverplayerentity -> serverplayerentity.world.getDimensionKey() == worldKey).forEach(serverplayerentity -> serverplayerentity.connection.sendPacket(packetIn));
        }
        ...
        public void sendMessageToTeamOrAllPlayers(PlayerEntity player, ITextComponent message) {
            ...
            if (team == null) {
                ...
                this.players.stream().filter(serverplayerentity -> serverplayerentity.getTeam() != team).forEach(serverplayerentity -> serverplayerentity.sendMessage(message, player.getUniqueID()));
            }
        }
        ...
        public BanList getBannedPlayers() {
            return super.getBannedPlayers();
        }

        @Override
        public IPBanList getBannedIPs() {
            return super.getBannedIPs();
        }
        ...
        public boolean canJoin(GameProfile profile) {
            return super.canJoin(profile);
        }

        @Override
        public boolean canSendCommands(GameProfile profile) {
            return super.canSendCommands(profile);
        }
        ...
        public void sendToAllNearExcept(@Nullable PlayerEntity except, double x, double y, double z, double radius, RegistryKey<World> dimension, IPacket<?> packetIn) {
            this.players.stream().filter(serverplayerentity -> serverplayerentity != except && serverplayerentity.world.getDimensionKey() == dimension).forEach(serverplayerentity -> {
        ...
        public void saveAllPlayerData() {
            this.players.forEach(this::writePlayerData);
        }

        @Override
        public WhiteList getWhitelistedPlayers() {
            return super.getWhitelistedPlayers();
        }

        @Override
        public String[] getWhitelistedPlayerNames() {
            return super.getWhitelistedPlayerNames();
        }

        @Override
        public OpList getOppedPlayers() {
            return super.getOppedPlayers();
        }

        @Override
        public String[] getOppedPlayerNames() {
            return super.getOppedPlayerNames();
        }

        @Override
        public void reloadWhitelist() {
            super.reloadWhitelist();
        }

        @Override
        public void sendWorldInfo(ServerPlayerEntity playerIn, ServerWorld worldIn) {
            super.sendWorldInfo(playerIn, worldIn);
        }

        @Override
        public void sendInventory(ServerPlayerEntity playerIn) {
            super.sendInventory(playerIn);
        }
        ...
        public boolean isWhiteListEnabled() {
            return super.isWhiteListEnabled();
        }
        ...
        public CompoundNBT getHostPlayerData() {
            return super.getHostPlayerData();
        }
        ...
        public void setPlayerGameTypeBasedOnOther(ServerPlayerEntity target, @Nullable ServerPlayerEntity source, ServerWorld worldIn) {
            if (source != null) {
        ...
        public void setCommandsAllowedForAll(boolean p_72387_1_) {
            super.setCommandsAllowedForAll(p_72387_1_);
        }

        @Override
        public void removeAllPlayers() {
            this.players.forEach(serverPlayer -> serverPlayer.connection.disconnect(new TranslationTextComponent("multiplayer.disconnect.server_shutdown")));
        }

        @Override
        public void func_232641_a_(ITextComponent p_232641_1_, ChatType p_232641_2_, UUID p_232641_3_) {
            super.func_232641_a_(p_232641_1_, p_232641_2_, p_232641_3_);
        }
        ...
        public void putUUIDToPlayerMap(UUID playerUUID, ServerPlayerEntity playerIn) {
            this.uuidToPlayerMap.put(playerUUID, playerIn);
        }
        ...
        public boolean commandsAllowedForAll() {
            return super.commandsAllowedForAll();
        }
    ...
    public ServerPlayerEntity spawn(ServerPlayerEntity serverPlayer, boolean keepEverything) {
        return list.func_232644_a_(serverPlayer, keepEverything);
    }
