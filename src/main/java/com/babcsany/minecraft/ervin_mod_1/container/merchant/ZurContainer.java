package com.babcsany.minecraft.ervin_mod_1.container.merchant;

import com.babcsany.minecraft.ervin_mod_1.entity.merchant.result_slot.ZurResultSlot;
import com.babcsany.minecraft.ervin_mod_1.entity.merchant.zur.IMerchant;
import com.babcsany.minecraft.ervin_mod_1.entity.merchant.zur.NPCMerchant;
...
public class ZurContainer extends Container {
   private final IMerchant merchant;
   private final ZurInventory merchantInventory;
   @OnlyIn(Dist.CLIENT)
   ...
   public ZurContainer(int id, PlayerInventory playerInventoryIn) {
      this(id, playerInventoryIn, new NPCMerchant(playerInventoryIn.player));
   }

   public ZurContainer(int id, PlayerInventory playerInventoryIn, IMerchant merchantIn) {
      super(ContainerInit.ZUR.get(), id);
      this.merchant = merchantIn;
      this.merchantInventory = new ZurInventory(merchantIn);
      this.addSlot(new Slot(this.merchantInventory, 0, 136, 37));
      this.addSlot(new Slot(this.merchantInventory, 1, 162, 37));
      this.addSlot(new ZurResultSlot(playerInventoryIn.player, merchantIn, this.merchantInventory, 2, 220, 37));
   ...
   public ZurContainer(int id, PlayerInventory playerInventoryIn, PacketBuffer packetBuffer) {
      this(id, playerInventoryIn, new NPCMerchant(playerInventoryIn.player));
   }
