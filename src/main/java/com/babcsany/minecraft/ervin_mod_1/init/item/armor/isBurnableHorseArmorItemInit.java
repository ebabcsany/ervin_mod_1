...
public class isBurnableHorseArmorItemInit {
    ...
    public static final RegistryObject<Item> TERAT_HORSE_ARMOR = BURNABLE_HORSE_ARMOR.register("terat_horse_armor", () -> new HorseArmorItem(880, new ResourceLocation(Ervin_mod_1.MOD_ID, "textures/entity/horse/armor/terat_horse_armor.png"), (new Item.Properties()).maxStackSize(1).isBurnable().group(ItemGroup.MISC)));
}
