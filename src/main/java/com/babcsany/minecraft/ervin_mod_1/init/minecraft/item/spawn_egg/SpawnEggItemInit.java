...
public class SpawnEggItemInit {
    ...
    public static final RegistryObject<Item> LIGHTNING_BOLT_SPAWN_EGG = SPAWN_EGGS.register("spawn_eggs/lightning_bolt_spawn_egg", () -> new SpawnEggItem(EntityType.LIGHTNING_BOLT, 16777215, 16767215, new Item.Properties().group(ItemGroup.ERVIN_MOD_1_SPAWN_EGGS)));
