...
public class registerBlockInit {
    ...
    public static final RegistryObject<Block> ENDER_TRASKRACH = BLOCKS.register("ender_traskrach", () -> new Block(Block.Properties.create(Material.ORGANIC).setRequiresTool().harvestLevel(4).hardnessAndResistance(80.0f)));
    ...
    public static final RegistryObject<Block> ZUNK_BLOCK = BLOCKS.register("zunk_block", () -> new Block(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(1).harvestTool(ToolType.SHOVEL).hardnessAndResistance(40.0F)));
    ...
    public static final RegistryObject<Block> THUFR = BLOCKS.register("special/thufr", () -> new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BLACK).harvestLevel(138).hardnessAndResistance(3690527310400000000.0F).sound(SoundType.STONE)));
    ...
    public static final RegistryObject<Block> TRAGN = BLOCKS.register("tragn", () -> new DamageOnWalkingBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(36).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1000000000.0f), 765275040000F));
    public static final RegistryObject<Block> TRAGK_BLOCK = BLOCKS.register("tragk_block", () -> new DamageOnWalkingBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(26).harvestTool(ToolType.PICKAXE).hardnessAndResistance(5000000.0f), 1224440064F));
    public static final RegistryObject<Block> TRAGK_SLAB = BLOCKS.register("tragk_slab", () -> new DamageOnWalkingSlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(24).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2500000.0f), 612220032F));
    public static final RegistryObject<Block> TRAGK_STAIRS = BLOCKS.register("tragk_stairs", () -> new DamageOnWalkingStairsBlock(() -> TRAGK_BLOCK.get().getDefaultState(), Block.Properties.from(TRAGK_BLOCK.get()), 908330048F));
    public static final RegistryObject<Block> GARK_BLOCK = BLOCKS.register("gark_block", () -> new DamageOnWalkingBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(12).hardnessAndResistance(2000.0f), 26244));
    public static final RegistryObject<Block> GARK_SLAB = BLOCKS.register("gark_slab", () -> new DamageOnWalkingSlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(12).hardnessAndResistance(2000.0f, 2200.0f), 13122));
    public static final RegistryObject<Block> GARK_STAIRS = BLOCKS.register("gark_stairs", () -> new DamageOnWalkingStairsBlock(() -> GARK_BLOCK.get().getDefaultState(), Block.Properties.from(GARK_BLOCK.get()), 19683));
