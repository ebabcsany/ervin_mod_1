...
public class isBurnableBlockItemInit {
    private static final DeferredRegister<Block> BURNABLE_BLOCKS = UnusedBlockInit.BLOCK_DEFERRED_REGISTER;
    private static final DeferredRegister<Item> BURNABLE_BLOCK_ITEMS = UnusedBlockItemInit.BLOCK_ITEM_DEFERRED_REGISTER;
    ...
    public static final RegistryObject<Item> NARIN_BLOCK_ITEM = BURNABLE_BLOCK_ITEMS.register("narin_block", () -> new BlockItem(NARIN_BLOCK.get(), new Item.Properties().isImmuneToFire()));
    ...
    public static final RegistryObject<Block> HURVRUJ = BURNABLE_BLOCKS.register("hurvruj", () -> new Hurvruj(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BLACK).setRequiresTool().hardnessAndResistance(500000.0F, 12000000.0F).setLightLevel((blockState) -> Hurvruj.lightState(blockState, 15))));
    public static final RegistryObject<Item> HURVRUJ_ITEM = BURNABLE_BLOCK_ITEMS.register("hurvruj", () -> new BlockItem(HURVRUJ.get(), new Item.Properties().isImmuneToFire()));
    ...
    public static RegistryObject<Block> register(String name, Block block) {
        return BURNABLE_BLOCKS.register(name, () -> block);
    }
