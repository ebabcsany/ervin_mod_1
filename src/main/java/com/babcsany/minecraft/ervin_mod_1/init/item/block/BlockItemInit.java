...
public class BlockItemInit {
    ...
    //public static final RegistryObject<Item> WHITE_STRING = BLOCK_ITEMS.register("strings/white_string", () -> new BlockItem(BlockInit.BLACK_TRIPWIRE.get(), (new Item.Properties())));
