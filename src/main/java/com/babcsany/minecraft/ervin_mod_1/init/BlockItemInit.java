...
public class BlockItemInit {
    ...
    public static final BlockItem RED_SMOOTH_STONE = registerSmoothStone("red");
...
//    public static final Block END_SRACKT = register("end_srackt", new Block(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(16.0f)));
    ...
    public static final BlockItem BLACK_COBBLESTONE = registerCobblestone("black");
    public static final BlockItem BLUE_COBBLESTONE = registerCobblestone("blue");
    public static final BlockItem BROWN_COBBLESTONE = registerCobblestone("brown");
    public static final BlockItem CYAN_COBBLESTONE = registerCobblestone("cyan");
    public static final BlockItem GREEN_COBBLESTONE = registerCobblestone("green");
    public static final BlockItem LIGHT_BLUE_COBBLESTONE = registerCobblestone("light_blue1");
    public static final BlockItem LIGHT_BLUE1_COBBLESTONE = registerCobblestone("light_blue");
    public static final BlockItem LIGHT_GRAY_COBBLESTONE = registerCobblestone("light_gray");
    public static final BlockItem LIME_COBBLESTONE = registerCobblestone("lime");
    public static final BlockItem MAGENTA_COBBLESTONE = registerCobblestone("magenta");
    public static final BlockItem ORANGE_COBBLESTONE = registerCobblestone("orange");
    public static final BlockItem PINK_COBBLESTONE = registerCobblestone("pink");
    public static final BlockItem PURPLE_COBBLESTONE = registerCobblestone("purple");
    public static final BlockItem WHITE_COBBLESTONE = registerCobblestone("white");
    public static final BlockItem YELLOW_COBBLESTONE = registerCobblestone("yellow");
    ...
    public static final BlockItem BLACK_STONE = registerStone("black");
    public static final BlockItem BLUE_STONE = registerStone("blue");
    public static final BlockItem BROWN_STONE = registerStone("brown");
    public static final BlockItem CYAN_STONE = registerStone("cyan");
    public static final BlockItem GREEN_STONE = registerStone("green");
    public static final BlockItem LIGHT_BLUE_STONE = registerStone("light_blue");
    public static final BlockItem LIGHT_BLUE1_STONE = registerStone("light_blue1");
    public static final BlockItem LIGHT_GRAY_STONE = registerStone("light_gray");
    public static final BlockItem LIME_STONE = registerStone("lime");
    public static final BlockItem MAGENTA_STONE = registerStone("magenta");
    public static final BlockItem ORANGE_STONE = registerStone("orange");
    public static final BlockItem PINK_STONE = registerStone("pink");
    public static final BlockItem PURPLE_STONE = registerStone("purple");
    public static final BlockItem RED_STONE = registerStone("red");
    public static final BlockItem WHITE_STONE = registerStone("white");
    public static final BlockItem YELLOW_STONE = registerStone("yellow");
    public static final BlockItem BLACK_COBBLESTONE_SLAB = registerCobblestoneSlab("black");
    public static final BlockItem BLUE_COBBLESTONE_SLAB = registerCobblestoneSlab("blue");
    public static final BlockItem BROWN_COBBLESTONE_SLAB = registerCobblestoneSlab("brown");
    public static final BlockItem CYAN_COBBLESTONE_SLAB = registerCobblestoneSlab("cyan");
    public static final BlockItem GREEN_COBBLESTONE_SLAB = registerCobblestoneSlab("green");
    public static final BlockItem LIGHT_BLUE_COBBLESTONE_SLAB = registerCobblestoneSlab("light_blue");
    public static final BlockItem LIGHT_BLUE1_COBBLESTONE_SLAB = registerCobblestoneSlab("light_blue1");
    public static final BlockItem LIGHT_GRAY_COBBLESTONE_SLAB = registerCobblestoneSlab("light_gray");
    public static final BlockItem LIME_COBBLESTONE_SLAB = registerCobblestoneSlab("lime");
    public static final BlockItem MAGENTA_COBBLESTONE_SLAB = registerCobblestoneSlab("magenta");
    public static final BlockItem ORANGE_COBBLESTONE_SLAB = registerCobblestoneSlab("orange");
    public static final BlockItem PINK_COBBLESTONE_SLAB = registerCobblestoneSlab("pink");
    public static final BlockItem PURPLE_COBBLESTONE_SLAB = registerCobblestoneSlab("purple");
    public static final BlockItem RED_COBBLESTONE_SLAB = registerCobblestoneSlab("red");
    public static final BlockItem WHITE_COBBLESTONE_SLAB = registerCobblestoneSlab("white");
    public static final BlockItem YELLOW_COBBLESTONE_SLAB = registerCobblestoneSlab("yellow");
    public static final BlockItem BLACK_STONE_SLAB = registerStoneSlab("black");
    public static final BlockItem BLUE_STONE_SLAB = registerStoneSlab("blue");
    public static final BlockItem BROWN_STONE_SLAB = registerStoneSlab("brown");
    public static final BlockItem CYAN_STONE_SLAB = registerStoneSlab("cyan");
    public static final BlockItem GREEN_STONE_SLAB = registerStoneSlab("green");
    public static final BlockItem LIGHT_BLUE_STONE_SLAB = registerStoneSlab("light_blue");
    public static final BlockItem LIGHT_BLUE1_STONE_SLAB = registerStoneSlab("light_blue1");
    public static final BlockItem LIGHT_GRAY_STONE_SLAB = registerStoneSlab("light_gray");
    public static final BlockItem LIME_STONE_SLAB = registerStoneSlab("lime");
    public static final BlockItem MAGENTA_STONE_SLAB = registerStoneSlab("magenta");
    public static final BlockItem ORANGE_STONE_SLAB = registerStoneSlab("orange");
    public static final BlockItem PINK_STONE_SLAB = registerStoneSlab("pink");
    public static final BlockItem PURPLE_STONE_SLAB = registerStoneSlab("purple");
    public static final BlockItem RED_STONE_SLAB = registerStoneSlab("red");
    public static final BlockItem WHITE_STONE_SLAB = registerStoneSlab("white");
    public static final BlockItem YELLOW_STONE_SLAB = registerStoneSlab("yellow");
    ...
    public static final BlockItem BLACK_SMOOTH_STONE = registerSmoothStone("black");
    public static final BlockItem BLUE_SMOOTH_STONE = registerSmoothStone("blue");
    public static final BlockItem BROWN_SMOOTH_STONE = registerSmoothStone("brown");
    public static final BlockItem CYAN_SMOOTH_STONE = registerSmoothStone("cyan");
    public static final BlockItem GREEN_SMOOTH_STONE = registerSmoothStone("green");
    public static final BlockItem LIGHT_BLUE_SMOOTH_STONE = registerSmoothStone("light_blue");
    public static final BlockItem LIGHT_BLUE1_SMOOTH_STONE = registerSmoothStone("light_blue1");
    public static final BlockItem LIGHT_GRAY_SMOOTH_STONE = registerSmoothStone("light_gray");
    public static final BlockItem LIME_SMOOTH_STONE = registerSmoothStone("lime");
    public static final BlockItem MAGENTA_SMOOTH_STONE = registerSmoothStone("magenta");
    public static final BlockItem ORANGE_SMOOTH_STONE = registerSmoothStone("orange");
    public static final BlockItem PINK_SMOOTH_STONE = registerSmoothStone("pink");
    public static final BlockItem PURPLE_SMOOTH_STONE = registerSmoothStone("purple");
    public static final BlockItem WHITE_SMOOTH_STONE = registerSmoothStone("white");
    public static final BlockItem YELLOW_SMOOTH_STONE = registerSmoothStone("yellow");
    public static final Block ENDER_SRACKHT_1 = register("ender_srackht_1", new Block(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(1).harvestTool(ToolType.PICKAXE).hardnessAndResistance(20.0F)));
    public static final Block ENDER_SRAKTCAF_1 = register("ender_sraktcaf_1", new Block(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(3).harvestTool(ToolType.SHOVEL).hardnessAndResistance(60.0F)));
    public static final Block ENDER_STAKRACH_1 = register("ender_stakrach_1", new Block(Block.Properties.create(Material.WOOD).setRequiresTool().harvestLevel(2).harvestTool(ToolType.AXE).hardnessAndResistance(40.0F)));
    public static final Block BLACK_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/black_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block BLUE_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/blue_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block BROWN_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/brown_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block CYAN_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/cyan_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block GREEN_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/green_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block LIGHT_BLUE_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/light_blue_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block LIGHT_BLUE1_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/light_blue1_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block LIGHT_GRAY_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/light_gray_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block LIME_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/lime_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block MAGENTA_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/magenta_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block ORANGE_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/orange_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block PINK_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/pink_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block PURPLE_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/purple_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block RED_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/red_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block WHITE_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/white_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block YELLOW_SMOOTH_STONE_SLAB = register("stone/smooth_stone/slabs/yellow_smooth_stone_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    public static final Block ZURK_BLOCK = register("zurk_block", new Block(Block.Properties.create(Material.AIR).setRequiresTool().harvestLevel(2).harvestTool(ToolType.SHOVEL).hardnessAndResistance(200.0F)));
    public static final Block ZURK_STAIRS = register("zurk_stairs", createStairsBlockFrom(ZURK_BLOCK));
    public static final Block BLACK_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/black_cobblestone_stairs", createStairsBlockFrom(BLACK_COBBLESTONE.getBlock()));
    public static final Block BLACK_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/black_smooth_stone_stairs", createStairsBlockFrom(BLACK_SMOOTH_STONE.getBlock()));
    public static final Block BLACK_STONE_STAIRS = register("stone/stairs/black_stone_stairs", createStairsBlockFrom(BLACK_STONE.getBlock()));
    public static final Block BLUE_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/blue_cobblestone_stairs", createStairsBlockFrom(BLUE_COBBLESTONE.getBlock()));
    public static final Block BLUE_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/blue_smooth_stone_stairs", createStairsBlockFrom(BLUE_SMOOTH_STONE.getBlock()));
    public static final Block BLUE_STONE_STAIRS = register("stone/stairs/blue_stone_stairs", createStairsBlockFrom(BLUE_STONE.getBlock()));
    public static final Block BROWN_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/brown_cobblestone_stairs", createStairsBlockFrom(BROWN_COBBLESTONE.getBlock()));
    public static final Block BROWN_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/brown_smooth_stone_stairs", createStairsBlockFrom(BROWN_SMOOTH_STONE.getBlock()));
    public static final Block BROWN_STONE_STAIRS = register("stone/stairs/brown_stone_stairs", createStairsBlockFrom(BROWN_STONE.getBlock()));
    public static final Block CYAN_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/cyan_cobblestone_stairs", createStairsBlockFrom(CYAN_COBBLESTONE.getBlock()));
    public static final Block CYAN_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/cyan_smooth_stone_stairs", createStairsBlockFrom(CYAN_SMOOTH_STONE.getBlock()));
    public static final Block CYAN_STONE_STAIRS = register("stone/stairs/cyan_stone_stairs", createStairsBlockFrom(CYAN_STONE.getBlock()));
    public static final Block GREEN_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/green_cobblestone_stairs", createStairsBlockFrom(GREEN_COBBLESTONE.getBlock()));
    public static final Block GREEN_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/green_smooth_stone_stairs", createStairsBlockFrom(GREEN_SMOOTH_STONE.getBlock()));
    public static final Block GREEN_STONE_STAIRS = register("stone/stairs/green_stone_stairs", createStairsBlockFrom(GREEN_STONE.getBlock()));
    public static final Block LIGHT_BLUE_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/light_blue_cobblestone_stairs", createStairsBlockFrom(LIGHT_BLUE_COBBLESTONE.getBlock()));
    public static final Block LIGHT_BLUE_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/light_blue_smooth_stone_stairs", createStairsBlockFrom(LIGHT_BLUE_SMOOTH_STONE.getBlock()));
    public static final Block LIGHT_BLUE_STONE_STAIRS = register("stone/stairs/light_blue_stone_stairs", createStairsBlockFrom(LIGHT_BLUE_STONE.getBlock()));
    public static final Block LIGHT_BLUE1_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/light_blue1_cobblestone_stairs", createStairsBlockFrom(LIGHT_BLUE1_COBBLESTONE.getBlock()));
    public static final Block LIGHT_BLUE1_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/light_blue1_smooth_stone_stairs", createStairsBlockFrom(LIGHT_BLUE1_SMOOTH_STONE.getBlock()));
    public static final Block LIGHT_BLUE1_STONE_STAIRS = register("stone/stairs/light_blue1_stone_stairs", createStairsBlockFrom(LIGHT_BLUE1_STONE.getBlock()));
    public static final Block LIGHT_GRAY_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/light_gray_cobblestone_stairs", createStairsBlockFrom(LIGHT_GRAY_COBBLESTONE.getBlock()));
    public static final Block LIGHT_GRAY_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/light_gray_smooth_stone_stairs", createStairsBlockFrom(LIGHT_GRAY_SMOOTH_STONE.getBlock()));
    public static final Block LIGHT_GRAY_STONE_STAIRS = register("stone/stairs/light_gray_stone_stairs", createStairsBlockFrom(LIGHT_GRAY_STONE.getBlock()));
    public static final Block LIME_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/lime_cobblestone_stairs", createStairsBlockFrom(LIME_COBBLESTONE.getBlock()));
    public static final Block LIME_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/lime_smooth_stone_stairs", createStairsBlockFrom(LIME_SMOOTH_STONE.getBlock()));
    public static final Block LIME_STONE_STAIRS = register("stone/stairs/lime_stone_stairs", createStairsBlockFrom(LIME_STONE.getBlock()));
    public static final Block MAGENTA_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/magenta_cobblestone_stairs", createStairsBlockFrom(MAGENTA_COBBLESTONE.getBlock()));
    public static final Block MAGENTA_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/magenta_smooth_stone_stairs", createStairsBlockFrom(MAGENTA_SMOOTH_STONE.getBlock()));
    public static final Block MAGENTA_STONE_STAIRS = register("stone/stairs/magenta_stone_stairs", createStairsBlockFrom(MAGENTA_STONE.getBlock()));
    public static final Block ORANGE_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/orange_cobblestone_stairs", createStairsBlockFrom(ORANGE_COBBLESTONE.getBlock()));
    public static final Block ORANGE_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/orange_smooth_stone_stairs", createStairsBlockFrom(ORANGE_SMOOTH_STONE.getBlock()));
    public static final Block ORANGE_STONE_STAIRS = register("stone/stairs/orange_stone_stairs", createStairsBlockFrom(ORANGE_STONE.getBlock()));
    public static final Block PINK_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/pink_cobblestone_stairs", createStairsBlockFrom(PINK_COBBLESTONE.getBlock()));
    public static final Block PINK_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/pink_smooth_stone_stairs", createStairsBlockFrom(PINK_SMOOTH_STONE.getBlock()));
    public static final Block PINK_STONE_STAIRS = register("stone/stairs/pink_stone_stairs", createStairsBlockFrom(PINK_STONE.getBlock()));
    public static final Block PURPLE_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/purple_cobblestone_stairs", createStairsBlockFrom(PURPLE_COBBLESTONE.getBlock()));
    public static final Block PURPLE_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/purple_smooth_stone_stairs", createStairsBlockFrom(PURPLE_SMOOTH_STONE.getBlock()));
    public static final Block PURPLE_STONE_STAIRS = register("stone/stairs/purple_stone_stairs", createStairsBlockFrom(PURPLE_STONE.getBlock()));
    public static final Block RED_COBBLESTONE_STAIRS;
    public static final Block RED_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/red_smooth_stone_stairs", createStairsBlockFrom(RED_SMOOTH_STONE.getBlock()));
    public static final Block RED_STONE_STAIRS = register("stone/stairs/red_stone_stairs", createStairsBlockFrom(RED_STONE.getBlock()));
    public static final Block WHITE_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/white_cobblestone_stairs", createStairsBlockFrom(WHITE_COBBLESTONE.getBlock()));
    public static final Block WHITE_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/white_smooth_stone_stairs", createStairsBlockFrom(WHITE_SMOOTH_STONE.getBlock()));
    public static final Block WHITE_STONE_STAIRS = register("stone/stairs/white_stone_stairs", createStairsBlockFrom(WHITE_STONE.getBlock()));
    public static final Block YELLOW_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/yellow_cobblestone_stairs", createStairsBlockFrom(YELLOW_COBBLESTONE.getBlock()));
    public static final Block YELLOW_SMOOTH_STONE_STAIRS = register("stone/smooth_stone/stairs/yellow_smooth_stone_stairs", createStairsBlockFrom(YELLOW_SMOOTH_STONE.getBlock()));
    public static final Block YELLOW_STONE_STAIRS = register("stone/stairs/yellow_stone_stairs", createStairsBlockFrom(YELLOW_STONE.getBlock()));
    ...
    public static final BlockItem BLACK_IRON_BLOCK = registerBlockItem("iron_block/black_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem BLUE_IRON_BLOCK = registerBlockItem("iron_block/blue_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem BROWN_IRON_BLOCK = registerBlockItem("iron_block/brown_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem CYAN_IRON_BLOCK = registerBlockItem("iron_block/cyan_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem GRAY_IRON_BLOCK = registerBlockItem("iron_block/gray_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem GREEN_IRON_BLOCK = registerBlockItem("iron_block/green_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem LIGHT_BLUE_IRON_BLOCK = registerBlockItem("iron_block/light_blue_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem LIGHT_BLUE1_IRON_BLOCK = registerBlockItem("iron_block/light_blue1_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem LIGHT_GRAY_IRON_BLOCK = registerBlockItem("iron_block/light_gray_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem LIME_IRON_BLOCK = registerBlockItem("iron_block/lime_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem MAGENTA_IRON_BLOCK = registerBlockItem("iron_block/magenta_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem ORANGE_IRON_BLOCK = registerBlockItem("iron_block/orange_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem PINK_IRON_BLOCK = registerBlockItem("iron_block/pink_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem PURPLE_IRON_BLOCK = registerBlockItem("iron_block/purple_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem RED_IRON_BLOCK = registerBlockItem("iron_block/red_iron_block", new Block(Block.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    public static final BlockItem YELLOW_IRON_BLOCK = registerBlockItem("iron_block/yellow_iron_block", new Block(AbstractBlock.Properties.create(Material.IRON, MaterialColor.IRON).setRequiresTool().hardnessAndResistance(5.0F, 6.0F).sound(SoundType.METAL)));
    ...
    public static BlockItem registerCobblestone(String name) {
        return registerStone("cobblestones", name, createCobblestone());
    }

    public static BlockItem registerCobblestoneSlab(String name) {
        return registerStoneSlab("cobblestone", name, createCobblestoneSlab());
    }

    public static BlockItem registerSmoothStone(String name) {
        return registerStone("smooth_stones", name, createSmoothStone());
    }

    public static BlockItem registerStoneSlab(String name) {
        return registerStone("slabs", name, createStoneSlab());
    }

    public static BlockItem registerStoneSlab(String type, String name, Block stone) {
        return registerStone(type + "/slabs", name, stone);
    }

    public static BlockItem registerStone(String name) {
        return registerStone("stones", name, createStone());
    }

    public static BlockItem registerStone(String type, String name, Block stone) {
