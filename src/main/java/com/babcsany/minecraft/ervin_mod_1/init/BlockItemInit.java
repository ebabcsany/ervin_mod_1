...
public class BlockItemInit {
    ...
    public static final RegistryObject<Block> RED_SMOOTH_STONE = BLOCKS.register("stone/smooth_stones/red_smooth_stone", () -> new Block(Block.Properties.create(Material.ROCK).setRequiresTool().harvestTool(ToolType.PICKAXE).hardnessAndResistance(2.0F, 6.0F)));
    ...
    public static final RegistryObject<Block> DURT_GURBF = BLOCKS.register("durt/gurbf", () -> new Block(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(2).harvestTool(ToolType.PICKAXE).hardnessAndResistance(22.0f, 400.0f)));
    ...
    public static StairsBlock createStairsBlock(Block fromBlock) {
...
//        Axe_Item.block();
        ...
        RUBY_STAIRS = register("ruby_stairs", createStairsBlock(RUBY_BLOCK));
        ...
        RED_COBBLESTONE_STAIRS = register("stone/cobblestone/stairs/red_cobblestone_stairs", createStairsBlock(RED_COBBLESTONE));
    }
}
