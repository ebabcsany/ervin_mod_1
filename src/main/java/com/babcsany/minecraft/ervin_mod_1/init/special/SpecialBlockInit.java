...
public class SpecialBlockInit {
    ...
    public static final RegistryObject<Block> TFJHU_1 = SPECIAL_BLOCKS.register(string("tfjhu/tfjhu_1"), () -> new Block(Block.Properties.create(MaterialInit.ROCK).speedFactor(3).sound(SoundType.CHAIN)));
