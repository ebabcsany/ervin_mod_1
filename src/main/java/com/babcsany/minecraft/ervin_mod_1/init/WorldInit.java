...
public class WorldInit extends iorld {

    public static World WORLDS;

    public static ISpawnWorldInfo worldInfo;
    public static RegistryKey<iorld> worldRegistryKey;
    ...
    public static iorld world;
    public static boolean Boolean;
    public static long Long;

    public static final RegistryKey<iorld> EXAMPLE = worldRegistryKey("example");

    public WorldInit() {
        this(worldInfo, worldRegistryKey, dimensionTypeRegistryKey_, dimensionType_, profilerSupplier, Boolean, Boolean, Long);
    }

    public WorldInit(ISpawnWorldInfo iSpawnWorldInfo, RegistryKey<iorld> worldRegistryKey, RegistryKey<dimensionType> dimensionTypeRegistryKey, dimensionType dimensionType, Supplier<IProfiler> iProfilerSupplier, boolean b, boolean b1, long l) {
    ...
    public static RegistryKey<iorld> worldRegistryKey(String key) {
