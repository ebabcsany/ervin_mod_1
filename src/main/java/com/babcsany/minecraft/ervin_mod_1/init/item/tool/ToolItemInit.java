...
import com.babcsany.minecraft.ervin_mod_1.item.burning.tool.stick.*;
...
public class ToolItemInit {
    ...
    public static final RegistryObject<Item> FIRT_AXE = TOOLS.register("firt_axe", () -> new FirtAxe(ModItemTier.FIRT, 16, 21.0F, (new Item.Properties())));
    public static final RegistryObject<Item> FIRT_HOE = TOOLS.register("firt_hoe", () -> new FirtHoe(ModItemTier.FIRT, 2, -1F, (new Item.Properties())));
    public static final RegistryObject<Item> FIRT_PICKAXE = TOOLS.register("firt_pickaxe", () -> new FirtPickaxe(ModItemTier.FIRT, 4, 8.4F, (new Item.Properties())));
    public static final RegistryObject<Item> FIRT_SHOVEL = TOOLS.register("firt_shovel", () -> new FirtShovel(ModItemTier.FIRT, 12, 16.8F, (new Item.Properties())));
    public static final RegistryObject<Item> FIRT_SWORD = TOOLS.register("firt_sword", () -> new FirtSword(ModItemTier.FIRT, 8, 12.6F, (new Item.Properties())));
