...
public class ToolItemInit {
    ...
    public static final RegistryObject<Item> KIRT_AXE = TOOLS.register("kirt_axe", () -> new AxeItem(ModItemTier.KIRT, 0.4F, 0.5F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_HOE = TOOLS.register("kirt_hoe", () -> new HoeItem(ModItemTier.KIRT, 0, 0.1F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_PICKAXE = TOOLS.register("kirt_pickaxe", () -> new PickaxeItem(ModItemTier.KIRT, 0, 0.2F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_SHOVEL = TOOLS.register("kirt_shovel", () -> new ShovelItem(ModItemTier.KIRT, 0.3F, 0.5F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_SWORD = TOOLS.register("kirt_sword", () -> new SwordItem(ModItemTier.KIRT, 1, 0.3F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_STIK_AXE = TOOLS.register("kirt_stik_axe", () -> new AxeItem(ModItemTier.KIRT_STIK, 1.6F, 2.5F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_STIK_HOE = TOOLS.register("kirt_stik_hoe", () -> new HoeItem(ModItemTier.KIRT_STIK, 1, 0.5F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_STIK_PICKAXE = TOOLS.register("kirt_stik_pickaxe", () -> new PickaxeItem(ModItemTier.KIRT_STIK, 1, 1.0F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_STIK_SHOVEL = TOOLS.register("kirt_stik_shovel", () -> new ShovelItem(ModItemTier.KIRT_STIK, 1.2F, 2.0F, (new Item.Properties())));
    public static final RegistryObject<Item> KIRT_STIK_SWORD = TOOLS.register("kirt_stik_sword", () -> new SwordItem(ModItemTier.KIRT_STIK, 4, 1.5F, (new Item.Properties())));
