...
public class BlockNamedItemInit {
    ...
    public static final RegistryObject<Item> FI_RT_PLOCK = BLOCK_ITEMS.register("fi_rt_plock", () -> new BlockItem(H_u_fBlockInit.UUUUUUUUUUUUUUUUUUUUUUUU.get(), (new Item.Properties()).group(ItemGroup.ERVIN_MOD_1_SEARCH)));
