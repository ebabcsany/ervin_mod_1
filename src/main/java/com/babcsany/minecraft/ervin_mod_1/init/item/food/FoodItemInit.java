...
public class FoodItemInit {
    ...
    public static final RegistryObject<Item> STEEF = FOODS.register("meat/steef", () -> new Item((new Item.Properties()).food(Foods.STEEF).group(net.minecraft.item.ItemGroup.FOOD).group(ModItemGroup.ERVIN_MOD_1_SEARCH)));
    ...
    public static final RegistryObject<Item> FRIM = FOODS.register("frim", () -> new Item((new Item.Properties()).food(Foods.FRIM).group(net.minecraft.item.ItemGroup.FOOD).group(ModItemGroup.ERVIN_MOD_1_SEARCH)));
    ...
    public static final RegistryObject<Item> REAT = FOODS.register("reat", () -> new Item((new Item.Properties()).food(Foods.REAT).group(net.minecraft.item.ItemGroup.FOOD).group(ModItemGroup.ERVIN_MOD_1_SEARCH)));
    ...
    public static final RegistryObject<Item> JAZZ_FRUIT = FOODS.register("jazz_fruit", () -> new Item((new Item.Properties()).food(Foods.JAZZ_FRUIT).group(net.minecraft.item.ItemGroup.FOOD).group(ModItemGroup.ERVIN_MOD_1_SEARCH)));
}
