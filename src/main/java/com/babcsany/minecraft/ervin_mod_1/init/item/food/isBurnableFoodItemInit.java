...
public class isBurnableFoodItemInit {
    ...
    public static final RegistryObject<Item> GRINT = BURNABLE_FOODS.register("grint", () -> new UsingAndBurningItem((new Item.Properties()).food(Foods.GRINT).isImmuneToFire().group(net.minecraft.item.ItemGroup.FOOD).group(ModItemGroup.ERVIN_MOD_1_ITEMS).group(ModItemGroup.ERVIN_MOD_1_SEARCH), 128, 40000));
    public static final RegistryObject<Item> DURG = BURNABLE_FOODS.register("durg", () -> new UsingAndBurningItem((new Item.Properties()).food(Foods.DURG).isImmuneToFire().group(net.minecraft.item.ItemGroup.FOOD).group(ModItemGroup.ERVIN_MOD_1_ITEMS).group(ModItemGroup.ERVIN_MOD_1_SEARCH), 2048, 640000));
}
