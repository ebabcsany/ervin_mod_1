...
public class isBurnableFoodItemInit {
    ...
    public static final RegistryObject<Item> GRINT = BURNABLE_FOODS.register("grint", () -> new Item((new Item.Properties()).food(Foods.GRINT).isBurnable().group(ItemGroup.ERVIN_MOD_1_ITEMS).group(ItemGroup.ERVIN_MOD_1_SEARCH)));
    public static final RegistryObject<Item> DURG = BURNABLE_FOODS.register("durg", () -> new Item((new Item.Properties()).food(Foods.DURG).isBurnable().group(ItemGroup.ERVIN_MOD_1_ITEMS).group(ItemGroup.ERVIN_MOD_1_SEARCH)));
}
