...
public class ItemInit {
    ...
    public static final RegistryObject<com.babcsany.minecraft.ervin_mod_1.item.item.Item> REGDEMP = ITEMS.register("regdemp", () -> new com.babcsany.minecraft.ervin_mod_1.item.item.Item((new com.babcsany.minecraft.ervin_mod_1.item.item.Item.Properties().modFood(ModFoodInit.REGDEMP))));
