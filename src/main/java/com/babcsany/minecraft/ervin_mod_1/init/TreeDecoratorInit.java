...
public class TreeDecoratorInit {
    ...
    //public static final RegistryObject<TreeDecoratorType<BeehiveTreeDecorator>> BEEHIVE = TREE_DECORATOR_TYPES.register("beehive", BeehiveTreeDecorator.field_236863_a_);
