...
public class ModSpawnEggItemInit {
    ...
    public static final RegistryObject<SpawnEggItem> GUBROV_SPAWN_EGG = SPAWN_EGGS.register("spawn_eggs/gubrov_spawn_egg", () -> new ModSpawnEggItem(EntityInit.GUBROV_ENTITY, 0x365a20, 0x143827, new Item.Properties().group(ItemGroup.ERVIN_MOD_1_SPAWN_EGGS)));
    ...
    //public static final RegistryObject<SpawnEggItem1> LIWRAY_SPAWN_EGG = SPAWN_EGGS.register("spawn_eggs/liwray_spawn_egg", () -> new SpawnEggItem1(EntityInit.LIWRAY, new Item.Properties().group(ItemGroup.ERVIN_MOD_1_SPAWN_EGGS)));    public static final RegistryObject<SpawnEggItem> ROVENT_SPAWN_EGG = SPAWN_EGGS.register("spawn_eggs/rovent_spawn_egg", () -> new ModSpawnEggItem(EntityInit.ROVENT_ENTITY, 0x244830, 0x28384e, new Item.Properties().group(ItemGroup.ERVIN_MOD_1_SPAWN_EGGS)));
    public static final RegistryObject<SpawnEggItem> SRACH_SPAWN_EGG = SPAWN_EGGS.register("spawn_eggs/srach_spawn_egg", () -> new ModSpawnEggItem(EntityInit.SRACH_ENTITY, 0x8000ff, 0x8000ff, new Item.Properties().group(ItemGroup.ERVIN_MOD_1_SPAWN_EGGS)));
    ...
    //public static final RegistryObject<SpawnEggItem> ZUR_SPAWN_EGG = SPAWN_EGGS.register("spawn_eggs/zur_spawn_egg", () -> new ModSpawnEggItem(EntityInit.ZUR_ENTITY, 0x6ea587, 0x446648, new Item.Properties().group(ItemGroup.ERVIN_MOD_1_SPAWN_EGGS)));
    public static final RegistryObject<SpawnEggItem1> ZUR_SPAWN_EGG = SPAWN_EGGS.register("spawn_eggs/zur_spawn_egg", () -> new SpawnEggItem1(EntityInit.ZUR_ENTITY, new Item.Properties().group(ItemGroup.ERVIN_MOD_1_SPAWN_EGGS)));
