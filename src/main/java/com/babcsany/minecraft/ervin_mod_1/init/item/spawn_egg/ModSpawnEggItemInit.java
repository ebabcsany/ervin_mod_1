...
public class ModSpawnEggItemInit {
    ...
    public static final Item GUBROV_SPAWN_EGG = register("ervin_mod_1:spawn_eggs/gubrov_spawn_egg", new SpawnEggItem1(com.babcsany.minecraft.init.EntityInit.GUBROV_ENTITY, new Item.Properties().group(ItemGroup.ERVIN_MOD_1_SPAWN_EGGS)));
