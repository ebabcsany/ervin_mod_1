...
public class BlockInit {
    ...
    public static final Block ENDER_TRASKRACH = register("ender_traskrach", new Block(Block.Properties.create(Material.ORGANIC).setRequiresTool().harvestLevel(4).harvestTool(ToolType.HOE).hardnessAndResistance(80.0f)));
    public static final Block ENDER_TRASKCRAFTH = register("ender_traskcrafth", new Block(Block.Properties.create(Material.ORGANIC).setRequiresTool().harvestLevel(5).hardnessAndResistance(100.0f)));
    public static final Block SCRAFTH = register("scrafth", new Block(Block.Properties.create(Material.ROCK).harvestLevel(0).harvestTool(ToolType.PICKAXE).hardnessAndResistance(10.0f)));
    public static final Block VIRK_BLOCK = register("virk_block", new Block(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(5).harvestTool(ToolType.PICKAXE).hardnessAndResistance(650.0f)));
    ...
    public static final Block TERAT_BLOCK = register("terat_block", new Block(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(32).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1000000.0f)));
    public static final Block GRITH_BLOCK = register("grith_block", new Block(Block.Properties.create(Material.ROCK, MaterialColor.SNOW).setRequiresTool().harvestLevel(80).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1000000000000000.0F).setLightLevel(Value -> 15)));
    public static final Block GRITH_SLAB = register("grith_slab", new SlabBlock(Block.Properties.create(Material.ROCK, MaterialColor.SNOW).setRequiresTool().harvestLevel(78).harvestTool(ToolType.PICKAXE).hardnessAndResistance(1000000000000000.0F,500000000000000.0F).setLightLevel(Value -> 15)));
    public static final Block GRITH_STAIRS = register("grith_stairs", new StairsBlock(GRITH_BLOCK::getDefaultState, Block.Properties.from(GRITH_BLOCK)));
    ...
    public static final Block ZUNK_SLAB = register("zunk_slab", new SlabBlock(Block.Properties.create(Material.ROCK).setRequiresTool().harvestLevel(1).harvestTool(ToolType.SHOVEL).hardnessAndResistance(30.0F, 50.0F)));
    public static final Block ZUNK_STAIRS = register("zunk_stairs", new StairsBlock(ZUNK_BLOCK::getDefaultState, Block.Properties.from(ZUNK_BLOCK)));
    ...
    public static final Block THUIRTH_RAIL = register("thuirth_rail", new ModPoweredRailBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().hardnessAndResistance(436.5F).sound(SoundType.METAL), true));
    public static final Block THUFR = register("special/thufr", new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BLACK).setRequiresTool().harvestLevel(119).hardnessAndResistance(2543624320164279125.5F).sound(SoundType.STONE)));
    public static final Block CHARCOAL_BLOCK = register("charcoal_block", new Block(Block.Properties.create(Material.ROCK).setRequiresTool().hardnessAndResistance(5.0F, 6.0F)));
