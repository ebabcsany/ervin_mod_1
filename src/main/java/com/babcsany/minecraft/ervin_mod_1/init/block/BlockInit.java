...
public class BlockInit {
    ...
    public static final RegistryObject<Block> REPEATER_FRISZERN = BLOCKS.register("repeater_friszern", () -> new Friszern(AbstractBlock.Properties.create(Material.IRON, MaterialColor.BROWN).setRequiresTool().hardnessAndResistance(3600000.0F)));
