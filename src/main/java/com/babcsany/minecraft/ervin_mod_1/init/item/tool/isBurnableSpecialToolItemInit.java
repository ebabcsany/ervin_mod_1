...
import com.babcsany.minecraft.ervin_mod_1.item.items.TeratStick;
...
public class isBurnableSpecialToolItemInit {
    ...
    public static final RegistryObject<Item> TERAT = BURNABLE_ITEMS.register("terat", () -> new Terat((new Item.Properties()).isBurnable().maxStackSize(64)));
    public static final RegistryObject<Item> TERAT_STICK = BURNABLE_ITEMS.register("stick/terat_stick", () -> new TeratStick((new Item.Properties()).isBurnable().maxStackSize(64)));
    public static final RegistryObject<Item> THUFR = BURNABLE_ITEMS.register("special/thufr", () -> new ThufrBlockItem(BlockInit.THUFR.get(), ((new Item.Properties()).isBurnable())));
