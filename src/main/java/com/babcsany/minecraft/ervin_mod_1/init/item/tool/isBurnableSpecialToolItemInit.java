...
public class isBurnableSpecialToolItemInit {
    ...
    public static final RegistryObject<ThufrBlockItem> THUFR = BURNABLE_ITEMS.register("special/thufr", () -> new ThufrBlockItem(BlockInit.THUFR.get(), ModItemTier2.THUFR,54326578.0F, ((new TieredBlockItem_1.Properties()).isBurnable()).maxStackSize(2048)));
