...
public class isBurnableSpecialToolItemInit {
    ...
    public static final RegistryObject<Item> THUFR_PICKAXE = BURNABLE_ITEMS.register("tools/pickaxe/thufr_pickaxe", () -> new Thufr(ModItemTier_.THUFR,3917877926.0F, 8723146536.0F, (new Item.Properties()).isImmuneToFire()));
    public static final RegistryObject<Item> THUFR_SHOVEL = BURNABLE_ITEMS.register("tools/shovel/thufr_shovel", () -> new ShovelItem(ModItemTier_.THUFR,245839647.0F, 13187263405.0F, (new Item.Properties()).isImmuneToFire()));
    public static final RegistryObject<Item> THUFR_SWORD = BURNABLE_ITEMS.register("tools/sword/thufr_sword", () -> new ThufrSword(ModItemTier_.THUFR,768707893, 34629186075.0F, (new Item.Properties()).isImmuneToFire()));
}
