...
public abstract class World extends net.minecraft.world.World {
    ...
    public static final RegistryKey<net.minecraft.world.World> EXAMPLE_WORLD = RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation(Ervin_mod_1.MOD_ID,"example_world"));
