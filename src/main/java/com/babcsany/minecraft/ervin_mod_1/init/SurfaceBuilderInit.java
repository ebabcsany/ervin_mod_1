...
public class SurfaceBuilderInit {
    ...
    public static final Block AIR = BlockItemInit.AIR.get();
    ...
    public static final BlockState DEF_BLOCK = BlockItemInit.DEFERRED_BLOCK.get().getDefaultState();
    public static final SurfaceBuilderConfig STONE_STONE_GRAVEL_CONFIG = new SurfaceBuilderConfig(STONE, AIR.getDefaultState(), GRAVEL);
