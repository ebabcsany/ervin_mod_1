...
public final class ModDimensionSettings {
   ...
   private ModDimensionSettings(DimensionStructuresSettings structures, NoiseSettings noise, BlockState defaultBlock, BlockState defaultFluid, int p_i231906_5_, int p_i231906_6_, int p_i231906_7_, boolean p_i231906_8_, Optional<ModDimensionSettings.Preset> p_i231906_9_) {
   ...
   public static class Preset {
      ...
      public static final ModDimensionSettings.Preset EXAMPLE = new ModDimensionSettings.Preset("example", (preset) -> createSettings(new DimensionStructuresSettings(false), BlockInit.FIRT_BLOCK.getDefaultState(), Blocks.AIR.getDefaultState(), preset));
      ...
      private static ModDimensionSettings createSettings(DimensionStructuresSettings structures, BlockState defaultBlock, BlockState defaultFluid, ModDimensionSettings.Preset preset, boolean disabledMobGeneration, boolean islandNoiseOverride) {
      ...
      private static ModDimensionSettings createSettings(DimensionStructuresSettings structures, boolean amplified, ModDimensionSettings.Preset preset) {
