...
public class TileEntityInit {
	...
	public static final RegistryObject<TileEntityType<FriszernTileEntity>> FRISZERN = TILE_ENTITY_TYPES.register("friszern", () -> TileEntityType.Builder.create(FriszernTileEntity::new, BlockInit.FRISZERN.get(), BlockInit.CHAIN_FRISZERN.get(), BlockInit.REPEATER_FRISZERN.get()).build(null));
