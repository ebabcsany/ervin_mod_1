...
public class SpecialBlockFoodItemInit {
    ...
    public static final RegistryObject<Item> VIRK_BLOCK = BURNABLE_FOOD_BLOCK_ITEMS.register("virk_block", () -> new ModBlockItem(BlockInit.VIRK_BLOCK.get(), (new Item.Properties()).isBurnable().food(Foods.VIRK_BLOCK).group(ItemGroup.ERVIN_MOD_1_SEARCH)));
