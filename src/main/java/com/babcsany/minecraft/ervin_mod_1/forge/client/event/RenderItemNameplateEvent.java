...
package com.babcsany.minecraft.ervin_mod_1.forge.client.event;
 ...
 **/
@Event.HasResult
public class RenderItemNameplateEvent extends EntityEvent
{
    ...
    public RenderItemNameplateEvent(ItemEntity entity, ITextComponent content, EntityRenderer<?> entityRenderer, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, int packedLight)
    {
        super(entity);
