...
package com.babcsany.minecraft.ervin_mod_1.registries;
...
public class ForgeRegistries1
{
    ...
    public static final IForgeRegistry<NirtreProfession> NIRTRE_PROFESSIONS = RegistryManager.ACTIVE.getRegistry(NirtreProfession.class);
