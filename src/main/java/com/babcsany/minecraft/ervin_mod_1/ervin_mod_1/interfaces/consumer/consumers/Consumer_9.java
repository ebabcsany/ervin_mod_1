...
/**
 * An operation that accepts 9 input arguments and returns no result.
 *
 ...
 * @since 2.7
 */
public interface Consumer_9<K, V, S, D, G, H, R, E, F> {
     ...
     */
    void accept(K k, V v, S s, D d, G g, H h, R r, E e, F f);
}
