...
/**
 * An operation that accepts 26 input arguments and returns no result.
 *
 ...
 * @since 2.7
 */
public interface Consumer_26<K, V, S, D, G, H, R, E, F, O, N, L, P, W, A, M, C, B, X, J, I, U, Z, T, Q, Y> {
     ...
     */
    void accept(K k, V v, S s, D d, G g, H h, R r, E e, F f, O o, N n, L l, P p, W w, A a, M m, C c, B b, X x, J j, I i, U u, Z z, T t, Q q, Y y);
}
