...
/**
 * An operation that accepts 8 input arguments and returns no result.
 *
 ...
 * @since 2.7
 */
public interface Consumer_8<K, V, S, D, G, H, R, E> {
     ...
     */
    void accept(K k, V v, S s, D d, G g, H h, R r, E e);
}
