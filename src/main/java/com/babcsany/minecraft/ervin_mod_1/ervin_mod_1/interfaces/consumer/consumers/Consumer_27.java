...
/**
 * An operation that accepts 27 input arguments and returns no result.
 *
 ...
 * @param <I> type of the 21. argument
 * @param <U> type of the 22. argument
 * @param <Z> type of the 23. argument
 * @param <T> type of the 24. argument
 * @param <Q> type of the 25. argument
 * @param <Y> type of the 26. argument
 * @param <KA> type of the 27. argument
 * @see ReadOnlyStringMap
 * @since 2.7
 */
public interface Consumer_27<K, V, S, D, G, H, R, E, F, O, N, L, P, W, A, M, C, B, X, J, I, U, Z, T, Q, Y, KA> {
     ...
     * @param i the 21. input argument
     * @param u the 22. input argument
     * @param z the 23. input argument
     * @param t the 24. input argument
     * @param q the 25. input argument
     * @param y the 26. input argument
     * @param ka the 27. input argument
     */
    void accept(K k, V v, S s, D d, G g, H h, R r, E e, F f, O o, N n, L l, P p, W w, A a, M m, C c, B b, X x, J j, I i, U u, Z z, T t, Q q, Y y, KA ka);
}
