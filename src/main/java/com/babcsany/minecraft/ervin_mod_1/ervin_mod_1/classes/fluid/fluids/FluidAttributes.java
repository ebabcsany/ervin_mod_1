...
public class FluidAttributes
{
    ...
    protected FluidAttributes(Builder builder, ModFlowingFluid fluid)
    {
    ...
    /**
     * Called instead of placing the fluid block if {//@link net.minecraft.world.Dimension#doesWaterVaporize()} and {@link #doesVaporize(IBlockDisplayReader, BlockPos, FluidStack)} are true.
    ...
    public static class Builder
    {
        ...
        private BiFunction<Builder, ModFlowingFluid,FluidAttributes> factory;

        protected Builder(ResourceLocation stillTexture, ResourceLocation flowingTexture, BiFunction<Builder, ModFlowingFluid,FluidAttributes> factory) {
        ...
        public FluidAttributes build(ModFlowingFluid fluid)
        {
    ...
    {
        protected Water(Builder builder, ModFlowingFluid fluid)
        {
            super(builder, fluid);
        }
