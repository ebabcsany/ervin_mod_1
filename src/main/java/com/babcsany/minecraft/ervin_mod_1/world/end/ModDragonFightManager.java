package com.babcsany.minecraft.ervin_mod_1.world.end;

import com.babcsany.minecraft.ervin_mod_1.world.BossInfo;
import com.babcsany.minecraft.ervin_mod_1.world.server.ServerBossInfo;
...
import net.minecraft.world.end.DragonSpawnStatet;
...
public class ModDragonFightManager {
   ...
   private final ServerBossInfo bossInfo = (ServerBossInfo)(new ServerBossInfo(new TranslationTextComponent("entity.minecraft.ender_dragon"), BossInfo.Color.RED, BossInfo.Overlay.PROGRESS)).setPlayEndBossMusic(true).setCreateFog(true);
   ...
   private DragonSpawnStatet respawnState;
   private int respawnStateTicks;
   private List<EnderCrystalEntity> crystals;

   public ModDragonFightManager(ServerWorld p_i231901_1_, long p_i231901_2_, CompoundNBT p_i231901_4_) {
      ...
      if (p_i231901_4_.contains("DragonKilled", 99)) {
         ...
         if (p_i231901_4_.getBoolean("IsRespawning")) {
            this.respawnState = DragonSpawnStatet.START;
         }
   ...
   public void setRespawnState(DragonSpawnStatet state) {
      if (this.respawnState == null) {
         throw new IllegalStateException("Dragon respawn isn't in progress, can't skip ahead in the animation.");
      } else {
         this.respawnStateTicks = 0;
         if (state == DragonSpawnStatet.END) {
            this.respawnState = null;
            this.dragonKilled = false;
