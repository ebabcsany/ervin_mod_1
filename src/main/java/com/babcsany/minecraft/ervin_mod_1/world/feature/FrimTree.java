...
public class FrimTree extends Tree {
    ...
    public static final BaseTreeFeatureConfig FRIM_TREE_CONFIG0 = (new BaseTreeFeatureConfig.Builder(
            new SimpleBlockStateProvider(BlockItemInit.FRIM_LOG.getBlock().getDefaultState()),
            new SimpleBlockStateProvider(BlockItemInit.FRIM_LEAVES.getBlock().getDefaultState()),
