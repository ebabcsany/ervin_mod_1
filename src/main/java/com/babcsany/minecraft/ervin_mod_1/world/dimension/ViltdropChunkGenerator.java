...
/*public class ViltdropChunkGenerator extends NoiseChunkGenerator<ViltdropGenSettings> {
    ...
    public ViltdropChunkGenerator(IWorld worldIn, BiomeProvider provider, ExampleGenSettings settingsIn) {
