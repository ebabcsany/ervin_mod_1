...
public class FirgChunkGenerator extends NoiseChunkGenerator<FirgGenSettings> {
	...
	public FirgChunkGenerator(IWorld worldIn, BiomeProvider provider, FirgGenSettings settingsIn) {
