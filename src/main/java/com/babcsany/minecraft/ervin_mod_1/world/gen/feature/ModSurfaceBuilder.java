...
public abstract class ModSurfaceBuilder<C extends ISurfaceBuilderConfig> extends SurfaceBuilder<C> {
    ...
    public static final SurfaceBuilderConfig SCRAFTH_CONFIG = register(SCRAFTH);
    public static final SurfaceBuilderConfig FIRG_CONFIG = register(FIRG);
    public static final SurfaceBuilderConfig TWUST_CONFIG = register(GRASS_BLOCK, GTRZIUZHIZJKJ, SCRAFTH);
    public static final SurfaceBuilderConfig BLOMUJN_CONFIG = register(DIRT, OBSIDIAN, TERAT_BLOCK);

    public ModSurfaceBuilder(Codec<C> codec) {
        super(codec);
    }

    public static SurfaceBuilderConfig modRegister(String material) {
        return modRegister(material, material, material);
    }

    public static SurfaceBuilderConfig modRegister21(String topAndUnderMaterial, String underWaterMaterial) {
        return modRegister(topAndUnderMaterial, topAndUnderMaterial, underWaterMaterial);
    }

    public static SurfaceBuilderConfig modRegister12(String topMaterial, String underAndWaterMaterial) {
        return modRegister(topMaterial, underAndWaterMaterial, underAndWaterMaterial);
    }
    ...
    public static SurfaceBuilderConfig register(String material) {
        return register(material, material, material);
    }

    public static SurfaceBuilderConfig register21(String namespace, String topAndUnderMaterial, String underWaterMaterial) {
        return register(namespace, topAndUnderMaterial, underWaterMaterial);
    }

    public static SurfaceBuilderConfig register12(String namespace, String topMaterial, String underAndWaterMaterial) {
        return register(namespace, topMaterial, underAndWaterMaterial);
    }
    ...
    public static SurfaceBuilderConfig register(Block material) {
        return register(material, material, material);
    }

    public static SurfaceBuilderConfig register21(Block topAndUnderMaterial, Block underWaterMaterial) {
        return register(topAndUnderMaterial, topAndUnderMaterial, underWaterMaterial);
    }

    public static SurfaceBuilderConfig register12(Block topMaterial, Block underAndWaterMaterial) {
        return register(topMaterial, underAndWaterMaterial, underAndWaterMaterial);
    }
    ...
    public static SurfaceBuilderConfig register(BlockState material) {
        return register(material, material, material);
    }

    public static SurfaceBuilderConfig register(ModBlockState material) {
        return register(material, material, material);
    }

    public static SurfaceBuilderConfig register21(ModBlockState topAndUnderMaterial, ModBlockState underWaterMaterial) {
        return register21(topAndUnderMaterial.state, underWaterMaterial.state);
    }

    public static SurfaceBuilderConfig register12(ModBlockState topMaterial, ModBlockState underAndWaterMaterial) {
        return register12(topMaterial.state, underAndWaterMaterial.state);
    }
    ...
    public static SurfaceBuilderConfig register21(BlockState topAndUnderMaterial, BlockState underWaterMaterial) {
        return register(topAndUnderMaterial, topAndUnderMaterial, underWaterMaterial);
    }

    public static SurfaceBuilderConfig register12(BlockState topMaterial, BlockState underAndWaterMaterial) {
        return register(topMaterial, underAndWaterMaterial, underAndWaterMaterial);
    }
