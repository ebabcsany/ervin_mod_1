...
public abstract class Biome1 extends net.minecraftforge.registries.ForgeRegistryEntry<Biome1> {
   public static final Logger LOGGER = LogManager.getLogger();
   public static final Set<Biome1> BIOMES = Sets.newHashSet();
   public static final ObjectIntIdentityMap<Biome1> MUTATION_TO_BASE_ID_MAP = new ObjectIntIdentityMap<>();
   ...
   protected final Biome1.Category category;
   protected final Biome1.RainType precipitation;
   ...
   private final Map<EntityClassification, List<Biome1.SpawnListEntry1>> spawns = Maps.newHashMap();
   ...
   /*@Nullable
   public static Biome1 getMutationForBiome(Biome1 biome) {
   ...
   protected Biome1(Biome1.Builder biomeBuilder) {
   ...
   protected void addSpawn(EntityClassification type, Biome1.SpawnListEntry1 spawnListEntry) {
    ...
    */
   public List<Biome1.SpawnListEntry1> getSpawns(EntityClassification creatureType) {
      return this.spawns.computeIfAbsent(creatureType, k -> Lists.newArrayList());
   }

   public Biome1.RainType getPrecipitation() {
   ...
   public Biome1.TempCategory getTempCategory() {
      if (this.category == Biome1.Category.OCEAN) {
         return Biome1.TempCategory.OCEAN;
      } else if ((double)this.getDefaultTemperature() < 0.2D) {
         return Biome1.TempCategory.COLD;
      } else {
         return (double)this.getDefaultTemperature() < 1.0D ? Biome1.TempCategory.MEDIUM : Biome1.TempCategory.WARM;
      }
   }
   ...
   public final Biome1.Category getCategory() {
   ...
   public static class Builder {
      ...
      @Nullable
      private Biome1.RainType precipitation;
      @Nullable
      private Biome1.Category category;
      @Nullable
      private Float depth;
      @Nullable
      private Float scale;
      ...
      public <SC extends ISurfaceBuilderConfig> Biome1.Builder surfaceBuilder(SurfaceBuilder<SC> surfaceBuilderIn, SC surfaceBuilderConfigIn) {
         this.surfaceBuilder = new ConfiguredSurfaceBuilder<>(surfaceBuilderIn, surfaceBuilderConfigIn);
         return this;
      }

      public Biome1.Builder surfaceBuilder(ConfiguredSurfaceBuilder<?> surfaceBuilderIn) {
         this.surfaceBuilder = surfaceBuilderIn;
         return this;
      }

      public Biome1.Builder precipitation(Biome1.RainType precipitationIn) {
         this.precipitation = precipitationIn;
         return this;
      }

      public Biome1.Builder category(Biome1.Category biomeCategory) {
         this.category = biomeCategory;
         return this;
      }

      public Biome1.Builder depth(float depthIn) {
         this.depth = depthIn;
         return this;
      }

      public Biome1.Builder scale(float scaleIn) {
         this.scale = scaleIn;
         return this;
      }

      public Biome1.Builder temperature(float temperatureIn) {
         this.temperature = temperatureIn;
         return this;
      }

      public Biome1.Builder downfall(float downfallIn) {
         this.downfall = downfallIn;
         return this;
      }

      public Biome1.Builder waterColor(int waterColorIn) {
         this.waterColor = waterColorIn;
         return this;
      }

      public Biome1.Builder waterFogColor(int waterFogColorIn) {
         this.waterFogColor = waterFogColorIn;
         return this;
      }

      public Biome1.Builder parent(@Nullable String parentIn) {
   ...
   public static enum Category {
      ...
      private static final Map<String, Biome1.Category> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Biome1.Category::getName, (p_222353_0_) -> {
         return p_222353_0_;
      }));
   ...
   public static enum RainType {
      ...
      private static final Map<String, Biome1.RainType> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Biome1.RainType::getName, (p_222360_0_) -> {
         return p_222360_0_;
      }));
      private final String name;
   ...
   public static class SpawnListEntry1 extends WeightedRandom.Item {
      public final EntityType<?> entityType;
      public final int minGroupCount;
      public final int maxGroupCount;

      public SpawnListEntry1(EntityType<?> entityTypeIn, int weight, int minGroupCountIn, int maxGroupCountIn) {
         super(weight);
   ...
   public static enum TempCategory {
      ...
      private static final Map<String, Biome1.TempCategory> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Biome1.TempCategory::getName, (p_222356_0_) -> {
         return p_222356_0_;
      }));
      private final String name;
