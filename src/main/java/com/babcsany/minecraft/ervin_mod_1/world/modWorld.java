...
public class modWorld extends iorld {

    public static final Logger LOGGER = iorld.LOGGER;
    public final int DIST_HASH_MAGIC_ = this.DIST_HASH_MAGIC;

    public modWorld(ISpawnWorldInfo p_i231617_1_, RegistryKey<iorld> p_i231617_2_, RegistryKey<DimensionType> p_i231617_3_, DimensionType p_i231617_4_, Supplier<IProfiler> p_i231617_5_, boolean p_i231617_6_, boolean p_i231617_7_, long p_i231617_8_) {
