...
public final class ModNoiseChunkGenerator extends ChunkGenerator {
   public static final Codec<ModNoiseChunkGenerator> field_236079_d_ = RecordCodecBuilder.create((p_236091_0_) -> p_236091_0_.group(BiomeProvider.PROVIDER_CODEC.fieldOf("biome_source").forGetter((p_236096_0_) -> p_236096_0_.biomeProvider), Codec.LONG.fieldOf("seed").stable().forGetter((p_236093_0_) -> p_236093_0_.Long), ModDimensionSettings.field_236098_b_.fieldOf("settings").forGetter((p_236090_0_) -> p_236090_0_.modDimensionSettings)).apply(p_236091_0_, p_236091_0_.stable(ModNoiseChunkGenerator::new)));
   ...
   private final OctavesNoiseGenerator octavesNoiseGenerator;
   private final OctavesNoiseGenerator octavesNoiseGenerator1;
   private final OctavesNoiseGenerator octavesNoiseGenerator2;
   private final INoiseGenerator surfaceDepthNoise;
   private final OctavesNoiseGenerator octavesNoiseGenerator3;
   @Nullable
   private final SimplexNoiseGenerator simplexNoiseGenerator;
   protected final BlockState defaultBlock;
   protected final BlockState defaultFluid;
   private final long Long;
   protected final ModDimensionSettings modDimensionSettings;
   private final int Int;

   public ModNoiseChunkGenerator(BiomeProvider biomeProvider, long l, ModDimensionSettings modDimensionSettings) {
      this(biomeProvider, biomeProvider, l, modDimensionSettings);
   }

   private ModNoiseChunkGenerator(BiomeProvider biomeProvider, BiomeProvider biomeProvider1, long l, ModDimensionSettings modDimensionSettings) {
      super(biomeProvider, biomeProvider1, modDimensionSettings.getStructures(), l);
      this.Long = l;
      this.modDimensionSettings = modDimensionSettings;
      NoiseSettings noisesettings = modDimensionSettings.getNoise();
      this.Int = noisesettings.func_236169_a_();
      ...
      this.defaultBlock = modDimensionSettings.getDefaultBlock();
      this.defaultFluid = modDimensionSettings.getDefaultFluid();
      ...
      this.octavesNoiseGenerator = new OctavesNoiseGenerator(this.randomSeed, IntStream.rangeClosed(-15, 0));
      this.octavesNoiseGenerator1 = new OctavesNoiseGenerator(this.randomSeed, IntStream.rangeClosed(-15, 0));
      this.octavesNoiseGenerator2 = new OctavesNoiseGenerator(this.randomSeed, IntStream.rangeClosed(-7, 0));
      ...
      this.octavesNoiseGenerator3 = new OctavesNoiseGenerator(this.randomSeed, IntStream.rangeClosed(-15, 0));
      if (noisesettings.func_236180_k_()) {
         SharedSeedRandom sharedseedrandom = new SharedSeedRandom(l);
         sharedseedrandom.skip(17292);
         this.simplexNoiseGenerator = new SimplexNoiseGenerator(sharedseedrandom);
      } else {
         this.simplexNoiseGenerator = null;
      }
   ...
   public ChunkGenerator func_230349_a_(long p_230349_1_) {
      return new ModNoiseChunkGenerator(this.biomeProvider.func_230320_a_(p_230349_1_), p_230349_1_, this.modDimensionSettings);
   }

   public boolean func_236088_a_(long p_236088_1_, ModDimensionSettings.Preset p_236088_3_) {
      return this.Long == p_236088_1_ && this.modDimensionSettings.func_236109_a_(p_236088_3_);
   }
   ...
   private double func_222552_a(int p_222552_1_, int p_222552_2_, int p_222552_3_, double p_222552_4_, double p_222552_6_, double p_222552_8_, double p_222552_10_) {
      ...
      for(int i = 0; i < 16; ++i) {
         ...
         ImprovedNoiseGenerator improvednoisegenerator = this.octavesNoiseGenerator.getOctave(i);
         if (improvednoisegenerator != null) {
            d0 += improvednoisegenerator.func_215456_a(d4, d5, d6, d7, (double)p_222552_2_ * d7) / d3;
         }

         ImprovedNoiseGenerator improvednoisegenerator1 = this.octavesNoiseGenerator1.getOctave(i);
         if (improvednoisegenerator1 != null) {
            d1 += improvednoisegenerator1.func_215456_a(d4, d5, d6, d7, (double)p_222552_2_ * d7) / d3;
         }

         if (i < 8) {
            ImprovedNoiseGenerator improvednoisegenerator2 = this.octavesNoiseGenerator2.getOctave(i);
   ...
   private void fillNoiseColumn(double[] noiseColumn, int noiseX, int noiseZ) {
      NoiseSettings noisesettings = this.modDimensionSettings.getNoise();
      double d0;
      double d1;
      if (this.simplexNoiseGenerator != null) {
         d0 = EndBiomeProvider.func_235317_a_(this.simplexNoiseGenerator, noiseX, noiseZ) - 8.0F;
         if (d0 > 0.0D) {
            d1 = 0.25D;
         } else {
            d1 = 1.0D;
   ...
   private double func_236095_c_(int p_236095_1_, int p_236095_2_) {
      double d0 = this.octavesNoiseGenerator3.getValue(p_236095_1_ * 200, 10.0D, (double)(p_236095_2_ * 200), 1.0D, 0.0D, true);
      double d1;
      if (d0 < 0.0D) {
         d1 = -d0 * 0.3D;
      } else {
   ...
   public int getHeight(int x, int z, net.minecraft.world.gen.Heightmap.Type heightmapType) {
   ...
   public void generateSurface(WorldGenRegion p_225551_1_, IChunk p_225551_2_) {
      ...
      for(int i1 = 0; i1 < 16; ++i1) {
         for(int j1 = 0; j1 < 16; ++j1) {
            int k1 = k + i1;
            int l1 = l + j1;
            int i2 = p_225551_2_.getTopBlockY(net.minecraft.world.gen.Heightmap.Type.WORLD_SURFACE_WG, i1, j1) + 1;
   ...
   private void makeBedrock(IChunk chunkIn, Random rand) {
      ...
      int k = this.modDimensionSettings.func_236118_f_();
      int l = this.Int - 1 - this.modDimensionSettings.func_236117_e_();
      int i1 = 5;
      boolean flag = l + 4 >= 0 && l < this.Int;
      boolean flag1 = k + 4 >= 0 && k < this.Int;
      if (flag || flag1) {
   ...
   public void func_230352_b_(IWorld p_230352_1_, StructureManager p_230352_2_, IChunk p_230352_3_) {
      ...
      net.minecraft.world.gen.Heightmap heightmap = chunkprimer.getHeightmap(net.minecraft.world.gen.Heightmap.Type.OCEAN_FLOOR_WG);
      net.minecraft.world.gen.Heightmap heightmap1 = chunkprimer.getHeightmap(Heightmap.Type.WORLD_SURFACE_WG);
      BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable();
   ...
   public int func_230356_f_() {
      return this.modDimensionSettings.func_236119_g_();
   }
   ...
   public void func_230354_a_(WorldGenRegion worldGenRegion) {
      if (!this.modDimensionSettings.func_236120_h_()) {
