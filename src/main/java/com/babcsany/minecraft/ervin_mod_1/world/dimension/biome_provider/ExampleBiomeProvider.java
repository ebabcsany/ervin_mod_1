...
public class ExampleBiomeProvider extends ModBiomeProvider {
   ...
   public ExampleBiomeProvider(long p_i231640_1_, List<Pair<Biome.Attributes, Biome>> p_i231640_3_, Optional<ExampleBiomeProvider.Preset> p_i231640_4_) {
   ...
   private static ExampleBiomeProvider func_235285_d_(long p_235285_0_) {
      ImmutableList<Biome> immutablelist = ImmutableList.of(BiomeInit.EXAMPLE_BIOME.get());
      return new ExampleBiomeProvider(p_235285_0_, immutablelist.stream().flatMap((p_235273_0_) -> p_235273_0_.func_235055_B_().map((p_235274_1_) -> Pair.of(p_235274_1_, p_235273_0_))).collect(ImmutableList.toImmutableList()), Optional.of(ExampleBiomeProvider.Preset.field_235288_b_));
   }
   ...
   public ModBiomeProvider func_230320_a_(long p_230320_1_) {
      return new ExampleBiomeProvider(p_230320_1_, this.field_235268_k_, this.field_235271_n_);
   }
   ...
   public boolean func_235280_b_(long p_235280_1_) {
      return this.field_235270_m_ == p_235280_1_ && Objects.equals(this.field_235271_n_, Optional.of(ExampleBiomeProvider.Preset.field_235288_b_));
   }
   ...
   public static class Preset {
      ...
      public Preset(ResourceLocation p_i231641_1_, LongFunction<ExampleBiomeProvider> p_i231641_2_) {
