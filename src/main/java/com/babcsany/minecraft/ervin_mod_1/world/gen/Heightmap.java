...
import com.babcsany.minecraft.ervin_mod_1.world.chunk.IChunk;
...
public class Heightmap {
   ...
   public static enum Type implements IStringSerializable {
      ...
      MOTION_BLOCKING_NO_THUFR("MOTION_BLOCKING_THUFR", Usage.LIVE_WORLD, (p_222682_0_) -> (p_222682_0_.getMaterial().blocksMovement() || !p_222682_0_.getFluidState().isEmpty()) && !(p_222682_0_.getBlock() instanceof Thufr));
      ...
      Type(String idIn, Usage usageIn, Predicate<BlockState> heightLimitPredicateIn) {
         this.id = idIn;
         this.usage = usageIn;
