...
public class ExampleBiomeProvider1 extends BiomeProvider {
    public static final MapCodec<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1> field_235262_e_ = RecordCodecBuilder.mapCodec((p_235279_0_) -> {
        ...
        })).apply(p_235279_0_, com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1::new);
    });
    public static final Codec<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1> field_235263_f_ = Codec.mapEither(com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset.field_235287_a_, field_235262_e_).xmap((p_235277_0_) -> {
        return p_235277_0_.map((p_235278_0_) -> {
            return p_235278_0_.getFirst().func_235292_a_(p_235278_0_.getSecond());
        }, Function.identity());
    }, (p_235275_0_) -> {
        return p_235275_0_.field_235271_n_.<Either<Pair<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset, Long>, com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1>>map((p_235276_1_) -> {
    ...
    private final Optional<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset> field_235271_n_;

    private ExampleBiomeProvider1(long p_i231639_1_, List<Pair<Biome.Attributes, Biome>> p_i231639_3_) {
        this(p_i231639_1_, p_i231639_3_, Optional.empty());
    }

    public ExampleBiomeProvider1(long p_i231640_1_, List<Pair<Biome.Attributes, Biome>> p_i231640_3_, Optional<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset> p_i231640_4_) {
    ...
    private static com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1 func_235285_d_(long p_235285_0_) {
        ...
        return new com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1(p_235285_0_, immutablelist.stream().flatMap((p_235273_0_) -> {
            return p_235273_0_.func_235055_B_().map((p_235274_1_) -> {
                return Pair.of(p_235274_1_, p_235273_0_);
            });
        }).collect(ImmutableList.toImmutableList()), Optional.of(com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset.field_235288_b_));
    }
    ...
    public BiomeProvider func_230320_a_(long p_230320_1_) {
        return new com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1(p_230320_1_, this.field_235268_k_, this.field_235271_n_);
    }
    ...
    public boolean func_235280_b_(long p_235280_1_) {
        return this.field_235270_m_ == p_235280_1_ && Objects.equals(this.field_235271_n_, Optional.of(net.minecraft.world.biome.provider.NetherBiomeProvider.Preset.field_235288_b_));
    }

    public static class Preset {
        private static final Map<ResourceLocation, com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset> field_235289_c_ = Maps.newHashMap();
        public static final MapCodec<Pair<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset, Long>> field_235287_a_ = Codec.mapPair(ResourceLocation.RESOURCE_LOCATION_CODEC.flatXmap((p_235294_0_) -> {
        ...
        public static final com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset field_235288_b_ = new com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.Preset(new ResourceLocation("nether"), (p_235295_0_) -> {
            return com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1.func_235285_d_(p_235295_0_);
        });
        private final ResourceLocation field_235290_d_;
        private final LongFunction<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1> field_235291_e_;

        public Preset(ResourceLocation p_i231641_1_, LongFunction<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1> p_i231641_2_) {
            this.field_235290_d_ = p_i231641_1_;
            this.field_235291_e_ = p_i231641_2_;
            field_235289_c_.put(p_i231641_1_, this);
        }

        public com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider1 func_235292_a_(long p_235292_1_) {
