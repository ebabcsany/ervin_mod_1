...
public class WorldBorder1 extends WorldBorder {
   ...
   private int worldSize = 299999984;
   private WorldBorder1.IBorderInfo state = new WorldBorder1.StationaryBorderInfo(6.0E7D);
   ...
   public void setTransition(double newSize) {
      this.state = new WorldBorder1.StationaryBorderInfo(newSize);
   ...
   public void setTransition(double oldSize, double newSize, long time) {
      this.state = (WorldBorder1.IBorderInfo)(oldSize == newSize ? new WorldBorder1.StationaryBorderInfo(newSize) : new WorldBorder1.MovingBorderInfo(oldSize, newSize, time));
   ...
   interface IBorderInfo {
      ...
      WorldBorder1.IBorderInfo tick();

      VoxelShape getShape();
   }

   class MovingBorderInfo implements WorldBorder1.IBorderInfo {
      ...
      public double getMinX() {
         return Math.max(WorldBorder1.this.getCenterX() - this.getSize() / 2.0D, (double)(-WorldBorder1.this.worldSize));
      }

      public double getMinZ() {
         return Math.max(WorldBorder1.this.getCenterZ() - this.getSize() / 2.0D, (double)(-WorldBorder1.this.worldSize));
      }

      public double getMaxX() {
         return Math.min(WorldBorder1.this.getCenterX() + this.getSize() / 2.0D, (double) WorldBorder1.this.worldSize);
      }

      public double getMaxZ() {
         return Math.min(WorldBorder1.this.getCenterZ() + this.getSize() / 2.0D, (double) WorldBorder1.this.worldSize);
      }
      ...
      public WorldBorder1.IBorderInfo tick() {
         return (WorldBorder1.IBorderInfo)(this.getTimeUntilTarget() <= 0L ? WorldBorder1.this.new StationaryBorderInfo(this.newSize) : this);
      }
   ...
   class StationaryBorderInfo implements WorldBorder1.IBorderInfo {
      ...
      private void updateBox() {
         this.minX = Math.max(WorldBorder1.this.getCenterX() - this.size / 2.0D, (double)(-WorldBorder1.this.worldSize));
         this.minZ = Math.max(WorldBorder1.this.getCenterZ() - this.size / 2.0D, (double)(-WorldBorder1.this.worldSize));
         this.maxX = Math.min(WorldBorder1.this.getCenterX() + this.size / 2.0D, (double) WorldBorder1.this.worldSize);
         this.maxZ = Math.min(WorldBorder1.this.getCenterZ() + this.size / 2.0D, (double) WorldBorder1.this.worldSize);
