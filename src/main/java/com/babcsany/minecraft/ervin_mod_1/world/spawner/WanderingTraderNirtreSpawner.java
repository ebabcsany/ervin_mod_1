...
public class WanderingTraderNirtreSpawner implements ISpecialSpawner {
   ...
   public WanderingTraderNirtreSpawner(IServerWorldInfo p_i231576_1_) {
   ...
   private boolean func_234562_a_(ServerWorld p_234562_1_) {
      ...
      if (playerentity == null) {
         ...
         if (blockpos2 != null && this.func_234560_a_(p_234562_1_, blockpos2)) {
            ...
            WanderingTraderNirtreEntity wanderingtraderentity = EntityInit.WANDERING_TRADER_NIRTRE_ENTITY.get().spawn(p_234562_1_, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, blockpos2, SpawnReason.EVENT, false, false);
   ...
   private void func_221243_a(WanderingTraderNirtreEntity p_221243_1_, int p_221243_2_) {
