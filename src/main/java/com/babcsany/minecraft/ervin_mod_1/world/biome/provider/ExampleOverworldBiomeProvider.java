...
public class ExampleOverworldBiomeProvider extends BiomeProvider {
   public static final Codec<ExampleOverworldBiomeProvider> field_235297_e_ = RecordCodecBuilder.create((p_235302_0_) -> {
      ...
      })).apply(p_235302_0_, p_235302_0_.stable(ExampleOverworldBiomeProvider::new));
   });
   private final Layer genBiomes;
   private static final List<Biome> field_226847_e_ = ImmutableList.of(BiomeInit.MIG_BIOME.get(),
   ...
   public ExampleOverworldBiomeProvider(long p_i231643_1_, boolean p_i231643_3_, boolean p_i231643_4_) {
   ...
   public BiomeProvider func_230320_a_(long p_230320_1_) {
      return new ExampleOverworldBiomeProvider(p_230320_1_, this.field_235299_i_, this.field_235300_j_);
   }
