...
public class FirgTreeFeature extends AbstractTreeFeature<TreeFeatureConfig> {
   public FirgTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225803_1_) {
      super(p_i225803_1_);
   }

   private void func_227233_a_(IWorldGenerationReader p_1_, Random p_2_, BlockPos p_3_, float p_4_, Set<BlockPos> p_227233_5_, MutableBoundingBox p_227233_6_, TreeFeatureConfig p_227233_7_) {
      int i = (int)((double)p_4_ + 0.618D);

      for(int j = -i; j <= i; ++j) {
         for(int k = -i; k <= i; ++k) {
            if (Math.pow((double)Math.abs(j) + 0.5D, 2.0D) + Math.pow((double)Math.abs(k) + 0.5D, 2.0D) <= (double)(p_4_ * p_4_)) {
               this.func_227219_b_(p_1_, p_2_, p_3_.add(j, 0, k), p_227233_5_, p_227233_6_, p_227233_7_);
            }
         }
      }
   ...
   private void func_227232_a_(IWorldGenerationReader p_227232_1_, Random p_227232_2_, int p_227232_3_, BlockPos p_227232_4_, List<FirgTreeFeature.ExtendedPos> p_227232_5_, Set<BlockPos> p_227232_6_, MutableBoundingBox p_227232_7_, TreeFeatureConfig p_227232_8_) {
      for(FirgTreeFeature.ExtendedPos fancytreefeature$extendedpos : p_227232_5_) {
   ...
   private void func_227240_b_(IWorldGenerationReader p_227240_1_, Random p_227240_2_, int p_227240_3_, BlockPos p_227240_4_, List<FirgTreeFeature.ExtendedPos> p_227240_5_, Set<BlockPos> p_227240_6_, MutableBoundingBox p_227240_7_, TreeFeatureConfig p_227240_8_) {
      for(FirgTreeFeature.ExtendedPos fancytreefeature$extendedpos : p_227240_5_) {
   ...
   public boolean func_225557_a_(IWorldGenerationReader generationReader, Random rand, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, TreeFeatureConfig p_225557_7_) {
      ...
      if (i == -1) {
         ...
         this.setDirt(generationReader, p_225557_3_.down());
         ...
         int i1 = i - 5;
         List<FirgTreeFeature.ExtendedPos> list = Lists.newArrayList();
         list.add(new FirgTreeFeature.ExtendedPos(p_225557_3_.up(i1), l));
               ...
               for(int j1 = 0; j1 < k; ++j1) {
                  ...
                  if (this.func_227235_a_(generationReader, rand, blockpos, blockpos1, false, p_225557_4_, p_225557_6_, p_225557_7_) == -1) {
                     ...
                     if (this.func_227235_a_(generationReader, rand, blockpos2, blockpos, false, p_225557_4_, p_225557_6_, p_225557_7_) == -1) {
                        list.add(new FirgTreeFeature.ExtendedPos(blockpos, blockpos2.getY()));
                     }
                  }
               }
            }
