...
public class ModDefaultBiomeFeatures {
   ...
   public static void addOrangeStoneOres(Biome biomeIn) {
      //biomeIn.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, ORANGE_STONE, 39)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(100, 0, 0, 640))));
