...
public class ModDefaultBiomeFeatures {
   ...
   public static final TreeFeatureConfig FIRG_TREE_CONFIG = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(FIRG_LOG), new SimpleBlockStateProvider(FIRG_LOG), new BlobFoliagePlacer(6, 2))).baseHeight(3).heightRandA(1).foliageHeight(5).ignoreVines().setSapling((net.minecraftforge.common.IPlantable) BlockInit.FIRG_SAPLING.get()).build();
   public static final TreeFeatureConfig FIRG_TREE_CONFIG2 = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(FIRG), new SimpleBlockStateProvider(FIRG_LOG), new BlobFoliagePlacer(2, 2))).baseHeight(0).heightRandA(3).foliageHeight(1).ignoreVines().setSapling((net.minecraftforge.common.IPlantable) BlockInit.FIRG_SAPLING.get()).build();
   ...
   public static final HugeTreeFeatureConfig MEGA_FIRG_TREE_CONFIG = (new HugeTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FIRG_LOG), new SimpleBlockStateProvider(FIRG_LEAVES))).baseHeight(8).heightInterval(10).crownHeight(12).decorators(ImmutableList.of(new AlterGroundTreeDecorator(new SimpleBlockStateProvider(PODZOL)))).setSapling((net.minecraftforge.common.IPlantable) BlockInit.FIRG_SAPLING.get()).build();
