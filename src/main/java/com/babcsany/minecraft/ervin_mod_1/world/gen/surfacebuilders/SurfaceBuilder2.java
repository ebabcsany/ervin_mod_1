...
public class SurfaceBuilder2 {
   private static final BlockState field_237161_a_ = isBurnableBlockItemInit.GRITH_BLOCK.get().getDefaultState();
   private static final BlockState field_237161_b_ = BlockItemInit.RED_GRASS_BLOCK.get().getDefaultState();
   private static final BlockState field_237161_c_ = BlockItemInit.VIRK_BLOCK.get().getDefaultState();
   private static final BlockState field_237161_d_ = BlockItemInit.VILKT_BLOCK.get().getDefaultState();
   private static final BlockState field_237162_a_ = Blocks.DIRT.getDefaultState();
   private static final BlockState field_237162_b_ = Blocks.BASALT.getDefaultState();
   ...
   private static final BlockState field_237165_f_ = BlockItemInit.FIRG.get().getDefaultState();
   private static final BlockState field_237165_g_ = BlockItemInit.ENDER_SRACKTH.get().getDefaultState();
   private static final BlockState field_237165_h_ = BlockItemInit.ENDER_SRAKTCAF.get().getDefaultState();
   private static final BlockState field_237166_f_ = BlockItemInit.SCRAFTH.get().getDefaultState();
   private static final BlockState field_237166_g_ = BlockItemInit.AVTER_BLOCK.get().getDefaultState();
   private static final BlockState field_237166_h_ = BlockItemInit.SHZ_BLOCK.get().getDefaultState();
   private static final BlockState field_237166_i_ = BlockItemInit.ZURK_BLOCK.get().getDefaultState();
   private static final BlockState field_237167_g_ = BlockItemInit.DIAMOND_BLOCK.get().getDefaultState();
   private static final BlockState field_237167_h_ = BlockItemInit.TRUGK_BLOCK.get().getDefaultState();
   private static final BlockState field_237167_i_ = BlockItemInit.ZUNK_BLOCK.get().getDefaultState();
   private static final BlockState field_237167_j_ = BlockItemInit.LEAT_BLOCK.get().getDefaultState();
   ...
   private static final BlockState field_237168_j_ = BlockItemInit.ENDER_TRASKCRAFTH.get().getDefaultState();
   private static final BlockState field_237168_k_ = BlockItemInit.ENDER_TRASKRACH.get().getDefaultState();
   private static final ImmutableList<BlockState> field_237160_a_ = ImmutableList.of(field_237161_a_, field_237162_b_, field_237163_c_, field_237164_d_, field_237165_e_, field_237166_f_, field_237167_g_, field_237168_h_);
   private static final ImmutableList<BlockState> field_237160_b_ = ImmutableList.of(field_237161_b_, field_237162_c_, field_237163_d_, field_237164_e_, field_237165_f_, field_237166_g_, field_237167_h_, field_237168_i_);
   private static final ImmutableList<BlockState> field_237160_c_ = ImmutableList.of(field_237161_c_, field_237162_d_, field_237163_e_, field_237164_f_, field_237165_g_, field_237166_h_, field_237167_i_, field_237168_j_);
   private static final ImmutableList<BlockState> field_237160_d_ = ImmutableList.of(field_237161_d_, field_237162_e_, field_237163_f_, field_237164_g_, field_237165_h_, field_237166_i_, field_237167_j_, field_237168_k_);
   private static final ImmutableList<BlockState> field_237160_e_ = ImmutableList.of(field_237162_a_);
