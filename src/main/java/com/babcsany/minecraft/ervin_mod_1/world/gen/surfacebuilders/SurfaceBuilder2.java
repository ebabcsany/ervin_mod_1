...
public class SurfaceBuilder2 {
   ...
   private static final BlockState field_237161_b_ = BlockInit.RED_GRASS_BLOCK.get().getDefaultState();
   private static final BlockState field_237161_c_ = BlockInit.VIRK_BLOCK.get().getDefaultState();
   private static final BlockState field_237161_d_ = BlockInit.VILKT_BLOCK.get().getDefaultState();
   ...
   private static final BlockState field_237164_g_ = BlockInit.END_PORTAL.get().getDefaultState();
   private static final BlockState field_237165_e_ = BlockInit.ENDER_TRASK.get().getDefaultState();
   private static final BlockState field_237165_f_ = BlockInit.FIRG.get().getDefaultState();
   private static final BlockState field_237165_g_ = BlockInit.ENDER_SRACKTH.get().getDefaultState();
   ...
   private static final BlockState field_237166_g_ = BlockInit.AVTER_BLOCK.get().getDefaultState();
   private static final BlockState field_237166_h_ = BlockInit.SHZ_BLOCK.get().getDefaultState();
   private static final BlockState field_237166_i_ = BlockInit.ZURK_BLOCK.get().getDefaultState();
   private static final BlockState field_237167_g_ = BlockInit.DIAMOND_BLOCK.get().getDefaultState();
