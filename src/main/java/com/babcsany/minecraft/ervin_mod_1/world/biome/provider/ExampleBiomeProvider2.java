...
public class ExampleBiomeProvider2 extends BiomeProvider {
    public static final Codec<com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider2> field_235314_e_ = Codec.LONG.fieldOf("seed").xmap(com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider2::new, (p_235316_0_) -> {
    ...
    public ExampleBiomeProvider2(long p_i231645_1_) {
        super(END_BIOMES);
    ...
    public BiomeProvider func_230320_a_(long p_230320_1_) {
        return new com.babcsany.minecraft.ervin_mod_1.world.biome.provider.ExampleBiomeProvider2(p_230320_1_);
    }
