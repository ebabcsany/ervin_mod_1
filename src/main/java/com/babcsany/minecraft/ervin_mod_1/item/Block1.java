...
import com.babcsany.minecraft.ervin_mod_1.fluid.BlockState1;
...
public class Block1 {
/*public class Block1 extends net.minecraftforge.registries.ForgeRegistryEntry<Block1> implements IItemProvider, net.minecraftforge.common.extensions.IForgeBlock {
   ...
   protected final StateContainer<Block1, BlockState> stateContainer;
   ...
   @Nullable
   private Item item;
   private static final ThreadLocal<Object2ByteLinkedOpenHashMap<Block1.RenderSideCacheKey>> SHOULD_SIDE_RENDER_CACHE = ThreadLocal.withInitial(() -> {
      Object2ByteLinkedOpenHashMap<Block1.RenderSideCacheKey> object2bytelinkedopenhashmap = new Object2ByteLinkedOpenHashMap<Block1.RenderSideCacheKey>(2048, 0.25F) {
   ...
   public static BlockState1 getStateById(int id) {
      BlockState1 blockstate = BLOCK_STATE_IDS.getByValue(id);
      return blockstate == null ? Blocks.AIR.getDefaultState() : blockstate;
   }

   public static Block1 getBlockFromItem(@Nullable Item itemIn) {
      return itemIn instanceof BlockItem ? ((BlockItem)itemIn).getBlock() : Blocks.AIR;
   }

   public static BlockState1 nudgeEntitiesWithNewState(BlockState1 oldState, BlockState1 newState, World worldIn, BlockPos pos) {
   ...
   @Deprecated
   public boolean canEntitySpawn(BlockState1 state, IBlockReader worldIn, BlockPos pos, EntityType<?> type) {
      return state.isSolidSide(worldIn, pos, Direction.UP) && state.getLightValue(worldIn, pos) < 14;
   }

   @Deprecated
   public boolean isAir(BlockState1 state) {
      return false;
   }
    ...
    * /
   @Deprecated
   public int getLightValue(BlockState1 state) {
    ...
    * /
   @Deprecated
   public Material getMaterial(BlockState1 state) {
    ...
    * /
   @Deprecated
   public MaterialColor getMaterialColor(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
    ...
    * /
   @Deprecated
   public void updateNeighbors(BlockState1 stateIn, IWorld worldIn, BlockPos pos, int flags) {
      try (BlockPos.PooledMutable blockpos$pooledmutable = BlockPos.PooledMutable.retain()) {
         for(Direction direction : UPDATE_ORDER) {
            blockpos$pooledmutable.setPos(pos).move(direction);
            BlockState1 blockstate = worldIn.getBlockState(blockpos$pooledmutable);
            BlockState1 blockstate1 = blockstate.updatePostPlacement(direction.getOpposite(), stateIn, worldIn, blockpos$pooledmutable, pos);
   ...
   public boolean isIn(Tag<Block1> tagIn) {
    ...
    * /
   public static BlockState1 getValidBlockForPosition(BlockState1 currentState, IWorld worldIn, BlockPos pos) {
      BlockState1 blockstate = currentState;
    ...
    * World#setBlockState}
    * /
   public static void replaceBlock(BlockState1 oldState, BlockState1 newState, IWorld worldIn, BlockPos pos, int flags) {
    ...
    * /
   @Deprecated
   public void updateDiagonalNeighbors(BlockState1 state, IWorld worldIn, BlockPos pos, int flags) {
   }
    ...
    * /
   @Deprecated
   public BlockState1 updatePostPlacement(BlockState1 stateIn, Direction facing, BlockState1 facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      return stateIn;
   }
    ...
    * /
   @Deprecated
   public BlockState1 rotate(BlockState1 state, Rotation rot) {
      return state;
   }
    ...
    * /
   @Deprecated
   public BlockState1 mirror(BlockState1 state, Mirror mirrorIn) {
      return state;
   }

   public Block1(Block1.Properties properties) {
      StateContainer.Builder<Block1, BlockState> builder = new StateContainer.Builder<>(this);
      ...
      this.stateContainer = builder.create(BlockState1::new);
    ...
    * /
   public static boolean cannotAttach(Block1 blockIn) {
   ...
   @Deprecated
   public boolean isNormalCube(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
      return state.getMaterial().isOpaque() && state.isCollisionShapeOpaque(worldIn, pos) && !state.canProvidePower();
   }

   @Deprecated
   public boolean causesSuffocation(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
      return this.material.blocksMovement() && state.isCollisionShapeOpaque(worldIn, pos);
   }

   @Deprecated
   @OnlyIn(Dist.CLIENT)
   public boolean isViewBlocking(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
      return state.isSuffocating(worldIn, pos);
   }

   @Deprecated
   public boolean allowsMovement(BlockState1 state, IBlockReader worldIn, BlockPos pos, PathType type) {
      switch(type) {
      case LAND:
    ...
    * /
   @Deprecated
   public BlockRenderType getRenderType(BlockState1 state) {
      return BlockRenderType.MODEL;
   }

   @Deprecated
   public boolean isReplaceable(BlockState1 state, BlockItemUseContext useContext) {
      return state.getMaterial().isReplaceable() && (useContext.getItem().isEmpty() || useContext.getItem().getItem() != this.asItem());
   }

   @Deprecated
   public boolean isReplaceable(BlockState1 p_225541_1_, Fluid p_225541_2_) {
    ...
    * /
   @Deprecated
   public float getBlockHardness(BlockState1 blockState, IBlockReader worldIn, BlockPos pos) {
    ...
    * /
   public boolean ticksRandomly(BlockState1 state) {
   ...
   @Deprecated
   public boolean needsPostProcessing(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
      return false;
   }

   @Deprecated
   @OnlyIn(Dist.CLIENT)
   public boolean isEmissiveRendering(BlockState1 p_225543_1_) {
      return false;
   }
    ...
    * /
   @OnlyIn(Dist.CLIENT)
   public static boolean shouldSideBeRendered(BlockState1 adjacentState, IBlockReader blockState, BlockPos blockAccess, Direction pos) {
      BlockPos blockpos = blockAccess.offset(pos);
      BlockState1 blockstate = blockState.getBlockState(blockpos);
      if (adjacentState.isSideInvisible(blockstate, pos)) {
         return false;
      } else if (blockstate.isSolid()) {
         Block1.RenderSideCacheKey block$rendersidecachekey = new Block1.RenderSideCacheKey(adjacentState, blockstate, pos);
         Object2ByteLinkedOpenHashMap<Block1.RenderSideCacheKey> object2bytelinkedopenhashmap = SHOULD_SIDE_RENDER_CACHE.get();
   ...
   @Deprecated
   public final boolean isSolid(BlockState1 state) {
      return this.isSolid;
   }

   @Deprecated
   @OnlyIn(Dist.CLIENT)
   public boolean isSideInvisible(BlockState1 state, BlockState1 adjacentBlockState, Direction side) {
      return false;
   }

   @Deprecated
   public VoxelShape getShape(BlockState1 state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
      return VoxelShapes.fullCube();
   }

   @Deprecated
   public VoxelShape getCollisionShape(BlockState1 state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
      return this.blocksMovement ? state.getShape(worldIn, pos) : VoxelShapes.empty();
   }

   @Deprecated
   public VoxelShape getRenderShape(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
      return state.getShape(worldIn, pos);
   }

   @Deprecated
   public VoxelShape getRaytraceShape(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
   ...
   public static boolean hasSolidSideOnTop(IBlockReader worldIn, BlockPos pos) {
      BlockState1 blockstate = worldIn.getBlockState(pos);
   ...
   public static boolean hasSolidSide(BlockState1 state, IBlockReader worldIn, BlockPos pos, Direction side) {
   ...
   public boolean propagatesSkylightDown(BlockState1 state, IBlockReader reader, BlockPos pos) {
      return !isOpaque(state.getShape(reader, pos)) && state.getFluidState().isEmpty();
   }

   @Deprecated
   public int getOpacity(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
   ...
   @Deprecated
   public boolean isTransparent(BlockState1 state) {
      return false;
   }
    ...
    * /
   @Deprecated
   public void randomTick(BlockState1 state, ServerWorld worldIn, BlockPos pos, Random random) {
      this.tick(state, worldIn, pos, random);
   }

   @Deprecated
   public void tick(BlockState1 state, ServerWorld worldIn, BlockPos pos, Random rand) {
   }
    ...
    * /
   @OnlyIn(Dist.CLIENT)
   public void animateTick(BlockState1 stateIn, World worldIn, BlockPos pos, Random rand) {
   }

   /**
    * Called after a player destroys this Block - the posiiton pos may no longer hold the state indicated.
    * /
   public void onPlayerDestroy(IWorld worldIn, BlockPos pos, BlockState1 state) {
   }

   @Deprecated
   public void neighborChanged(BlockState1 state, World worldIn, BlockPos pos, Block1 blockIn, BlockPos fromPos, boolean isMoving) {
   ...
   @Nullable
   @Deprecated
   public INamedContainerProvider getContainer(BlockState1 state, World worldIn, BlockPos pos) {
      return null;
   }

   @Deprecated
   public void onBlockAdded(BlockState1 state, World worldIn, BlockPos pos, BlockState1 oldState, boolean isMoving) {
   }

   @Deprecated
   public void onReplaced(BlockState1 state, World worldIn, BlockPos pos, BlockState1 newState, boolean isMoving) {
    ...
    * /
   @Deprecated
   public float getPlayerRelativeBlockHardness(BlockState1 state, PlayerEntity player, IBlockReader worldIn, BlockPos pos) {
    ...
    * /
   @Deprecated
   public void spawnAdditionalDrops(BlockState1 state, World worldIn, BlockPos pos, ItemStack stack) {
   }
   ...
   @Deprecated
   public List<ItemStack> getDrops(BlockState1 state, LootContext.Builder builder) {
   ...
   public static List<ItemStack> getDrops(BlockState1 state, ServerWorld worldIn, BlockPos pos, @Nullable TileEntity tileEntityIn) {
   ...
   public static List<ItemStack> getDrops(BlockState1 state, ServerWorld worldIn, BlockPos pos, @Nullable TileEntity tileEntityIn, @Nullable Entity entityIn, ItemStack stack) {
   ...
   public static void spawnDrops(BlockState1 state, World worldIn, BlockPos pos) {
   ...
   public static void spawnDrops(BlockState1 state, World worldIn, BlockPos pos, @Nullable TileEntity tileEntityIn) {
      if (worldIn instanceof ServerWorld) {
   ...
   public static void spawnDrops(BlockState1 state, World worldIn, BlockPos pos, @Nullable TileEntity tileEntityIn, Entity entityIn, ItemStack stack) {
      if (worldIn instanceof ServerWorld) {
   ...
   @Deprecated
   public boolean isValidPosition(BlockState1 state, IWorldReader worldIn, BlockPos pos) {
      return true;
   }

   @Deprecated
   public ActionResultType onBlockActivated(BlockState1 state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
   ...
   @Nullable
   public BlockState1 getStateForPlacement(BlockItemUseContext context) {
      return this.getDefaultState();
   }

   @Deprecated
   public void onBlockClicked(BlockState1 state, World worldIn, BlockPos pos, PlayerEntity player) {
   }
    ...
    * /
   @Deprecated
   public int getWeakPower(BlockState1 blockState, IBlockReader blockAccess, BlockPos pos, Direction side) {
      return 0;
   }
    ...
    * /
   @Deprecated
   public boolean canProvidePower(BlockState1 state) {
      return false;
   }

   @Deprecated
   public void onEntityCollision(BlockState1 state, World worldIn, BlockPos pos, Entity entityIn) {
   }
    ...
    * /
   @Deprecated
   public int getStrongPower(BlockState1 blockState, IBlockReader blockAccess, BlockPos pos, Direction side) {
      return 0;
   }
    ...
    * /
   public void harvestBlock(World worldIn, PlayerEntity player, BlockPos pos, BlockState1 state, @Nullable TileEntity te, ItemStack stack) {
    ...
    * /
   public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState1 state, @Nullable LivingEntity placer, ItemStack stack) {
   }
    ...
    * /
   @Deprecated
   public boolean eventReceived(BlockState1 state, World worldIn, BlockPos pos, int id, int param) {
      return false;
   }
    ...
    * /
   @Deprecated
   public PushReaction getPushReaction(BlockState1 state) {
      return this.material.getPushReaction();
   }

   @Deprecated
   @OnlyIn(Dist.CLIENT)
   public float getAmbientOcclusionLightValue(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
   ...
   public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState1 state) {
   ...
   @Deprecated
   public IFluidState getFluidState(BlockState1 state) {
   ...
   @Deprecated
   @OnlyIn(Dist.CLIENT)
   public long getPositionRandom(BlockState1 state, BlockPos pos) {
      return MathHelper.getPositionRandom(pos);
   }

   public void onProjectileCollision(World worldIn, BlockState1 state, BlockRayTraceResult hit, Entity projectile) {
   }
    ...
    * /
   @Deprecated
   public boolean hasComparatorInputOverride(BlockState1 state) {
      return false;
   }
    ...
    * /
   @Deprecated
   public int getComparatorInputOverride(BlockState1 blockState, World worldIn, BlockPos pos) {
      return 0;
   }

   protected void fillStateContainer(StateContainer.Builder<Block1, BlockState> builder) {
   }

   public StateContainer<Block1, BlockState1> getStateContainer() {
      return this.stateContainer;
   }

   protected final void setDefaultState(BlockState1 state) {
    ...
    * /
   public final BlockState1 getDefaultState() {
    ...
    * /
   public Block1.OffsetType getOffsetType() {
      return Block1.OffsetType.NONE;
   }
    ...
    * /
   @Deprecated
   public Vec3d getOffset(BlockState1 state, IBlockReader worldIn, BlockPos pos) {
      Block1.OffsetType block$offsettype = this.getOffsetType();
      if (block$offsettype == Block1.OffsetType.NONE) {
         return Vec3d.ZERO;
      } else {
         long i = MathHelper.getCoordinateRandom(pos.getX(), 0, pos.getZ());
         return new Vec3d(((double)((float)(i & 15L) / 15.0F) - 0.5D) * 0.5D, block$offsettype == Block1.OffsetType.XYZ ? ((double)((float)(i >> 4 & 15L) / 15.0F) - 1.0D) * 0.2D : 0.0D, ((double)((float)(i >> 8 & 15L) / 15.0F) - 0.5D) * 0.5D);
      }
   }

   @Deprecated //Forge: Use more sensitive version {@link IForgeBlockState#getSoundType(IWorldReader, BlockPos, Entity) }
   public SoundType getSoundType(BlockState1 state) {
   ...
   private final net.minecraftforge.common.util.ReverseTagWrapper<Block1> reverseTags = new net.minecraftforge.common.util.ReverseTagWrapper<>(this, BlockTags::getGeneration, BlockTags::getCollection);
   private final java.util.function.Supplier<ResourceLocation> lootTableSupplier;

   @Override
   public float getSlipperiness(BlockState1 state, IWorldReader world, BlockPos pos, @Nullable Entity entity) {
      return this.slipperiness;
   }

   @Nullable
   @Override
   public net.minecraftforge.common.ToolType getHarvestTool(BlockState1 state) {
      return harvestTool; //TODO: RE-Evaluate
   }

   @Override
   public int getHarvestLevel(BlockState1 state) {
      return harvestLevel; //TODO: RE-Evaluate
   }

   @Override
   public boolean canSustainPlant(BlockState1 state, IBlockReader world, BlockPos pos, Direction facing, net.minecraftforge.common.IPlantable plantable) {
       BlockState1 plant = plantable.getPlant(world, pos.offset(facing));
       ...
       switch (type) {
           ...
           case Cave:   return Block1.hasSolidSide(state, world, pos, Direction.UP);
   ...
   public static class Properties {
      ...
      public static Block1.Properties create(Material materialIn) {
         return create(materialIn, materialIn.getColor());
      }

      public static Block1.Properties create(Material materialIn, DyeColor color) {
         return create(materialIn, color.getMapColor());
      }

      public static Block1.Properties create(Material materialIn, MaterialColor mapColorIn) {
         return new Block1.Properties(materialIn, mapColorIn);
      }

      public static Block1.Properties from(Block1 blockIn) {
         Block1.Properties block$properties = new Block1.Properties(blockIn.material, blockIn.materialColor);
      ...
      public Block1.Properties doesNotBlockMovement() {
         this.blocksMovement = false;
         this.isSolid = false;
         return this;
      }

      public Block1.Properties notSolid() {
         this.isSolid = false;
         return this;
      }

      public Block1.Properties slipperiness(float slipperinessIn) {
         this.slipperiness = slipperinessIn;
         return this;
      }

      public Block1.Properties speedFactor(float factor) {
         this.speedFactor = factor;
         return this;
      }

      public Block1.Properties jumpFactor(float factor) {
         this.jumpFactor = factor;
         return this;
      }

      public Block1.Properties sound(SoundType soundTypeIn) {
         this.soundType = soundTypeIn;
         return this;
      }

      public Block1.Properties lightValue(int lightValueIn) {
         this.lightValue = lightValueIn;
         return this;
      }

      public Block1.Properties hardnessAndResistance(float hardnessIn, float resistanceIn) {
         this.hardness = hardnessIn;
         this.resistance = Math.max(0.0F, resistanceIn);
         return this;
      }

      protected Block1.Properties zeroHardnessAndResistance() {
         return this.hardnessAndResistance(0.0F);
      }

      public Block1.Properties hardnessAndResistance(float hardnessAndResistance) {
         this.hardnessAndResistance(hardnessAndResistance, hardnessAndResistance);
         return this;
      }

      public Block1.Properties tickRandomly() {
         this.ticksRandomly = true;
         return this;
      }

      public Block1.Properties variableOpacity() {
         this.variableOpacity = true;
         return this;
      }

      public Block1.Properties harvestLevel(int harvestLevel) {
          this.harvestLevel = harvestLevel;
          return this;
      }

      public Block1.Properties harvestTool(net.minecraftforge.common.ToolType harvestTool) {
          this.harvestTool = harvestTool;
          return this;
      }

      public Block1.Properties noDrops() {
         this.lootTable = LootTables.EMPTY;
         return this;
      }

      public Block1.Properties lootFrom(Block1 blockIn) {
   ...
   public static final class RenderSideCacheKey {
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            return true;
         } else if (!(p_equals_1_ instanceof Block1.RenderSideCacheKey)) {
            return false;
         } else {
            Block1.RenderSideCacheKey block$rendersidecachekey = (Block1.RenderSideCacheKey)p_equals_1_;
