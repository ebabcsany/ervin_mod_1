...
public class BrefkStage72 extends Item {
   public BrefkStage72(Properties builder) {
      super(builder);
   }
   ...
   public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
      ...
      return stack.isEmpty() ? new ItemStack(BrefkStageItemInit.BREFK_STAGE71.get()) : stack;
   }
