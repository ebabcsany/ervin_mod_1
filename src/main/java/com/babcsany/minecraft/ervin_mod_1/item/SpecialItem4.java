...
public class SpecialItem4 extends Item {
	...
	public boolean onEntityItemUpdate(ItemStack stack, ItemEntity entity) {
		entity.getEntityWorld().setBlockState(entity.getPosition().down(), isBurnableBlockInit.SRIUNK_BLOCK.get().getDefaultState());
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		if (context.getWorld().getBlockState(context.getPos()).getBlock() == BlockInit.EXAMPLE_BLOCK.get()) {
