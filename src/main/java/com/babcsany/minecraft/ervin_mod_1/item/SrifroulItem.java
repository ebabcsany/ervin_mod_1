...
public class SrifroulItem extends Item implements IVanishable {
   private static final Logger field_234666_a_ = LogManager.getLogger();

   public SrifroulItem(Properties builder) {
      super(builder);
   }
   ...
   public String getTranslationKey(ItemStack stack) {
      return func_234670_d_(stack) ? "item.ervin_mod_1.lodestone_srifroul" : super.getTranslationKey(stack);
   }
}