...
public class ModBucketItem extends Item {
   ...
   public ModBucketItem(Fluid containedFluidIn, Properties builder) {
      super(builder);
    ...
    */
   public ModBucketItem(java.util.function.Supplier<? extends Fluid> supplier, Properties builder) {
      super(builder);
   ...
   public boolean tryPlaceContainedLiquid(@Nullable PlayerEntity player, World worldIn, BlockPos posIn, @Nullable BlockRayTraceResult rayTrace) {
      if (!(this.containedBlock instanceof FlowingFluid)) {
         ...
         FlowingFluidBlock block = (FlowingFluidBlock) blockstate.getBlock();
   ...
   public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, @Nullable net.minecraft.nbt.CompoundNBT nbt) {
      if (this.getClass() == ModBucketItem.class)
