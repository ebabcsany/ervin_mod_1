...
public class EnchantedBookItemOrange extends Item {
   public EnchantedBookItemOrange(Properties builder) {
      super(builder);
   }
   ...
   public static ItemStack getEnchantedItemStack(EnchantmentData enchantData) {
      ItemStack itemstack = new ItemStack(ItemInit.ENCHANTED_BOOK_ORANGE);
