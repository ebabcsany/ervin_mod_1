...
public class PickaxeBlockNamedItem extends ToolItem {
   ...
   public PickaxeBlockNamedItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder, Block blockIn) {
