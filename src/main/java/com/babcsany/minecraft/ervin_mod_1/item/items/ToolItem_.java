...
import com.babcsany.minecraft.ervin_mod_1.item.tool.TieredItem_;
...
public class ToolItem_ extends TieredItem_ implements IVanishable {
   ...
   public ToolItem_(float attackDamageIn, IItemTier_ tier, Set<Block> effectiveBlocksIn, Properties builderIn) {
