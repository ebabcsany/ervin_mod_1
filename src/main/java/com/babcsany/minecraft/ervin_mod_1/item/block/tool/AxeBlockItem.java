...
public class AxeBlockItem extends ToolBlockItem {
   ...
   public AxeBlockItem(IItemTier tier, Block blockIn, float attackDamageIn, float attackSpeedIn, Properties builder) {
      super(blockIn, attackDamageIn, attackSpeedIn, tier, field_150917_d_, builder.addToolType(net.minecraftforge.common.ToolType.AXE, tier.getHarvestLevel()));
   }
