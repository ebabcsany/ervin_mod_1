...
import com.babcsany.minecraft.ervin_mod_1.item.items.ModToolItem;
...
public class PhiskItem extends ModToolItem {
   private static final Set<Block> EFFECTIVE_ON = setEffectiveBlocks("tgruhuft");

   private static ImmutableSet<Block> setEffectiveBlocks(String... keys) {
