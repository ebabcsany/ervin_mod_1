...
public class BrefkStage78 extends Item {
   public BrefkStage78(Properties builder) {
      super(builder);
   }
   ...
   public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
      ...
      return stack.isEmpty() ? new ItemStack(BrefkStageItemInit.BREFK_STAGE77.get()) : stack;
   }
