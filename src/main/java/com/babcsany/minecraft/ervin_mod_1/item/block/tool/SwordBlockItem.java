...
import com.babcsany.minecraft.ervin_mod_1.item.block.TieredBlockItem;
...
public class SwordBlockItem extends TieredBlockItem implements IVanishable {
   private final float attackDamage;
   /** Modifiers applied when the item is in the mainhand of a user. */
   private final Multimap<Attribute, AttributeModifier> attributeModifiers;

   public SwordBlockItem(IItemTier tier, Block blockIn, int attackDamageIn, float attackSpeedIn, Item.Properties builderIn) {
