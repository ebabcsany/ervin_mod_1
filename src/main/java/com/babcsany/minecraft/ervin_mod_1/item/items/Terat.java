...
public class Terat extends ToolItem {
   ...
   public Terat(IItemTier1 tier, int attackDamageIn, float attackSpeedIn, Item.Properties builder) {
   ...
   public enum ModRarity implements IExtensibleEnum {
      ...
      public static Firn.ModRarity create(String name, TextFormatting format) {
