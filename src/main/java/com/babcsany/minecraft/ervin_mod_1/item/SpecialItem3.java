...
public class SpecialItem3 extends Item {
	...
	public SpecialItem3(Properties properties) {
		super(properties);
	}
	...
	public boolean onEntityItemUpdate(ItemStack stack, ItemEntity entity) {
		entity.getEntityWorld().setBlockState(entity.getPosition().down(), BlockItemInit.VILKT_BLOCK.get().getDefaultState());
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		if (context.getWorld().getBlockState(context.getPos()).getBlock() == BlockItemInit.SHZ_BLOCK.get()) {
