...
public class BrefkStage84 extends Item {
   public BrefkStage84(Properties builder) {
      super(builder);
   }
   ...
   public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
      ...
      return stack.isEmpty() ? new ItemStack(BrefkStageItemInit.BREFK_STAGE83.get()) : stack;
   }
