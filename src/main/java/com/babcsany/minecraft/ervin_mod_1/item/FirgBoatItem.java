...
public class FirgBoatItem extends Item {
   ...
   private final FirgBoatEntity.Type type;

   public FirgBoatItem(FirgBoatEntity.Type typeIn, Properties properties) {
      super(properties);
      this.type = typeIn;
   }
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
      ...
      if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
         ...
         if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
            FirgBoatEntity boatentity = new FirgBoatEntity(worldIn, raytraceresult.getHitVec().x, raytraceresult.getHitVec().y, raytraceresult.getHitVec().z);
