...
public class EnchantedBookItemRed extends Item {
   public EnchantedBookItemRed(Properties builder) {
      super(builder);
   }
   ...
   public static ItemStack getEnchantedItemStack(EnchantmentData enchantData) {
      ItemStack itemstack = new ItemStack(ItemInit.ENCHANTED_BOOK_RED);
