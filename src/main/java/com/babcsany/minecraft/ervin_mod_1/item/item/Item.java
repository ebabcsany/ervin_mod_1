...
public class Item extends ForgeRegistryEntry<net.minecraft.item.Item> implements IItemProvider, IForgeItem {
   public static final Map<Block, net.minecraft.item.Item> BLOCK_TO_ITEM = net.minecraftforge.registries.GameData.getBlockItemMap();
   ...
   private final net.minecraft.item.Item containerItem;
   @Nullable
   private String translationKey;
   @Nullable
   private final Food food;

   public static int getIdFromItem(net.minecraft.item.Item itemIn) {
      return itemIn == null ? 0 : Registry.ITEM.getId(itemIn);
   }

   public static net.minecraft.item.Item getItemById(int id) {
      return Registry.ITEM.getByValue(id);
   }

   @Deprecated
   public static net.minecraft.item.Item getItemFromBlock(Block blockIn) {
   ...
   @Nullable
   @Deprecated // Use ItemStack sensitive version.
   public final net.minecraft.item.Item getContainerItem() {
   ...
   private final net.minecraftforge.common.util.ReverseTagWrapper<Item> reverseTags = new net.minecraftforge.common.util.ReverseTagWrapper<>(this, ItemTag::getCollection1);
   ...
   public static class Properties {
      ...
      public Properties containerItem(net.minecraft.item.Item containerItemIn) {
