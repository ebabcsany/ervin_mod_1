...
public enum ModItemTier implements IItemTier {
    ...
    BLACK_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.BLACK_COBBLESTONE.get())),
    BLUE_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.BLUE_COBBLESTONE.get())),
    BROWN_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.BROWN_COBBLESTONE.get())),
    CYAN_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.CYAN_COBBLESTONE.get())),
    GREEN_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.GREEN_COBBLESTONE.get())),
    LIGHT_BLUE_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.LIGHT_BLUE_COBBLESTONE.get())),
    LIGHT_BLUE1_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.LIGHT_BLUE1_COBBLESTONE.get())),
    LIGHT_GRAY_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.LIGHT_GRAY_COBBLESTONE.get())),
    LIME_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.LIME_COBBLESTONE.get())),
    MAGENTA_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.MAGENTA_COBBLESTONE.get())),
    ORANGE_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.ORANGE_COBBLESTONE.get())),
    PINK_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.PINK_COBBLESTONE.get())),
    PURPLE_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.PURPLE_COBBLESTONE.get())),
    RED_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.RED_COBBLESTONE.get())),
    WHITE_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.WHITE_COBBLESTONE.get())),
    YELLOW_COBBLESTONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockInit.YELLOW_COBBLESTONE.get())),
