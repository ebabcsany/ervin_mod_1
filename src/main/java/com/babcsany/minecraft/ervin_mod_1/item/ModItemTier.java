...
public enum ModItemTier implements IItemTier {
    ...
    BLACK_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.BLACK_COBBLESTONE.get())),
    BLUE_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.BLUE_COBBLESTONE.get())),
    BROWN_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.BROWN_COBBLESTONE.get())),
    CYAN_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.CYAN_COBBLESTONE.get())),
    GREEN_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.GREEN_COBBLESTONE.get())),
    LIGHT_BLUE_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.LIGHT_BLUE_COBBLESTONE.get())),
    LIGHT_BLUE1_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.LIGHT_BLUE1_COBBLESTONE.get())),
    LIGHT_GRAY_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.LIGHT_GRAY_COBBLESTONE.get())),
    LIME_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.LIME_COBBLESTONE.get())),
    MAGENTA_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.MAGENTA_COBBLESTONE.get())),
    ORANGE_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.ORANGE_COBBLESTONE.get())),
    PINK_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.PINK_COBBLESTONE.get())),
    PURPLE_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.PURPLE_COBBLESTONE.get())),
    RED_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.RED_COBBLESTONE.get())),
    WHITE_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.WHITE_COBBLESTONE.get())),
    YELLOW_STONE(1, 131, 4.0F, 1.0F, 5, () -> Ingredient.fromItems(BlockItemInit.YELLOW_COBBLESTONE.get())),
    ...
    SURV(2, 1310, 40.0F, 10.0F, 50, () -> Ingredient.fromItems(BlockItemInit.SURV.get())),
    ...
    THUFR(119, 543800000, 3690527310400000000.0F, 34894526265243262.0F, 143288, () -> Ingredient.fromItems(isBurnableSpecialToolItemInit.THUFR.get()));
