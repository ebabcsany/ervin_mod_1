...
public class BrefkStage79 extends Item {
   public BrefkStage79(Properties builder) {
      super(builder);
   }
   ...
   public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
      ...
      return stack.isEmpty() ? new ItemStack(BrefkStageItemInit.BREFK_STAGE78.get()) : stack;
   }
