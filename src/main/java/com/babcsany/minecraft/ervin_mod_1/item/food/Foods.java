...
public class Foods {
    ...
    public static final Food FIRG_SLICES = (new Food.Builder()).hunger((int) 0.125).saturation(0.15F).effect(new EffectInstance(Effects.REGENERATION, 50, (int) 1.25), 10.0F).setAlwaysEdible().fastToEat().build();
    public static final Food FIRG_SLAB = (new Food.Builder()).hunger((int) 0.5).saturation(0.6F).effect(new EffectInstance(Effects.REGENERATION, 25, 10), 10.0F).setAlwaysEdible().fastToEat().build();
