...
public class Foods {
    ...
    public static final Food FIRG = (new Food.Builder()).hunger(2).saturation(1.2F).effect(new EffectInstance(Effects.REGENERATION, 50, 10), 10.0F).setAlwaysEdible().fastToEat().build();
    public static final Food FIRG_SLAB = (new Food.Builder()).hunger(1).saturation(0.6F).effect(new EffectInstance(Effects.REGENERATION, 25, 10), 10.0F).setAlwaysEdible().fastToEat().build();
    public static final Food FIRG_STAIRS = (new Food.Builder()).hunger((int)1.5).saturation(0.9F).effect(new EffectInstance(Effects.REGENERATION, 38, 10), 10.0F).setAlwaysEdible().fastToEat().build();
