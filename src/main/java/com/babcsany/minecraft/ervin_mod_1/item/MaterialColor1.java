...
public class MaterialColor1 {
   ...
   public static final MaterialColor1[] COLORS = new MaterialColor1[64];
   ...
   public static final MaterialColor1 DURT = new MaterialColor1(52, 1345260);
   public final int colorValue;
   public final int colorIndex;

   private MaterialColor1(int index, int color) {
      if (index >= 0 && index <= 63) {
