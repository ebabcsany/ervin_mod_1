...
public class EnchantedBookItemMagenta extends Item {
   public EnchantedBookItemMagenta(Properties builder) {
      super(builder);
   }
   ...
   public static ItemStack getEnchantedItemStack(EnchantmentData enchantData) {
      ItemStack itemstack = new ItemStack(ItemInit.ENCHANTED_BOOK_MAGENTA);
