...
public class EnchantedBookItemLime extends Item {
   public EnchantedBookItemLime(Properties builder) {
      super(builder);
   }
   ...
   public static ItemStack getEnchantedItemStack(EnchantmentData enchantData) {
      ItemStack itemstack = new ItemStack(ItemInit.ENCHANTED_BOOK_LIME);
