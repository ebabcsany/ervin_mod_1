package com.babcsany.minecraft.ervin_mod_1.item.crafting.book;
...
public class BlackBookCloningRecipe extends SpecialRecipe {
   public BlackBookCloningRecipe(ResourceLocation idIn) {
      super(idIn);
   }
   ...
   public IRecipeSerializer<?> getSerializer() {
      return RecipeSerializerInit.CRAFTING_SPECIAL_BOOKCLONING;
   }
