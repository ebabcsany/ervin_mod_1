...
public class EnchantedBookItemGray extends Item {
   public EnchantedBookItemGray(Properties builder) {
      super(builder);
   }
   ...
   public static ItemStack getEnchantedItemStack(EnchantmentData enchantData) {
      ItemStack itemstack = new ItemStack(ItemInit.ENCHANTED_BOOK_GRAY);
