...
public class BucketItem1 extends Item {
   private final Fluid containedBlock;

   // Forge: Use the other constructor that takes a Supplier
   @Deprecated
   public BucketItem1(Fluid containedFluidIn, Properties builder) {
      super(builder);
    ...
    */
   public BucketItem1(java.util.function.Supplier<? extends Fluid> supplier, Properties builder) {
      super(builder);
   ...
   public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, @Nullable net.minecraft.nbt.CompoundNBT nbt) {
      if (this.getClass() == BucketItem1.class)
