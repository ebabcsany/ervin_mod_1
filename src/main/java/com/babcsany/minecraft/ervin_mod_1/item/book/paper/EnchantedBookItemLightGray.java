...
public class EnchantedBookItemLightGray extends Item {
   public EnchantedBookItemLightGray(Properties builder) {
      super(builder);
   }
   ...
   public static ItemStack getEnchantedItemStack(EnchantmentData enchantData) {
      ItemStack itemstack = new ItemStack(ItemInit.ENCHANTED_BOOK_LIGHT_GRAY);
