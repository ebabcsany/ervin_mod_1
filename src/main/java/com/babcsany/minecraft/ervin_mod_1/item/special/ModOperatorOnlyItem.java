...
public class ModOperatorOnlyItem extends BlockItem {
   ...
   protected BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      return playerentity == null || playerentity.abilities.isCreativeMode || playerentity.abilities.isFlying || playerentity.abilities.disableDamage || playerentity.abilities.allowFlying ? null : super.getStateForPlacement(context);
   }
