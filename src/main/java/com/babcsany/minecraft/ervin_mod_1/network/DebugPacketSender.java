...
public class DebugPacketSender {
   ...
   public static void sendDgrurbPath(World worldIn, DgrurbMobEntity dgrurb, @Nullable Path p_218803_2_, float p_218803_3_) {
   }
   ...
   public static void sendDgrurbGoal(World worldIn, DgrurbMobEntity dgrurb, GoalSelector p_218800_2_) {
   }
