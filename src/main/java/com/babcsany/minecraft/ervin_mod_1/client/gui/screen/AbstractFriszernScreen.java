...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractFriszernScreen extends Screen {
   ...
   abstract FriszernLogic getLogic();
   ...
   protected void init() {
      ...
      this.trackOutputButton = this.addButton(new Button(this.width / 2 + 150 - 20, this.func_195236_i(), 20, 20, new StringTextComponent("O"), (p_214184_1_) -> {
         FriszernLogic commandblocklogic = this.getLogic();
      ...
      this.commandTextField = new TextFieldWidget(this.font, this.width / 2 - 150, 50, 300, 20, new TranslationTextComponent("advMode.command")) {
         protected IFormattableTextComponent getNarrationMessage() {
            return super.getNarrationMessage().appendString(AbstractFriszernScreen.this.suggestionHelper.func_228129_c_());
         }
      };
   ...
   protected abstract void func_195235_a(FriszernLogic commandBlockLogicIn);
