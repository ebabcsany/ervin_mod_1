...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractList1<E extends AbstractList1.AbstractListEntry1<E>> extends FocusableGui implements IRenderable {
   protected final Minecraft minecraft;
   protected final int itemHeight;
   private final List<E> children = new AbstractList1.SimpleArrayList();
   protected int width;
   ...
   public AbstractList1(Minecraft mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int itemHeightIn) {
      this.minecraft = mcIn;
      this.width = widthIn;
   ...
   public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
      if (super.keyPressed(keyCode, scanCode, modifiers)) {
         ...
         this.moveSelection(AbstractList1.Ordering.DOWN);
         return true;
      } else if (keyCode == 265) {
         this.moveSelection(AbstractList1.Ordering.UP);
         return true;
      } else {
         return false;
      }
   ...
   protected void moveSelection(AbstractList1.Ordering p_241219_1_) {
   ...
   protected void func_241572_a_(AbstractList1.Ordering p_241572_1_, Predicate<E> p_241572_2_) {
      int i = p_241572_1_ == AbstractList1.Ordering.UP ? -1 : 1;
   ...
   private void func_238480_f_(AbstractList1.AbstractListEntry1<E> p_238480_1_) {
   ...
   @OnlyIn(Dist.CLIENT)
   public abstract static class AbstractListEntry1<E extends AbstractList1.AbstractListEntry1<E>> implements IGuiEventListener {
      @Deprecated
      protected AbstractList1<E> list;
   ...
   class SimpleArrayList extends java.util.AbstractList<E> {
      ...
      public E set(int p_set_1_, E p_set_2_) {
         ...
         AbstractList1.this.func_238480_f_(p_set_2_);
         return e;
      }

      public void add(int p_add_1_, E p_add_2_) {
         this.field_216871_b.add(p_add_1_, p_add_2_);
         AbstractList1.this.func_238480_f_(p_add_2_);
      }
