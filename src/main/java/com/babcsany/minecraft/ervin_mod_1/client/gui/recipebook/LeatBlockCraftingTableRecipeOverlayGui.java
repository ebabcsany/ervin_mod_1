package com.babcsany.minecraft.ervin_mod_1.client.gui.recipebook;
...
@OnlyIn(Dist.CLIENT)
public class LeatBlockCraftingTableRecipeOverlayGui extends AbstractGui implements IRenderable, IGuiEventListener {
   private static final ResourceLocation RECIPE_BOOK_TEXTURE = new ResourceLocation("textures/gui/recipe_book.png");
   private final List<LeatBlockCraftingTableRecipeOverlayGui.RecipeButtonWidget> buttonList = Lists.newArrayList();
   private boolean visible;
   private int x;
   private int y;
   private Minecraft mc;
   private RecipeList1 recipeList;
   ...
   public void func_201703_a(Minecraft p_201703_1_, ClientPlayerEntity playerEntity, RecipeList1 p_201703_2_, int p_201703_3_, int p_201703_4_, int p_201703_5_, int p_201703_6_, float p_201703_7_) {
      ...
      for(int j1 = 0; j1 < j; ++j1) {
         ...
         if (this.field_201704_n) {
            this.buttonList.add(new LeatBlockCraftingTableRecipeOverlayGui.FurnaceRecipeButtonWidget(k1, l1, irecipe, flag1));
         } else {
            this.buttonList.add(new LeatBlockCraftingTableRecipeOverlayGui.RecipeButtonWidget(k1, l1, irecipe, flag1));
         }
      }
   ...
   public RecipeList1 getRecipeList() {
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int p_231044_5_) {
      if (p_231044_5_ != 0) {
         ...
         for(LeatBlockCraftingTableRecipeOverlayGui.RecipeButtonWidget recipeoverlaygui$recipebuttonwidget : this.buttonList) {
   ...
   @OnlyIn(Dist.CLIENT)
   class FurnaceRecipeButtonWidget extends LeatBlockCraftingTableRecipeOverlayGui.RecipeButtonWidget {
   ...
   class RecipeButtonWidget extends Widget implements IRecipePlacer<Ingredient> {
      ...
      protected final List<LeatBlockCraftingTableRecipeOverlayGui.RecipeButtonWidget.Child> field_201506_o = Lists.newArrayList();
      ...
      public void setSlotContents(Iterator<Ingredient> ingredients, int slotIn, int maxAmount, int y, int x) {
         ...
         if (aitemstack.length != 0) {
            this.field_201506_o.add(new LeatBlockCraftingTableRecipeOverlayGui.RecipeButtonWidget.Child(3 + x * 7, 3 + y * 7, aitemstack));
         }
      ...
      public void renderButton(MatrixStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
         ...
         LeatBlockCraftingTableRecipeOverlayGui.this.mc.getTextureManager().bindTexture(LeatBlockCraftingTableRecipeOverlayGui.RECIPE_BOOK_TEXTURE);
         int i = 152;
         if (!this.isCraftable) {
            i += 26;
         }

         int j = LeatBlockCraftingTableRecipeOverlayGui.this.field_201704_n ? 130 : 78;
         if (this.isHovered()) {
            j += 26;
         }
         ...
         for(LeatBlockCraftingTableRecipeOverlayGui.RecipeButtonWidget.Child recipeoverlaygui$recipebuttonwidget$child : this.field_201506_o) {
            RenderSystem.pushMatrix();
            float f = 0.42F;
            ...
            LeatBlockCraftingTableRecipeOverlayGui.this.mc.getItemRenderer().renderItemAndEffectIntoGUI(recipeoverlaygui$recipebuttonwidget$child.field_201705_a[MathHelper.floor(LeatBlockCraftingTableRecipeOverlayGui.this.time / 30.0F) % recipeoverlaygui$recipebuttonwidget$child.field_201705_a.length], k, l);
            RenderSystem.popMatrix();
         }
