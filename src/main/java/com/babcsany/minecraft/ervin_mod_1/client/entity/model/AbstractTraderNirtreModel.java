...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractTraderNirtreModel<T extends CreatureEntity> extends BipedModel<T> {
   protected AbstractTraderNirtreModel(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
