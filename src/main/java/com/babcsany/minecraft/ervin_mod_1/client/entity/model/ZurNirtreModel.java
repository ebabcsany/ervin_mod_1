...
public class ZurNirtreModel<T extends ZurEntity> extends AbstractZombieModel<T> {
    public ZurNirtreModel(float modelSize, boolean p_i1168_2_) {
        this(modelSize, 0.0F, 64, p_i1168_2_ ? 32 : 64);
    }

    protected ZurNirtreModel(float p_i48914_1_, float p_i48914_2_, int p_i48914_3_, int p_i48914_4_) {
