...
@OnlyIn(Dist.CLIENT)
public class ZurNirtreModel<T extends ZurEntity> extends BipedModel<T> implements IHeadToggle {
   private ModelRenderer field_217150_a;

   public ZurNirtreModel(float p_i51058_1_, boolean p_i51058_2_) {
