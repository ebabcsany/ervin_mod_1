...
public class LeatBlockCraftingTableScreen extends ContainerScreen<LeatBlockCraftingTableContainer> implements IRecipeShownListener {
   ...
   private static final ResourceLocation RECIPE_BUTTON_TEXTURE = new ResourceLocation(Ervin_mod_1.MOD_ID,"textures/gui/leat_block_crafting_table_gui_container_button.png");
   private final RecipeBookGui recipeBookGui = new RecipeBookGui();
   private boolean widthTooNarrow;

   public LeatBlockCraftingTableScreen(LeatBlockCraftingTableContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
   ...
   protected void init() {
      ...
      this.addButton(new ImageButton(this.guiLeft + 6, this.height / 2 - 49, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEXTURE, (p_214076_1_) -> {
         this.recipeBookGui.initSearchBar(this.widthTooNarrow);
         this.recipeBookGui.toggleVisibility();
         this.guiLeft = this.recipeBookGui.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
         ((ImageButton)p_214076_1_).setPosition(this.guiLeft + 6, this.height / 2 - 49);
      }));
      this.titleX = 29;
   }
