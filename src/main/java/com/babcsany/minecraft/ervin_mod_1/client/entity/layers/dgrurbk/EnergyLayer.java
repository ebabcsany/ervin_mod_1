package com.babcsany.minecraft.ervin_mod_1.client.entity.layers.dgrurbk;
...
@OnlyIn(Dist.CLIENT)
public abstract class EnergyLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
   public EnergyLayer(DgrurbkRender p_i226038_1_) {
      super((IEntityRenderer<T, M>) p_i226038_1_);
   }
