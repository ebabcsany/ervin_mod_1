...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractZombieTraderModel<T extends CreatureEntity> extends BipedModel<T> {
   protected AbstractZombieTraderModel(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
