...
@OnlyIn(Dist.CLIENT)
public class ShertMushroomLayer<T extends ShertEntity> extends LayerRenderer<T, SrachModel<T>> {
   public ShertMushroomLayer(IEntityRenderer<T, SrachModel<T>> rendererIn) {
      super(rendererIn);
   }
