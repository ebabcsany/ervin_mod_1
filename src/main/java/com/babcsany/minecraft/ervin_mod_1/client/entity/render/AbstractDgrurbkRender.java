...
import com.babcsany.minecraft.ervin_mod_1.client.entity.render.dgrurb.BipedDgrurbRenderer;
...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractDgrurbkRender<T extends Dgrurbk, M extends DgrurbkModel<T>> extends BipedDgrurbRenderer<T, M> {
   private static final ResourceLocation DGRURBK = new ResourceLocation(Ervin_mod_1.MOD_ID,"textures/entity/dgrurbk.png");
