...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractTraderNirtreRender<T extends TraderNirtreEntity, M extends TraderNirtreModel<T>> extends BipedRenderer<T, M> {
   ...
   protected AbstractTraderNirtreRender(EntityRendererManager p_i50974_1_, M p_i50974_2_, M p_i50974_3_, M p_i50974_4_) {
    ...
    */
   public ResourceLocation getEntityTexture(TraderNirtreEntity entity) {
