...
/*
@OnlyIn(Dist.CLIENT)
public class FreinEntityRender extends MobRenderer<FreinEntityRender, FreinEntityModel<FreinEntity>> {


        private static final ResourceLocation FREIN_ENTITY_TEXTURES = new ResourceLocation("textures/entity/frein_entity.png");

        public FreinEntityRender(EntityRendererManager renderManagerIn) {
            super(renderManagerIn, new FreinEntityModel<>(16), 0.25F);
            this.addLayer(new FreinEntity<>(this));
        }
