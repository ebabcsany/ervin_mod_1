package com.babcsany.minecraft.ervin_mod_1.client.gui.screen.merchant;
...
@OnlyIn(Dist.CLIENT)
public class ZurScreen extends ContainerScreen<ZurContainer> {
   ...
   private final ZurScreen.TradeButton[] field_214138_m = new ZurScreen.TradeButton[7];
   private int field_214139_n;
   private boolean field_214140_o;

   public ZurScreen(ZurContainer p_i51080_1_, PlayerInventory p_i51080_2_, ITextComponent p_i51080_3_) {
   ...
   protected void init() {
      ...
      for(int l = 0; l < 7; ++l) {
         this.field_214138_m[l] = this.addButton(new ZurScreen.TradeButton(i + 5, k, l, (p_214132_1_) -> {
            if (p_214132_1_ instanceof ZurScreen.TradeButton) {
               this.selectedMerchantRecipe = ((ZurScreen.TradeButton)p_214132_1_).func_212937_a() + this.field_214139_n;
               this.func_195391_j();
            }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         for(ZurScreen.TradeButton merchantscreen$tradebutton : this.field_214138_m) {
   ...
   class TradeButton extends Button {
      ...
      public void renderToolTip(MatrixStack p_230443_1_, int p_230443_2_, int p_230443_3_) {
         if (this.isHovered && ZurScreen.this.container.getOffers().size() > this.field_212938_a + ZurScreen.this.field_214139_n) {
            if (p_230443_2_ < this.x + 20) {
               ItemStack itemstack = ZurScreen.this.container.getOffers().get(this.field_212938_a + ZurScreen.this.field_214139_n).func_222205_b();
               ZurScreen.this.renderTooltip(p_230443_1_, itemstack, p_230443_2_, p_230443_3_);
            } else if (p_230443_2_ < this.x + 50 && p_230443_2_ > this.x + 30) {
               ItemStack itemstack2 = ZurScreen.this.container.getOffers().get(this.field_212938_a + ZurScreen.this.field_214139_n).getBuyingStackSecond();
               if (!itemstack2.isEmpty()) {
                  ZurScreen.this.renderTooltip(p_230443_1_, itemstack2, p_230443_2_, p_230443_3_);
               }
            } else if (p_230443_2_ > this.x + 65) {
               ItemStack itemstack1 = ZurScreen.this.container.getOffers().get(this.field_212938_a + ZurScreen.this.field_214139_n).getSellingStack();
               ZurScreen.this.renderTooltip(p_230443_1_, itemstack1, p_230443_2_, p_230443_3_);
            }
         }
