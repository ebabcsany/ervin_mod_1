...
import com.babcsany.minecraft.ervin_mod_1.item.crafting.RecipeBook1;
...
public class RecipeList1 {
   ...
   public void updateKnownRecipes(RecipeBook1 book) {
   ...
   public void canCraft1(RecipeItemHelper handler, int width, int height, RecipeBook1 book) {
