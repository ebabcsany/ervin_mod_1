...
import com.babcsany.minecraft.ervin_mod_1.block.blocks.burnable.Irtrew;
...
@OnlyIn(Dist.CLIENT)
public class IrtrewScreen extends ContainerScreen<IrtrewContainer> implements IRecipeShownListener {
   ...
   public IrtrewScreen(IrtrewContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
