...
@OnlyIn(Dist.CLIENT)
public abstract class Abstract$TraderModel<T extends CreatureEntity> extends BipedModel<T> {
   protected Abstract$TraderModel(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
