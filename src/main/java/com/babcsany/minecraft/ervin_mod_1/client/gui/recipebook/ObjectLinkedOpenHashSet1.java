 ...
 * @see HashCommon
 */
public class ObjectLinkedOpenHashSet1<K> extends AbstractObjectSortedSet<K>
		implements
	...
	public ObjectLinkedOpenHashSet1(final int expected, final float f) {
		if (f <= 0 || f > 1)
	 ...
	 *            the expected number of elements in the hash set.
	 */
	public ObjectLinkedOpenHashSet1(final int expected) {
	 ...
	 */
	public ObjectLinkedOpenHashSet1() {
	 ...
	 *            the load factor.
	 */
	public ObjectLinkedOpenHashSet1(final Collection<? extends K> c, final float f) {
		this(c.size(), f);
		addAll(c);
	}
	/**
	 ...
	 *            a {@link Collection} to be copied into the new hash set.
	 */
	public ObjectLinkedOpenHashSet1(final Collection<? extends K> c) {
	 ...
	 *            the load factor.
	 */
	public ObjectLinkedOpenHashSet1(final ObjectCollection<? extends K> c, final float f) {
		this(c.size(), f);
		addAll(c);
	}
	/**
	 ...
	 *            a type-specific collection to be copied into the new hash set.
	 */
	public ObjectLinkedOpenHashSet1(final ObjectCollection<? extends K> c) {
		this(c, DEFAULT_LOAD_FACTOR);
	}
	/**
	 ...
	 *            the load factor.
	 */
	public ObjectLinkedOpenHashSet1(final Iterator<? extends K> i, final float f) {
	 ...
	 *            a type-specific iterator whose elements will fill the set.
	 */
	public ObjectLinkedOpenHashSet1(final Iterator<? extends K> i) {
	 ...
	 *            the load factor.
	 */
	public ObjectLinkedOpenHashSet1(final K[] a, final int offset, final int length, final float f) {
	 ...
	 *            the number of elements to use.
	 */
	public ObjectLinkedOpenHashSet1(final K[] a, final int offset, final int length) {
	 ...
	 *            the load factor.
	 */
	public ObjectLinkedOpenHashSet1(final K[] a, final float f) {
		this(a, 0, a.length, f);
	}
	/**
	 * Creates a new hash set with {@link Hash#DEFAULT_LOAD_FACTOR} as load factor
	 ...
	 *            an array to be copied into the new hash set.
	 */
	public ObjectLinkedOpenHashSet1(final K[] a) {
	...
	private class SetIterator implements ObjectListIterator<K> {
		...
		SetIterator(K from) {
			if (((from) == null)) {
				if (ObjectLinkedOpenHashSet1.this.containsNull) {
					next = (int) link[n];
					prev = n;
					return;
				} else
			...
			// The starting point.
			final K key[] = ObjectLinkedOpenHashSet1.this.key;
			int pos = (HashCommon.mix((from).hashCode())) & mask;
			// There's always an unused entry.
			while (!((key[pos]) == null)) {
		...
		public void remove() {
			...
			curr = -1;
			if (pos == n) {
				ObjectLinkedOpenHashSet1.this.containsNull = false;
				ObjectLinkedOpenHashSet1.this.key[n] = (null);
			} else {
				K curr;
				final K[] key = ObjectLinkedOpenHashSet1.this.key;
	...
	@Override
	@SuppressWarnings("unchecked")
	public ObjectLinkedOpenHashSet1<K> clone() {
		ObjectLinkedOpenHashSet1<K> c;
		try {
			c = (ObjectLinkedOpenHashSet1<K>) super.clone();
