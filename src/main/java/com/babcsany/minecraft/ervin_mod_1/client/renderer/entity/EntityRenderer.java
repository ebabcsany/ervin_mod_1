...
import com.babcsany.minecraft.ervin_mod_1.forge.client.event.RenderItemNameplateEvent;
...
@OnlyIn(Dist.CLIENT)
public abstract class EntityRenderer<T extends ItemEntity> {
   protected final net.minecraft.client.renderer.entity.EntityRendererManager renderManager;
   protected float shadowSize;
   protected float shadowOpaque = 1.0F;

   protected EntityRenderer(net.minecraft.client.renderer.entity.EntityRendererManager renderManager) {
   ...
   public void render(T entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      RenderItemNameplateEvent renderItemNameplateEvent = new RenderItemNameplateEvent(entityIn, entityIn.getDisplayName(), this, matrixStackIn, bufferIn, packedLightIn);
      net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(renderItemNameplateEvent);
      if (renderItemNameplateEvent.getResult() != net.minecraftforge.eventbus.api.Event.Result.DENY && (renderItemNameplateEvent.getResult() == net.minecraftforge.eventbus.api.Event.Result.ALLOW || this.canRenderName(entityIn))) {
         this.renderName(entityIn, renderItemNameplateEvent.getContent(), matrixStackIn, bufferIn, packedLightIn);
      }
   }
