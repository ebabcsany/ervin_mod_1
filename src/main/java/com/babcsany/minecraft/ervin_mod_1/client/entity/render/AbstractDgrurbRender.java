...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractDgrurbRender<T extends Dgrurb, M extends DgrurbModel<T>> extends BipedRenderer<T, M> {
   private static final ResourceLocation field_217771_a = new ResourceLocation(Ervin_mod_1.MOD_ID,"textures/entity/dgrurb.png");

   protected AbstractDgrurbRender(EntityRendererManager p_i50974_1_, M p_i50974_2_, M p_i50974_3_, M p_i50974_4_) {
