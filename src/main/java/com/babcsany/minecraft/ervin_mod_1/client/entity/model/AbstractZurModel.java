...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractZurModel<T extends AbstractZurEntity> extends BipedModel<T> {
   protected AbstractZurModel(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
