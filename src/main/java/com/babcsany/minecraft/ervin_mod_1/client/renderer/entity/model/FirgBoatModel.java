package com.babcsany.minecraft.ervin_mod_1.client.renderer.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class FirgBoatModel extends SegmentedModel<FirgBoatEntity> {
    ...
    */
   public void setRotationAngles(FirgBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(FirgBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
