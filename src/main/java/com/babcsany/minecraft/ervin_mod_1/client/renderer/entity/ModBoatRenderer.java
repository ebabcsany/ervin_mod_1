...
import com.babcsany.minecraft.ervin_mod_1.client.renderer.entity.model.ModBoatModel;
...
public class ModBoatRenderer extends EntityRenderer<ModBoatEntity> {
   private static final ResourceLocation[] MOD_BOAT_TEXTURES = new ResourceLocation[]{new ResourceLocation(Ervin_mod_1.MOD_ID,"textures/entity/boat/firg.png"), new ResourceLocation(Ervin_mod_1.MOD_ID,"textures/entity/boat/frim.png")};
   ...
   public ResourceLocation getEntityTexture(ModBoatEntity entity) {
      return MOD_BOAT_TEXTURES[entity.getBoatType().ordinal()];
   }
}
