...
public enum TextFormatting1 {
   ...
   private static final Map<String, TextFormatting1> NAME_MAPPING = Arrays.stream(values()).collect(Collectors.toMap((p_199746_0_) -> lowercaseAlpha(p_199746_0_.name), (p_199747_0_) -> p_199747_0_));
   ...
   private TextFormatting1(String formattingName, char formattingCodeIn, int index, @Nullable Integer colorCode) {
      this(formattingName, formattingCodeIn, false, index, colorCode);
   }

   private TextFormatting1(String formattingName, char formattingCodeIn, boolean fancyStylingIn) {
      this(formattingName, formattingCodeIn, fancyStylingIn, -1, (Integer)null);
   }

   private TextFormatting1(String formattingName, char formattingCodeIn, boolean fancyStylingIn, int index, @Nullable Integer colorCode) {
    ...
    */
   @Nullable
   public static TextFormatting1 getValueByName(@Nullable String friendlyName) {
    ...
    */
   @Nullable
   public static TextFormatting1 fromColorIndex(int index) {
      if (index < 0) {
         return RESET;
      } else {
         for(TextFormatting1 textformatting : values()) {
   ...
   @Nullable
   @OnlyIn(Dist.CLIENT)
   public static TextFormatting1 fromFormattingCode(char formattingCodeIn) {
