...
public abstract class Registry<T> implements Codec<T>, Keyable, IObjectIntIterable<T> {
   ...
   protected static final net.minecraft.util.registry.MutableRegistry<net.minecraft.util.registry.MutableRegistry<?>> ROOT_REGISTRY = new SimpleRegistry<>(createKey("root"), Lifecycle.experimental());
   ...
   public static final RegistryKey<Registry<INirtreType>> NIRTRE_TYPE_KEY = createKey("nirtre_type");
   public static final RegistryKey<Registry<VillagerProfession>> VILLAGER_PROFESSION_KEY = createKey("villager_profession");
   public static final RegistryKey<Registry<NirtreProfession>> NIRTRE_PROFESSION_KEY = createKey("nirtre_profession");
   public static final RegistryKey<Registry<PointOfInterestType>> POINT_OF_INTEREST_TYPE_KEY = createKey("point_of_interest_type");
   public static final RegistryKey<Registry<PointOfInterestType1>> POINT_OF_INTEREST_TYPE1_KEY = createKey("point_of_interest_type1");
   ...
   public static final DefaultedRegistry<Block> BLOCK = forgeDefaulted(BLOCK_KEY, Block.class, () -> {
      return Blocks.AIR;
   });
   @Deprecated public static final Registry<Enchantment> ENCHANTMENT = forge(ENCHANTMENT_KEY, Enchantment.class, () -> {
      return Enchantments.FORTUNE;
   });
   public static final DefaultedRegistry<EntityType<?>> ENTITY_TYPE = forgeDefaulted(ENTITY_TYPE_KEY, EntityType.class, () -> {
   ...
   public static final Registry<Feature<?>> FEATURE = forge(FEATURE_KEY, Feature.class, () -> {
      return Feature.ORE;
   });
   @Deprecated public static final Registry<Placement<?>> DECORATOR = forge(DECORATOR_KEY, Placement.class, () -> {
      return Placement.NOPE;
   });
   public static final Registry<Biome> BIOME = forge(BIOME_KEY, Biome.class, () -> {
      return Biomes.DEFAULT;
   });
   public static final Registry<BlockStateProviderType<?>> BLOCK_STATE_PROVIDER_TYPE = forge(BLOCK_STATE_PROVIDER_TYPE_KEY, BlockStateProviderType.class, () -> {
      return BlockStateProviderType.SIMPLE_STATE_PROVIDER;
   });
   public static final Registry<BlockPlacerType<?>> BLOCK_PLACER_TYPE = forge(BLOCK_PLACER_TYPE_KEY, BlockPlacerType.class, () -> {
      return BlockPlacerType.SIMPLE_BLOCK;
   });
   public static final Registry<FoliagePlacerType<?>> FOLIAGE_PLACER_TYPE = forge(FOLIAGE_PLACER_TYPE_KEY, FoliagePlacerType.class, () -> {
   ...
   public static final Registry<TreeDecoratorType<?>> TREE_DECORATOR_TYPE = forge(TREE_DECORATOR_TYPE_KEY, TreeDecoratorType.class, () -> {
   ...
   public static final DefaultedRegistry<INirtreType> NIRTRE_TYPE = registerDefaulted(NIRTRE_TYPE_KEY, "example", () -> INirtreType.PLAINS);
   ...
   public static final DefaultedRegistry<NirtreProfession> NIRTRE_PROFESSION = forgeDefaulted(NIRTRE_PROFESSION_KEY, NirtreProfession.class, () -> NirtreProfession.NONE);
   ...
   @Deprecated public static final DefaultedRegistry<PointOfInterestType1> POINT_OF_INTEREST_TYPE1 = forgeDefaulted(POINT_OF_INTEREST_TYPE1_KEY, PointOfInterestType1.class, () -> PointOfInterestType1.NIRTRE);
   ...
   private static <T extends net.minecraft.util.registry.MutableRegistry<?>> void validateMutableRegistry(net.minecraft.util.registry.MutableRegistry<T> registry) {
   ...
   private static <T, R extends net.minecraft.util.registry.MutableRegistry<T>> R func_239743_a_(RegistryKey<Registry<T>> registryKey, R instance, Supplier<T> objectSupplier) {
      ResourceLocation resourcelocation = registryKey.func_240901_a_();
      LOCATION_TO_SUPPLIER.put(resourcelocation, objectSupplier);
      return (R)((net.minecraft.util.registry.MutableRegistry)ROOT_REGISTRY).register((RegistryKey)registryKey, (Object)instance);
   }
   ...
   public static <V, T extends V> T register(Registry<V> registry, ResourceLocation identifier, T value) {
      return ((net.minecraft.util.registry.MutableRegistry<V>)registry).register(RegistryKey.func_240903_a_(registry.registryKey, identifier), value);
   }
