...
public abstract class FlowingFluid1 extends Fluid {
   public static final BooleanProperty FALLING = BlockStateProperties.FALLING;
   public static final IntegerProperty LEVEL_1_16 = ModBlockStateProperties.LEVEL_1_16;
   ...
   public IFluidState getFlowingFluidState(int level, boolean falling) {
      return this.getFlowingFluid().getDefaultState().with(LEVEL_1_16, Integer.valueOf(level)).with(FALLING, Boolean.valueOf(falling));
   }
