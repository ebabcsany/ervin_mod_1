...
public abstract class ForgeFlowingFluid1 extends FlowingFluid
{
    ...
    protected ForgeFlowingFluid1(Properties properties)
    {
    ...
    public static class Flowing extends ForgeFlowingFluid1
    {
    ...
    public static class Source extends ForgeFlowingFluid1
    {
    ...
    public static class Properties
    {
        ...
        private Supplier<? extends FlowingFluidBlock1> block1;
        ...
        public Properties block1(Supplier<? extends FlowingFluidBlock1> block)
        {
            this.block1 = block;
            return this;
        }
