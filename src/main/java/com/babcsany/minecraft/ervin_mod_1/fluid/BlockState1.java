...
public class BlockState1 /*extends StateHolder<Block, BlockState1> implements IStateHolder<BlockState1>, net.minecraftforge.common.extensions.IForgeBlockState*/ {
   ...
   public BlockState1(Block blockIn, ImmutableMap<IProperty<?>, Comparable<?>> properties) {
   ...
   public void cacheState() {
      if (!this.getBlock().isVariableOpacity()) {
         this.cache = new BlockState1.Cache(this);
      }
   ...
   /** @deprecated use {@link BlockState1#isAir(IBlockReader, BlockPos) */
   /*@Deprecated
   public boolean isAir() {
      return this.getBlock().isAir(this);
   }

   /** @deprecated use {@link BlockState1#rotate(IWorld, BlockPos, Rotation) */
   /*@Deprecated
    ...
    * /
   public BlockState1 rotate(Rotation rot) {
    ...
    * /
   public BlockState1 mirror(Mirror mirrorIn) {
   ...
   @OnlyIn(Dist.CLIENT)
   public boolean isSideInvisible(BlockState1 state, Direction face) {
   ...
   public void onBlockAdded(World worldIn, BlockPos pos, BlockState1 oldState, boolean isMoving) {
      this.getBlock().onBlockAdded(this, worldIn, pos, oldState, isMoving);
   }

   public void onReplaced(World worldIn, BlockPos pos, BlockState1 newState, boolean isMoving) {
   ...
   public BlockState1 updatePostPlacement(Direction face, BlockState1 queried, IWorld worldIn, BlockPos currentPos, BlockPos offsetPos) {
   ...
   public static <T> Dynamic<T> serialize(DynamicOps<T> opsIn, BlockState1 state) {
   ...
   public static <T> BlockState1 deserialize(Dynamic<T> dynamic) {
      ...
      BlockState1 blockstate = block.getDefaultState();
      StateContainer<Block, BlockState1> statecontainer = block.getStateContainer();
   ...
   static final class Cache {
      ...
      private Cache(BlockState1 stateIn) {
