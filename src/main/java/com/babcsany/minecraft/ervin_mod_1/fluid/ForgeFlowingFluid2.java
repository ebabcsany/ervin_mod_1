...
public abstract class ForgeFlowingFluid2 extends FlowingFluid
{
    ...
    @Nullable
    private final Supplier<? extends FlowingFluidBlock2> block;
    ...
    protected ForgeFlowingFluid2(Properties properties)
    {
    ...
    {
        if (block != null)
            return block.get().getDefaultState().with(FlowingFluidBlock2.LEVEL, getLevelFromState(state));
    ...
    public static class Flowing extends ForgeFlowingFluid2
    {
    ...
    public static class Source extends ForgeFlowingFluid2
    {
    ...
    public static class Properties
    {
        ...
        private Supplier<? extends FlowingFluidBlock2> block;
        ...
        public Properties block(Supplier<? extends FlowingFluidBlock2> block)
        {
            this.block = block;
            return this;
        }
