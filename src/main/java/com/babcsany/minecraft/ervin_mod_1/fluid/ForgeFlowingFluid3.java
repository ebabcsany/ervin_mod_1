...
public abstract class ForgeFlowingFluid3 extends FlowingFluid1
{
    ...
    @Nullable
    private final Supplier<? extends FlowingFluidBlock1> block;
    ...
    protected ForgeFlowingFluid3(Properties properties)
    {
    ...
    {
        if (block != null)
            return block.get().getDefaultState().with(FlowingFluidBlock1.LEVEL, getLevelFromState(state));
    ...
    public static class Flowing extends ForgeFlowingFluid3
    {
        public Flowing(Properties properties)
        {
            super(properties);
            setDefaultState(getStateContainer().getBaseState().with(LEVEL_1_16, 15));
        }

        protected void fillStateContainer(StateContainer.Builder<Fluid, IFluidState> builder) {
            super.fillStateContainer(builder);
            builder.add(LEVEL_1_16);
        }

        public int getLevel(IFluidState state) {
            return state.get(LEVEL_1_16);
        }
    ...
    public static class Source extends ForgeFlowingFluid3
    {
    ...
    public static class Properties
    {
        ...
        private Supplier<? extends FlowingFluidBlock1> block;
        ...
        public Properties block(Supplier<? extends FlowingFluidBlock1> block)
        {
            this.block = block;
            return this;
        }
