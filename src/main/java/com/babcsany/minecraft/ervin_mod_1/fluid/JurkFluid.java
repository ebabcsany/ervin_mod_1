...
public abstract class JurkFluid extends FlowingFluid2 {
   ...
   public BlockState getBlockState(IFluidState state) {
      return BlockInit.JURK.get().getDefaultState().with(JurkFlowingFluid.LEVEL, Integer.valueOf(getLevelFromState(state)));
   }
   ...
   public boolean canDisplace(IFluidState p_215665_1_, IBlockReader p_215665_2_, BlockPos p_215665_3_, Fluid p_215665_4_, Direction p_215665_5_) {
      return p_215665_5_ == Direction.DOWN && !p_215665_4_.isIn(FluidTag.JURK);
   }
