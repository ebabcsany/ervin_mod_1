...
public abstract class MilkFluid extends FlowingFluid1 {
   ...
   public BlockState getBlockState(IFluidState state) {
      return FluidInit.MILK_BLOCK.get().getDefaultState().with(JurkFlowingFluid.LEVEL, Integer.valueOf(getLevelFromState(state)));
   }

   public boolean isEquivalentTo(Fluid fluidIn) {
      return fluidIn == ModFluids.MILK || fluidIn == ModFluids.FLOWING_MILK;
   }
   ...
   public boolean canDisplace(IFluidState p_215665_1_, IBlockReader p_215665_2_, BlockPos p_215665_3_, Fluid p_215665_4_, Direction p_215665_5_) {
      return p_215665_5_ == Direction.DOWN && !p_215665_4_.isIn(FluidTag.MILK);
   }
   ...
   public static class Flowing extends MilkFluid {
      ...
      public int getLevel(IFluidState p_207192_1_) {
         return p_207192_1_.get(LEVEL_1_16);
      }
