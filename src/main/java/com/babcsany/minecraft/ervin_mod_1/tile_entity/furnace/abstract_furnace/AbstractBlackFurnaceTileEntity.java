...
public abstract class AbstractBlackFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
   ...
   public static Map<Item, Integer> getBurnTimes() {
      ...
      addItemBurnTime(map, MinecraftBlockItems.COAL_SLAB.get(), 8000);
      ...
      addItemBurnTime(map, BurningItemInit.GART.get(), 50000);
      addItemBurnTime(map, BurningItemInit.GARB.get(), 125000);
      addItemBurnTime(map, BurningItemInit.GARK.get(), 312500);
      addItemBurnTime(map, isBurnableBlockItemInit_.GARK_BLOCK.get(), 781250);
      addItemBurnTime(map, isBurnableBlockItemInit_.GARK_SLAB.get(), 256150);
      addItemBurnTime(map, isBurnableBlockItemInit_.GARK_STAIRS.get(), 384225);
      addItemBurnTime(map, BurningItemInit.GARKT.get(), 1953125);
      addItemBurnTime(map, BurningItemInit.GARKTH.get(), 12500000);
      addItemBurnTime(map, BurningItemInit.TRAGH.get(), 31250000);
      addItemBurnTime(map, BurningItemInit.TRAGK.get(), 78125000);
      addItemBurnTime(map, isBurnableBlockItemInit_.TRAGK_BLOCK.get(), tragk_block);
      addItemBurnTime(map, BurningItemInit.TRAGT.get(), tragk_block * 10);
      addItemBurnTime(map, isBurnableBlockItemInit_.TRAGN.get(), tragk_block * 100);
