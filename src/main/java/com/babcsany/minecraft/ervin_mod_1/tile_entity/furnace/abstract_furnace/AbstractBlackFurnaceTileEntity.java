...
public abstract class AbstractBlackFurnaceTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
   ...
   public static Map<Item, Integer> getBurnTimes() {
      ...
      addItemBurnTime(map, isBurnableItemInit.GARK, 312500);
      addItemBurnTime(map, isBurnableBlockItemInit.GARK_BLOCK, 781250);
      addItemBurnTime(map, isBurnableBlockItemInit.GARK_SLAB, 256150);
      addItemBurnTime(map, isBurnableBlockItemInit.GARK_STAIRS, 384225);
      addItemBurnTime(map, isBurnableItemInit.GARKT, 1953125);
      addItemBurnTime(map, isBurnableItemInit.GARKTH, 12500000);
      addItemBurnTime(map, isBurnableItemInit.TRAGH, 31250000);
      addItemBurnTime(map, isBurnableItemInit.TRAGK, 78125000);
      addItemBurnTime(map, isBurnableBlockItemInit.TRAGK_BLOCK, tragk_block);
      addItemBurnTime(map, isBurnableItemInit.TRAGT, tragk_block * 10);
      addItemBurnTime(map, isBurnableBlockItemInit.TRAGN, tragk_block * 100);
      addItemBurnTime(map, Items.LAVA_BUCKET, 20000);
      addItemBurnTime(map, Blocks.COAL_BLOCK, 16000);
      addItemBurnTime(map, ItemInit.FIRT, 1200);
      ...
      addItemBurnTime(map, ArmorItemInit.FIRT_BOOTS, 4800);
      addItemBurnTime(map, ArmorItemInit.FIRT_HELMET, 6000);
