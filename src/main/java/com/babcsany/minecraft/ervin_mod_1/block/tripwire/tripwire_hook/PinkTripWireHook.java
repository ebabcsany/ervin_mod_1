...
public class PinkTripWireHook extends ModTripWireHookBlock {
   public PinkTripWireHook(Properties properties) {
      super(properties);
   ...
   public Block getTripWire() {
      return BlockInit.PINK_TRIPWIRE.get();
   }

   @Override
   public Block getTripWireHook() {
      return BlockInit.PINK_TRIPWIRE_HOOK.get();
   }
}