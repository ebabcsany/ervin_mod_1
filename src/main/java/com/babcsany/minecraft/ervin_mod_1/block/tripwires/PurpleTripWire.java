...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.PurpleTripWireHook;
...
public class PurpleTripWire extends Block {
   ...
   private final PurpleTripWireHook field_196538_F;

   public PurpleTripWire(PurpleTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
