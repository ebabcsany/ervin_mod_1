...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.OrangeTripWireHook;
...
public class OrangeTripWire extends Block {
   ...
   private final OrangeTripWireHook field_196538_F;

   public OrangeTripWire(OrangeTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
