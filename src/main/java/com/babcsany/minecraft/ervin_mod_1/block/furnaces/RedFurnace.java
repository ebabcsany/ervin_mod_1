package com.babcsany.minecraft.ervin_mod_1.block.furnaces;
...
public class RedFurnace extends AbstractFurnaceBlock {
    public RedFurnace(AbstractBlock.Properties builder) {
        super(builder);
    }
