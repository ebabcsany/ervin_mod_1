...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.MagentaTripWireHook;
...
public class MagentaTripWire extends Block {
   ...
   private final MagentaTripWireHook field_196538_F;

   public MagentaTripWire(MagentaTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
