...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.LimeTripWireHook;
...
public class LimeTripWire extends Block {
   ...
   private final LimeTripWireHook field_196538_F;

   public LimeTripWire(LimeTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
