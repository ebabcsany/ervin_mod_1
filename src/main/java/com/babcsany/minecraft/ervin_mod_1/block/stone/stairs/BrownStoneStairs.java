...
import com.babcsany.minecraft.ervin_mod_1.block.stone.slabs.BrownStoneSlab;
...
public class BrownStoneStairs extends Block implements IWaterLoggable {
   ...
   public BrownStoneStairs(BlockState state, Properties properties) {
      super(properties);
   ...
   public BrownStoneStairs(java.util.function.Supplier<BlockState> state, Properties properties) {
      super(properties);
      this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(HALF, Half.BOTTOM).with(SHAPE, StairsShape.STRAIGHT).with(WATERLOGGED, Boolean.valueOf(false)));
   ...
   public static boolean isBlockStairs(BlockState state) {
      return state.getBlock() instanceof BrownStoneStairs;
   }
