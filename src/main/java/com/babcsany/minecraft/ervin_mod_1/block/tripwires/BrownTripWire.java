...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.BrownTripWireHook;
...
public class BrownTripWire extends Block {
   ...
   private final BrownTripWireHook field_196538_F;

   public BrownTripWire(BrownTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
