...
public class LightBlueTripWire extends Block {
   ...
   private final LightBlueTripWireHook field_196538_F;

   public LightBlueTripWire(LightBlueTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
