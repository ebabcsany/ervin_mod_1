...
public class BrownTripWireHook extends ModTripWireHookBlock {
   public BrownTripWireHook(Properties properties) {
      super(properties);
   ...
   public Block getTripWire() {
      return BlockInit.BROWN_TRIPWIRE.get();
   }

   @Override
   public Block getTripWireHook() {
      return BlockInit.BROWN_TRIPWIRE_HOOK.get();
   }
}