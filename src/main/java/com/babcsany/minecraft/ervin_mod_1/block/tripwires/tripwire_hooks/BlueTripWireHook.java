...
public class BlueTripWireHook extends Block {
   ...
   public BlueTripWireHook(Properties properties) {
      super(properties);
   ...
   public void calculateState(World worldIn, BlockPos pos, BlockState hookState, boolean p_176260_4_, boolean p_176260_5_, int p_176260_6_, @Nullable BlockState p_176260_7_) {
      ...
      for(int j = 1; j < 42; ++j) {
         ...
         if (blockstate.getBlock() != BlockInit.BLUE_TRIPWIRE.get() && j != p_176260_6_) {
            ablockstate[j] = null;
            flag2 = false;
         } else {
            if (j == p_176260_6_) {
