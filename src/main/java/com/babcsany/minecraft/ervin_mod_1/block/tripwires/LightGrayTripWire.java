...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.LightGrayTripWireHook;
...
public class LightGrayTripWire extends Block {
   ...
   private final LightGrayTripWireHook field_196538_F;

   public LightGrayTripWire(LightGrayTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
