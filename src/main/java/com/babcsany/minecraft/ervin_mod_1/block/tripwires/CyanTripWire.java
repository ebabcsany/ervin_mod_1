...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.CyanTripWireHook;
...
public class CyanTripWire extends Block {
   ...
   private final CyanTripWireHook field_196538_F;

   public CyanTripWire(CyanTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
