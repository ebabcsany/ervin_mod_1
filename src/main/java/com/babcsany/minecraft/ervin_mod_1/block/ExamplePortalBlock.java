...
public class ExamplePortalBlock extends Block {
    ...
    public ExamplePortalBlock(AbstractBlock.Properties properties) {
        super(properties);
     ...
     * this method is unrelated to {@link #randomTick} and {@link #tick(BlockState, ServerWorld, BlockPos, Random)}, and will always be called regardless
