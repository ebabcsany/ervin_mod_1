...
public class FlowingFluidBlock$l extends Block implements IBucketPickupHandler {
   public static final IntegerProperty LEVEL = ModBlockStateProperties.LEVEL_0_1;
   ...
   public FlowingFluidBlock$l(FlowingFluid fluidIn, Properties builder) {
      super(builder);
      this.fluid = fluidIn;
    ...
    */
   public FlowingFluidBlock$l(java.util.function.Supplier<? extends FlowingFluid> supplier, Properties properties) {
      super(properties);
      this.fluid = null;
      this.field_212565_c = Lists.newArrayList();
      this.setDefaultState(this.stateContainer.getBaseState().with(LEVEL, Integer.valueOf(0)));
