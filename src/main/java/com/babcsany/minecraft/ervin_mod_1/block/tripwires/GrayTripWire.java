...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.GrayTripWireHook;
...
public class GrayTripWire extends Block {
   ...
   private final GrayTripWireHook field_196538_F;

   public GrayTripWire(GrayTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
