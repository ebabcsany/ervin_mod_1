...
public class GreenTripWireHook extends ModTripWireHookBlock {
   public GreenTripWireHook(Properties properties) {
      super(properties);
   ...
   public Block getTripWire() {
      return BlockInit.GREEN_TRIPWIRE.get();
   }

   @Override
   public Block getTripWireHook() {
      return BlockInit.GREEN_TRIPWIRE_HOOK.get();
   }
}