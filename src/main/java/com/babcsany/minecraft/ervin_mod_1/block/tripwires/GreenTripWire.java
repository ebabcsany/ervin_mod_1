...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.GreenTripWireHook;
...
public class GreenTripWire extends Block {
   ...
   private final GreenTripWireHook field_196538_F;

   public GreenTripWire(GreenTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
