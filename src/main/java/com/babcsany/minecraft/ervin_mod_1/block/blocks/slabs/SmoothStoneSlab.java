package com.babcsany.minecraft.ervin_mod_1.block.blocks.slabs;
...
public class SmoothStoneSlab extends Block implements IWaterLoggable {
   ...
   public SmoothStoneSlab(Properties properties) {
      super(properties);
