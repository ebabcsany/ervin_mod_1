package com.babcsany.minecraft.ervin_mod_1.block.stone.smooth_stone.slabs;
...
public class LightBlue1SmoothStoneSlab extends Block implements IWaterLoggable {
   ...
   public LightBlue1SmoothStoneSlab(Properties properties) {
      super(properties);
