...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.PinkTripWireHook;
...
public class PinkTripWire extends Block {
   ...
   private final PinkTripWireHook field_196538_F;

   public PinkTripWire(PinkTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
