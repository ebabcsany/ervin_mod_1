...
public class BlueTripWire extends Block {
   ...
   private final BlueTripWireHook field_196538_F;

   public BlueTripWire(BlueTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
      ...
      for(Direction direction : new Direction[]{Direction.SOUTH, Direction.WEST}) {
         for(int i = 1; i < 42; ++i) {
            ...
            if (blockstate.getBlock() == this.field_196538_F) {
               if (blockstate.get(BlueTripWireHook.FACING) == direction.getOpposite()) {
   ...
   public boolean shouldConnectTo(BlockState p_196536_1_, Direction p_196536_2_) {
      ...
      if (block == this.field_196538_F) {
         return p_196536_1_.get(BlueTripWireHook.FACING) == p_196536_2_.getOpposite();
      } else {
         return block == this;
      }
   }
