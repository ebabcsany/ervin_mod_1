...
public class BlackTripWire extends Block {
   ...
   private final BlackTripWireHook field_196538_F;

   public BlackTripWire(BlackTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
