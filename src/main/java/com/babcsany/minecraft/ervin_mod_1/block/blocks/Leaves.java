...
public class Leaves extends Block implements net.minecraftforge.common.IForgeShearable {
   ...
   private static int getDistance(BlockState neighbor) {
      if (BlockTags.LOGS.contains(neighbor.getBlock())) {
         ...
         return neighbor.getBlock() instanceof Leaves ? neighbor.get(DISTANCE) : 7;
      }
   }
