...
public class RugkStairs extends Block implements IWaterLoggable {
   ...
   public RugkStairs(BlockState state, Properties properties) {
      super(properties);
   ...
   public RugkStairs(java.util.function.Supplier<BlockState> state, Properties properties) {
      super(properties);
      this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(HALF, Half.BOTTOM).with(SHAPE, StairsShape.STRAIGHT).with(WATERLOGGED, Boolean.valueOf(false)));
