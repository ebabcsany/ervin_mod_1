package com.babcsany.minecraft.ervin_mod_1.block.stone.slabs;
...
public class LightBlue1StoneSlab extends Block implements IWaterLoggable {
   ...
   public LightBlue1StoneSlab(Properties properties) {
      super(properties);
