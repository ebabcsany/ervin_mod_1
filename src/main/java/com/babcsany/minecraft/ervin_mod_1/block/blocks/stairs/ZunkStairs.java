...
public class ZunkStairs extends Block implements IWaterLoggable {
   ...
   public ZunkStairs(BlockState state, Properties properties) {
      super(properties);
   ...
   public ZunkStairs(java.util.function.Supplier<BlockState> state, Properties properties) {
      super(properties);
      this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(HALF, Half.BOTTOM).with(SHAPE, StairsShape.STRAIGHT).with(WATERLOGGED, Boolean.valueOf(false)));
   ...
   public static boolean isBlockStairs(BlockState state) {
      return state.getBlock() instanceof ZunkStairs;
   }
