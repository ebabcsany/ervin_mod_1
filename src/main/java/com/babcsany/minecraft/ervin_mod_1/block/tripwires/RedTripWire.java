...
import com.babcsany.minecraft.ervin_mod_1.block.tripwires.tripwire_hooks.RedTripWireHook;
...
public class RedTripWire extends Block {
   ...
   private final RedTripWireHook field_196538_F;

   public RedTripWire(RedTripWireHook p_i48305_1_, Properties properties) {
      super(properties);
