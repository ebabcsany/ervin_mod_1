...
import com.babcsany.minecraft.ervin_mod_1.block.stone.cobblestone.slabs.LightGrayCobblestoneSlab;
...
public class LightGrayCobblestoneStairs extends Block implements IWaterLoggable {
   public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
   public static final EnumProperty<Half> HALF = BlockStateProperties.HALF;
   public static final EnumProperty<StairsShape> SHAPE = BlockStateProperties.STAIRS_SHAPE;
   public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
   protected static final VoxelShape AABB_SLAB_TOP = LightGrayCobblestoneSlab.TOP_SHAPE;
   protected static final VoxelShape AABB_SLAB_BOTTOM = LightGrayCobblestoneSlab.BOTTOM_SHAPE;
   ...
   public LightGrayCobblestoneStairs(BlockState state, Properties properties) {
      super(properties);
   ...
   public LightGrayCobblestoneStairs(java.util.function.Supplier<BlockState> state, Properties properties) {
      super(properties);
      this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(HALF, Half.BOTTOM).with(SHAPE, StairsShape.STRAIGHT).with(WATERLOGGED, Boolean.valueOf(false)));
   ...
   public static boolean isBlockStairs(BlockState state) {
      return state.getBlock() instanceof LightGrayCobblestoneStairs;
   }
