...
public abstract class AnimalEntity1 extends AgeableEntity1 {
   private int inLove;
   private UUID playerInLove;

   protected AnimalEntity1(EntityType<? extends AnimalEntity1> type, World worldIn) {
      super(type, worldIn);
   }
    ...
    */
   public static boolean canAnimalSpawn(EntityType<? extends AnimalEntity1> animal, IWorld worldIn, SpawnReason reason, BlockPos pos, Random random) {
    ...
    */
   public boolean canMateWith(AnimalEntity1 otherAnimal) {
      if (otherAnimal == this) {
         return false;
