...
public class NearestAttackableDgrurbkMobTargetGoal<T extends LivingEntity> extends DgrurbkTargetGoal {
   ...
   public NearestAttackableDgrurbkMobTargetGoal(DgrurbMobEntity goalOwnerIn, Class<T> targetClassIn, boolean checkSight) {
      this(goalOwnerIn, targetClassIn, checkSight, false);
   }

   public NearestAttackableDgrurbkMobTargetGoal(DgrurbMobEntity goalOwnerIn, Class<T> targetClassIn, boolean checkSight, boolean nearbyOnlyIn) {
      this(goalOwnerIn, targetClassIn, 10, checkSight, nearbyOnlyIn, null);
   }

   public NearestAttackableDgrurbkMobTargetGoal(DgrurbMobEntity goalOwnerIn, Class<T> targetClassIn, int targetChanceIn, boolean checkSight, boolean nearbyOnlyIn, @Nullable Predicate<LivingEntity> targetPredicate) {
