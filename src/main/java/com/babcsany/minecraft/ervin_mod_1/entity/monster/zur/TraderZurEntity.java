...
public abstract class TraderZurEntity extends TameableZurEntity implements INPC, IMerchant {
   private static final DataParameter<Integer> SHAKE_HEAD_TICKS = EntityDataManager.createKey(TraderZurEntity.class, DataSerializers.VARINT);
   @Nullable
   private PlayerEntity customer;
   @Nullable
   protected MerchantOffers offers;
   public final Inventory zurInventory = new Inventory(1000000);
   ...
   protected abstract void onTraderZurTrade(MerchantOffer offer);
