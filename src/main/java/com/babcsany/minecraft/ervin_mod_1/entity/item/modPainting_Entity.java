...
public class modPainting_Entity extends HangingEntity {
   ...
   public modPainting_Entity(EntityType<? extends modPainting_Entity> type, World worldIn) {
      super(type, worldIn);
   }

    public modPainting_Entity(World worldIn, BlockPos pos, Direction facing) {
   ...
   @OnlyIn(Dist.CLIENT)
   public modPainting_Entity(World worldIn, BlockPos pos, Direction facing, modPainting_Type artIn) {
