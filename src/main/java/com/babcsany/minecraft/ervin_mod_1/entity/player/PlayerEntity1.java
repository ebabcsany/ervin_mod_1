...
public abstract class PlayerEntity1 extends PlayerEntity {
   ...
   private static final DataParameter<Float> ABSORPTION = EntityDataManager.createKey(PlayerEntity1.class, DataSerializers.FLOAT);
   private static final DataParameter<Integer> PLAYER_SCORE = EntityDataManager.createKey(PlayerEntity1.class, DataSerializers.VARINT);
   protected static final DataParameter<Byte> PLAYER_MODEL_FLAG = EntityDataManager.createKey(PlayerEntity1.class, DataSerializers.BYTE);
   protected static final DataParameter<Byte> MAIN_HAND = EntityDataManager.createKey(PlayerEntity1.class, DataSerializers.BYTE);
   protected static final DataParameter<CompoundNBT> LEFT_SHOULDER_ENTITY = EntityDataManager.createKey(PlayerEntity1.class, DataSerializers.COMPOUND_NBT);
   protected static final DataParameter<CompoundNBT> RIGHT_SHOULDER_ENTITY = EntityDataManager.createKey(PlayerEntity1.class, DataSerializers.COMPOUND_NBT);
      ...
      if (p_192028_1_ != null && (!p_192028_1_.contains("Silent") || !p_192028_1_.getBoolean("Silent")) && this.world.rand.nextInt(200) == 0) {
         ...
         EntityType.byKey(s).filter((p_213830_0_) -> {
            ...
            if (!ParrotEntity.playMimicSound(this.world, this)) {
               this.world.playSound((PlayerEntity1)null, this.getPosX(), this.getPosY(), this.getPosZ(), ParrotEntity.func_234212_a_(this.world, this.world.rand), this.getSoundCategory(), 1.0F, ParrotEntity.getPitch(this.world.rand));
            }
   ...
   public boolean canAttackPlayer(PlayerEntity1 other) {
         ...
         if (!targetEntity.hitByEntity(this)) {
            ...
            if (f > 0.0F || f1 > 0.0F) {
               ...
               if (this.isSprinting() && flag) {
                  this.world.playSound((PlayerEntity1)null, this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.ENTITY_PLAYER_ATTACK_KNOCKBACK, this.getSoundCategory(), 1.0F, 1.0F);
                  ++i;
                  flag1 = true;
               }
               ...
               if (flag5) {
                  ...
                  if (flag3) {
                     ...
                     this.world.playSound((PlayerEntity1)null, this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.ENTITY_PLAYER_ATTACK_SWEEP, this.getSoundCategory(), 1.0F, 1.0F);
                     this.spawnSweepParticles();
                  }

                  if (targetEntity instanceof ServerPlayerEntity1 && targetEntity.velocityChanged) {
                     ((ServerPlayerEntity1)targetEntity).connection.sendPacket(new SEntityVelocityPacket(targetEntity));
                     targetEntity.velocityChanged = false;
                     targetEntity.setMotion(vector3d);
                  }

                  if (flag2) {
                     this.world.playSound((PlayerEntity1)null, this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.ENTITY_PLAYER_ATTACK_CRIT, this.getSoundCategory(), 1.0F, 1.0F);
                     this.onCriticalHit(targetEntity);
                  }

                  if (!flag2 && !flag3) {
                     if (flag) {
                        this.world.playSound((PlayerEntity1)null, this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.ENTITY_PLAYER_ATTACK_STRONG, this.getSoundCategory(), 1.0F, 1.0F);
                     } else {
                        this.world.playSound((PlayerEntity1)null, this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.ENTITY_PLAYER_ATTACK_WEAK, this.getSoundCategory(), 1.0F, 1.0F);
                     }
                  }
                  ...
                  this.world.playSound((PlayerEntity1)null, this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.ENTITY_PLAYER_ATTACK_NODAMAGE, this.getSoundCategory(), 1.0F, 1.0F);
                  if (flag4) {
   ...
   /**
    * Plays the {@link #getSplashSound() splash sound}, and the {@link ParticleTypes#BUBBLE} and {@link
    * ParticleTypes#SPLASH} particles.
    */
   ...
   public void addExperienceLevel(int levels) {
      ...
      if (levels > 0 && this.experienceLevel % 5 == 0 && (float)this.lastXPSound < (float)this.ticksExisted - 100.0F) {
         ...
         this.world.playSound((PlayerEntity1)null, this.getPosX(), this.getPosY(), this.getPosZ(), SoundEvents.ENTITY_PLAYER_LEVELUP, this.getSoundCategory(), f * 0.75F, 1.0F);
    ...
    */
   protected int getExperiencePoints(PlayerEntity1 player) {
   ...
   public ItemStack onFoodEaten(World p_213357_1_, ItemStack p_213357_2_, PlayerEntity player) {
      ...
      if (player instanceof ServerPlayerEntity1) {
         CriteriaTriggers.CONSUME_ITEM.trigger((ServerPlayerEntity1)player, p_213357_2_);
      }
