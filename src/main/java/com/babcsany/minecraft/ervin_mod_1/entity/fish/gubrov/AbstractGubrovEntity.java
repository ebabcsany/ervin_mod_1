...
public abstract class AbstractGubrovEntity extends WaterMobEntity {
   ...
   public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
      return MobEntity.func_233666_p_().createMutableAttribute(Attributes.MAX_HEALTH, 3000.0D);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new AvoidEntityGoal<>(this, WaterMobEntity.class, 20.0F, 16.0D, 14.0D, EntityPredicates.NOT_SPECTATING::test));
      this.goalSelector.addGoal(4, new AbstractGubrovEntity.SwimGoal(this));
   }
   ...
   public void travel(Vector3d travelVector) {
      if (this.isServerWorld() && this.isInWater()) {
         ...
         if (this.getAttackTarget() == null) {
            this.setMotion(this.getMotion().add(1.0D, -0.05D, 1.0D));
         }
      } else {
   ...
   static class MoveHelperController extends MovementController {
      private final AbstractGubrovEntity fish;

      MoveHelperController(AbstractGubrovEntity fish) {
         super(fish);
         this.fish = fish;
      }
   ...
   static class SwimGoal extends RandomSwimmingGoal {
      ...
      public SwimGoal(AbstractGubrovEntity fish) {
         super(fish, 1.0D, 40);
         this.fish = fish;
      }
