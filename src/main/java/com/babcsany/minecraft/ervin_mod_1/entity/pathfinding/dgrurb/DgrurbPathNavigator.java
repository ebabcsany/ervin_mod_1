...
public abstract class DgrurbPathNavigator {
   protected final DgrurbMobEntity entity;
   ...
   protected DgrurbNodeProcessor nodeProcessor;
   private BlockPos targetPos;
   private int field_225468_r;
   private float field_226334_s_ = 1.0F;
   private final DgrurbPathFinder pathFinder;

   public DgrurbPathNavigator(DgrurbMobEntity entityIn, World worldIn) {
   ...
   protected abstract DgrurbPathFinder getPathFinder(int p_179679_1_);
   ...
   public void tick() {
      ...
      if (!this.noPath()) {
         ...
         DebugPacketSender.sendDgrurbPath(this.world, this.entity, this.currentPath, this.maxDistanceToWaypoint);
         if (!this.noPath()) {
   ...
   public DgrurbNodeProcessor getNodeProcessor() {
