...
public class SupplementedTask<E extends LivingEntity> extends com.babcsany.minecraft.ervin_mod_1.entity.monster.zur.Task<E> {
   private final Predicate<E> field_233940_b_;
   private final com.babcsany.minecraft.ervin_mod_1.entity.monster.zur.Task<? super E> field_233941_c_;
   private final boolean field_233942_d_;

   public SupplementedTask(Map<MemoryModuleType<?>, MemoryModuleStatus> p_i231528_1_, Predicate<E> p_i231528_2_, com.babcsany.minecraft.ervin_mod_1.entity.monster.zur.Task<? super E> p_i231528_3_, boolean p_i231528_4_) {
