package com.babcsany.minecraft.ervin_mod_1.entity.ai.brain;
...
public class ModBrain<E extends LivingEntity> {
   private static final Logger field_233688_a_ = LogManager.getLogger();
   private final Supplier<Codec<ModBrain<E>>> field_233689_b_;
   ...
   public static <E extends LivingEntity> ModBrain.BrainCodec<E> func_233705_a_(Collection<? extends MemoryModuleType<?>> p_233705_0_, Collection<? extends SensorType<? extends Sensor<? super E>>> p_233705_1_) {
      return new ModBrain.BrainCodec<>(p_233705_0_, p_233705_1_);
   }

   public static <E extends LivingEntity> Codec<ModBrain<E>> func_233710_b_(final Collection<? extends MemoryModuleType<?>> p_233710_0_, final Collection<? extends SensorType<? extends Sensor<? super E>>> p_233710_1_) {
      final MutableObject<Codec<ModBrain<E>>> mutableobject = new MutableObject<>();
      mutableobject.setValue((new MapCodec<ModBrain<E>>() {
         ...
         public <T> DataResult<ModBrain<E>> decode(DynamicOps<T> p_decode_1_, MapLike<T> p_decode_2_) {
            MutableObject<DataResult<Builder<ModBrain.MemoryCodec<?>>>> mutableobject1 = new MutableObject<>(DataResult.success(ImmutableList.builder()));
            p_decode_2_.entries().forEach((p_233732_3_) -> {
               ...
               DataResult<? extends ModBrain.MemoryCodec<?>> dataresult1 = dataresult.flatMap((p_233729_3_) -> {
            ...
            ImmutableList<ModBrain.MemoryCodec<?>> immutablelist = mutableobject1.getValue().resultOrPartial(ModBrain.field_233688_a_::error).map(Builder::build).orElseGet(ImmutableList::of);
            return DataResult.success(new ModBrain<>(p_233710_0_, p_233710_1_, immutablelist, mutableobject::getValue));
         }

         private <T, U> DataResult<ModBrain.MemoryCodec<U>> func_233728_a_(MemoryModuleType<U> p_233728_1_, DynamicOps<T> p_233728_2_, T p_233728_3_) {
            return p_233728_1_.getMemoryCodec().map(DataResult::success).orElseGet(() -> {
               ...
               return new ModBrain.MemoryCodec<>(p_233728_1_, Optional.of(p_233726_1_));
            });
         }

         public <T> RecordBuilder<T> encode(ModBrain<E> p_encode_1_, DynamicOps<T> p_encode_2_, RecordBuilder<T> p_encode_3_) {
   ...
   public ModBrain(Collection<? extends MemoryModuleType<?>> p_i231494_1_, Collection<? extends SensorType<? extends Sensor<? super E>>> p_i231494_2_, ImmutableList<ModBrain.MemoryCodec<?>> p_i231494_3_, Supplier<Codec<ModBrain<E>>> p_i231494_4_) {
      ...
      for(ModBrain.MemoryCodec<?> memorycodec : p_i231494_3_) {
   ...
   private Stream<ModBrain.MemoryCodec<?>> func_233720_j_() {
      return this.memories.entrySet().stream().map((p_233707_0_) -> {
         return ModBrain.MemoryCodec.func_233743_b_(p_233707_0_.getKey(), p_233707_0_.getValue());
      });
   }
   ...
   public <U> boolean func_233708_b_(MemoryModuleType<U> p_233708_1_, U p_233708_2_) {
      return this.hasMemory(p_233708_1_) && this.getMemory(p_233708_1_).filter((p_233704_1_) -> p_233704_1_.equals(p_233708_2_)).isPresent();
   }
   ...
   public ModBrain<E> copy() {
      ModBrain<E> brain = new ModBrain<>(this.memories.keySet(), this.sensors.keySet(), ImmutableList.of(), this.field_233689_b_);
   ...
   public static final class BrainCodec<E extends LivingEntity> {
      ...
      private final Codec<ModBrain<E>> field_233746_c_;
      ...
      private BrainCodec(Collection<? extends MemoryModuleType<?>> p_i231498_1_, Collection<? extends SensorType<? extends Sensor<? super E>>> p_i231498_2_) {
         ...
         this.field_233746_c_ = ModBrain.func_233710_b_(p_i231498_1_, p_i231498_2_);
      }

      public ModBrain<E> func_233748_a_(Dynamic<?> p_233748_1_) {
         return this.field_233746_c_.parse(p_233748_1_).resultOrPartial(ModBrain.field_233688_a_::error).orElseGet(() -> {
            return new ModBrain<>(this.field_233744_a_, this.field_233745_b_, ImmutableList.of(), () -> {
   ...
   static final class MemoryCodec<U> {
      ...
      private static <U> ModBrain.MemoryCodec<U> func_233743_b_(MemoryModuleType<U> p_233743_0_, Optional<? extends Memory<?>> p_233743_1_) {
         return new ModBrain.MemoryCodec<>(p_233743_0_, (Optional<? extends Memory<U>>) p_233743_1_);
      }
      ...
      private void func_233738_a_(ModBrain<?> p_233738_1_) {
