...
public abstract class AbstractkZurEntity extends CreatureEntity implements IMob, INPC, IMerchant {
   ...
   protected AbstractkZurEntity(EntityType<? extends AbstractkZurEntity> type, World worldIn) {
      super(type, worldIn);
   ...
   @Nullable
   public abstract AbstractkZurEntity createChild(AbstractkZurEntity ageable);
    ...
    */
   public static boolean canZurSpawn(EntityType<? extends AbstractkZurEntity> animal, IWorld worldIn, SpawnReason reason, BlockPos pos, Random random) {
    ...
    */
   public boolean canMateWith(AbstractkZurEntity otherAnimal) {
      if (otherAnimal == this) {
         return false;
