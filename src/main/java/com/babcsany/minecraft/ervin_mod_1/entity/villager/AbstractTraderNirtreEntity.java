...
public abstract class AbstractTraderNirtreEntity extends AgeableEntity implements INPC, IMerchant {
   ...
   public AbstractTraderNirtreEntity(EntityType<? extends AbstractNirtreEntity> type, World worldIn) {
      super(type, worldIn);
   ...
   public void onTrade(MerchantOffer offer) {
      ...
      if (this.customer instanceof ServerPlayerEntity) {
         ModCriteriaTriggers.TRADER_NIRTRE_TRADE.test((ServerPlayerEntity)this.customer, this, offer.getSellingStack());
      }
