...
public class GroundDgrurbPathNavigator extends DgrurbPathNavigator {
   private boolean shouldAvoidSun;

   public GroundDgrurbPathNavigator(DgrurbMobEntity entitylivingIn, World worldIn) {
      super(entitylivingIn, worldIn);
   }

   protected DgrurbPathFinder getPathFinder(int p_179679_1_) {
      this.nodeProcessor = new WalkDgrurbNodeProcessor();
