...
import com.babcsany.minecraft.ervin_mod_1.entity.ai.goal.AvoidEntityGoal1;
...
public class Wolf1Entity extends TameableEntity implements IAngerable {
   private static final DataParameter<Boolean> BEGGING = EntityDataManager.createKey(Wolf1Entity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.createKey(Wolf1Entity.class, DataSerializers.VARINT);
   private static final DataParameter<Integer> field_234232_bz_ = EntityDataManager.createKey(Wolf1Entity.class, DataSerializers.VARINT);
   ...
   public Wolf1Entity(EntityType<? extends Wolf1Entity> type, World worldIn) {
      super(type, worldIn);
      this.setTamed(false);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new AvoidEntityGoal1<>(this, Wolf1Entity.class, 24.0F, 1.5D, 1.5D));
      ...
      this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, CreeperEntity.class, false));
      this.targetSelector.addGoal(14, new NearestAttackableTargetGoal<>(this, EnderDragonEntity.class, false));
      this.targetSelector.addGoal(13, new NearestAttackableTargetGoal<>(this, MonsterEntity.class, false));
      this.targetSelector.addGoal(15, new ResetAngerGoal<>(this, true));
   }
   ...
   public Wolf1Entity createChild(AgeableEntity ageable) {
      Wolf1Entity wolfentity = EntityInit.HHIJ_ENTITY.get().create(this.world);
   ...
   public boolean canMateWith(AnimalEntity otherAnimal) {
      if (otherAnimal == this) {
         ...
         return false;
      } else if (!(otherAnimal instanceof Wolf1Entity)) {
         return false;
      } else {
         Wolf1Entity wolfentity = (Wolf1Entity)otherAnimal;
   ...
   public boolean shouldAttackEntity(LivingEntity target, LivingEntity owner) {
      if (!(target instanceof CreeperEntity) && !(target instanceof GhastEntity)) {
         if (target instanceof Wolf1Entity) {
            Wolf1Entity wolfentity = (Wolf1Entity)target;
   ...
   class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
      ...
      public AvoidEntityGoal(Wolf1Entity wolfIn, Class<T> entityClassToAvoidIn, float avoidDistanceIn, double farSpeedIn, double nearSpeedIn) {
      ...
      private boolean avoidLlama(LlamaEntity llamaIn) {
         return llamaIn.getStrength() >= Wolf1Entity.this.rand.nextInt(5);
      }
      ...
      public void startExecuting() {
         Wolf1Entity.this.setAttackTarget((LivingEntity)null);
