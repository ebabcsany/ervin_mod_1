...
public class HhijRandomPositionGenerator {
    ...
    */
   @Nullable
   public static Vector3d findRandomTarget(HhijCreatureEntity entitycreatureIn, int xz, int y) {
   ...
   @Nullable
   public static Vector3d findGroundTarget(HhijCreatureEntity p_226338_0_, int p_226338_1_, int p_226338_2_, int p_226338_3_, @Nullable Vector3d p_226338_4_, double p_226338_5_) {
   ...
   @Nullable
   public static Vector3d func_221024_a(HhijCreatureEntity p_221024_0_, int p_221024_1_, int p_221024_2_, ToDoubleFunction<BlockPos> p_221024_3_) {
    ...
    */
   @Nullable
   public static Vector3d findRandomTargetBlockAwayFrom(HhijCreatureEntity entitycreatureIn, int xz, int y, Vector3d targetVec3) {
      Vector3d vector3d = entitycreatureIn.getPositionVec().subtract(targetVec3);
      return func_226339_a_(entitycreatureIn, xz, y, 0, vector3d, true, (double)((float)Math.PI / 2F), entitycreatureIn::getBlockPathWeight, false, 0, 0, true);
   }

   @Nullable
   public static Vector3d func_223548_b(HhijCreatureEntity p_223548_0_, int p_223548_1_, int p_223548_2_, Vector3d p_223548_3_) {
   ...
   @Nullable
   private static Vector3d func_226339_a_(HhijCreatureEntity p_226339_0_, int p_226339_1_, int p_226339_2_, int p_226339_3_, @Nullable Vector3d p_226339_4_, boolean p_226339_5_, double p_226339_6_, ToDoubleFunction<BlockPos> p_226339_8_, boolean p_226339_9_, int p_226339_10_, int p_226339_11_, boolean p_226339_12_) {
