...
public class FindWaterGoal extends Goal {
   private final DgrurbCreatureEntity creature;

   public FindWaterGoal(DgrurbCreatureEntity creature) {
   ...
   public void startExecuting() {
      ...
      if (blockpos != null) {
         this.creature.getMoveHelper().setMoveTo(blockpos.getX(), blockpos.getY(), (double)blockpos.getZ(), 1.0D);
      }
