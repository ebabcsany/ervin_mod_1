...
public class DgrurbkLookAtGoal extends Goal {
   ...
   public DgrurbkLookAtGoal(DgrurbMobEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
      this(entityIn, watchTargetClass, maxDistance, 0.02F);
   }

   public DgrurbkLookAtGoal(DgrurbMobEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance, float chanceIn) {
