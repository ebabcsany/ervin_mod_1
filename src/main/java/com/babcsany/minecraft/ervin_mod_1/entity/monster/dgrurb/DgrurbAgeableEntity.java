...
public abstract class DgrurbAgeableEntity extends DgrurbCreatureEntity {
   private static final DataParameter<Boolean> BABY = EntityDataManager.createKey(DgrurbAgeableEntity.class, DataSerializers.BOOLEAN);
   protected int growingAge;
   protected int forcedAge;
   protected int forcedAgeTimer;

   protected DgrurbAgeableEntity(EntityType<? extends DgrurbAgeableEntity> type, World worldIn) {
      super(type, worldIn);
   }

   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      if (spawnDataIn == null) {
         spawnDataIn = new DgrurbAgeableEntity.AgeableData();
      }

      DgrurbAgeableEntity.AgeableData ageableentity$ageabledata = (DgrurbAgeableEntity.AgeableData)spawnDataIn;
   ...
   @Nullable
   public abstract DgrurbAgeableEntity createChild(DgrurbAgeableEntity ageable);
