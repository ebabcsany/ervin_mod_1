...
public class MultiTask<E extends LivingEntity> extends Task<E> {
   ...
   public MultiTask(Map<MemoryModuleType<?>, MemoryModuleStatus> p_i51503_1_, Set<MemoryModuleType<?>> memoryModuleTypes, Ordering ordering, RunType runType, List<Pair<Task<? super E>, Integer>> pairList) {
      super(p_i51503_1_);
      this.field_220416_b = memoryModuleTypes;
      this.field_220417_c = ordering;
      this.field_220418_d = runType;
      pairList.forEach((taskIntegerPair) -> this.field_220419_e.func_226313_a_(taskIntegerPair.getFirst(), taskIntegerPair.getSecond()));
   }
   ...
   protected void updateTask(ServerWorld worldIn, E owner, long gameTime) {
      this.field_220419_e.func_220655_b().filter((p_220408_0_) -> p_220408_0_.getStatus() == Status.RUNNING).forEach((p_220409_4_) -> p_220409_4_.tick(worldIn, owner, gameTime));
   }

   protected void resetTask(ServerWorld worldIn, E entityIn, long gameTimeIn) {
      this.field_220419_e.func_220655_b().filter((p_220407_0_) -> p_220407_0_.getStatus() == Status.RUNNING).forEach((p_220412_4_) -> {
   ...
   public String toString() {
      Set<? extends Task<? super E>> set = this.field_220419_e.func_220655_b().filter((p_220410_0_) -> p_220410_0_.getStatus() == Status.RUNNING).collect(Collectors.toSet());
   ...
   enum Ordering {
      ...
      Ordering(Consumer<WeightedList<?>> p_i50849_3_) {
   ...
   enum RunType {
      RUN_ONE {
         public <E extends LivingEntity> void func_220630_a(WeightedList<Task<? super E>> p_220630_1_, ServerWorld p_220630_2_, E p_220630_3_, long p_220630_4_) {
            p_220630_1_.func_220655_b().filter((p_220634_0_) -> p_220634_0_.getStatus() == Status.STOPPED).filter((p_220633_4_) -> p_220633_4_.start(p_220630_2_, p_220630_3_, p_220630_4_)).findFirst();
         }
      },
      TRY_ALL {
         public <E extends LivingEntity> void func_220630_a(WeightedList<Task<? super E>> p_220630_1_, ServerWorld p_220630_2_, E p_220630_3_, long p_220630_4_) {
            p_220630_1_.func_220655_b().filter((p_220632_0_) -> p_220632_0_.getStatus() == Status.STOPPED).forEach((p_220631_4_) -> {
