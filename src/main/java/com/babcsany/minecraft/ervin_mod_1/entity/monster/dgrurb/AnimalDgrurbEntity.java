...
public abstract class AnimalDgrurbEntity extends DgrurbAgeableEntity {
   private int inLove;
    ...
    */
   public static boolean canAnimalSpawn(EntityType<? extends AnimalDgrurbEntity> animal, IWorld worldIn, SpawnReason reason, BlockPos pos, Random random) {
    ...
    */
   public boolean canMateWith(AnimalDgrurbEntity otherAnimal) {
      if (otherAnimal == this) {
         return false;
   ...
   public void func_234177_a_(World p_234177_1_, AnimalDgrurbEntity p_234177_2_) {
      DgrurbAgeableEntity ageableentity = this.createChild(p_234177_2_);
       ...
       ageableentity = event.getDgrurbAnimalChild();
       if (cancelled) {
      ...
      if (ageableentity != null) {
         ...
         if (serverplayerentity != null) {
            ...
            CriteriaTriggers1.BRED_DGRURB_ANIMALS.trigger(serverplayerentity, this, p_234177_2_, ageableentity);
         }
