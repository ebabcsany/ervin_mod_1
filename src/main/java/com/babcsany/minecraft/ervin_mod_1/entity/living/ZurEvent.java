 ...
 **/
public class ZurEvent extends EntityEvent {

    public ZurEvent(ZurEntity entity)
    {
        super(entity);
    }

    public ZurEntity getSummoner()
    {
        return (ZurEntity) getEntity();
    }
     ...
     **/
    @HasResult
    public static class SummonAidEvent1 extends ZurEvent {
        private ZurEntity customSummonedAid;
        ...
        public SummonAidEvent1(ZurEntity entity, World world, int x, int y, int z, LivingEntity attacker, double summonChance)
        {
            super(entity);
            this.world = world;
            this.x = x;
         ...
         */
        public ZurEntity getCustomSummonedAid1() { return customSummonedAid; }
        public void setCustomSummonedAid(ZurEntity customSummonedAid) { this.customSummonedAid = customSummonedAid; }
