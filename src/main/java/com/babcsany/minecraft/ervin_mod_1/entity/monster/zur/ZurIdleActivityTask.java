...
public class ZurIdleActivityTask<E extends MobEntity, T> extends Task<E> {
   ...
   public ZurIdleActivityTask(Predicate<E> p_i231513_1_, MemoryModuleType<? extends T> p_i231513_2_, MemoryModuleType<T> p_i231513_3_, RangedInteger p_i231513_4_) {
