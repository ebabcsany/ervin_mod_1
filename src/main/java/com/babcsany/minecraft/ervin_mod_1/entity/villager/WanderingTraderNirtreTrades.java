...
public class WanderingTraderNirtreTrades {
   ...
   static class EnchantedBookForEmeraldsTrade implements WanderingTraderNirtreTrades.ITrade {
      private final int xpValue;
   ...
   static class ItemWithPotionForEmeraldsAndItemsTrade implements WanderingTraderNirtreTrades.ITrade {
   ...
   static class ItemsForEmeraldsAndItemsTrade implements WanderingTraderNirtreTrades.ITrade {
