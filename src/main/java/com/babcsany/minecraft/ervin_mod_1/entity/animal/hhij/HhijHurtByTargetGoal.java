...
public class HhijHurtByTargetGoal extends TargetGoal {
   ...
   public HhijHurtByTargetGoal(HhijCreatureEntity creatureIn, Class<?>... excludeReinforcementTypes) {
   ...
   public HhijHurtByTargetGoal setCallsForHelp(Class<?>... reinforcementTypes) {
