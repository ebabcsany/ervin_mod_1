...
public class BowAttackGoal<T extends AbstractZurEntity> extends Goal {
   ...
   public BowAttackGoal(T mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
      this.entity = mob;
