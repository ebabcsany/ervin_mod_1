...
public class TakeBlockGoal extends Goal {
    ...
    public TakeBlockGoal(AbstractZurEntity zurIn) {
        this.zur = zurIn;
    }
    ...
    public void tick() {
        ...
        if (block.isIn(ModBlockTags.ZUR_HOLDABLE) && flag) {
            world.removeBlock(blockpos, false);
            this.zur.setHeldBlockState(blockstate.getBlock().getDefaultState());
        }
    }
}
