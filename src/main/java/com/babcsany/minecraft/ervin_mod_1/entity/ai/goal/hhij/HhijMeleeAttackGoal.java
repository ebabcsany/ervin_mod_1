...
public class HhijMeleeAttackGoal extends Goal {
   protected final HhijCreatureEntity attacker;
   ...
   public HhijMeleeAttackGoal(HhijCreatureEntity creature, double speedIn, boolean useLongMemory) {
