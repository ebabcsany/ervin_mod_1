...
public class GwurstEntity extends AnimalEntity {
   ...
   public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
      return MobEntity.func_233666_p_().createMutableAttribute(Attributes.MAX_HEALTH, 120.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.25D);
   }
   ...
   protected int getExperiencePoints(PlayerEntity player) {
      return this.isGwurstJockey() ? 10 : super.getExperiencePoints(player);
   }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      this.gwurstJockey = compound.getBoolean("IsChickenJockey");
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      compound.putBoolean("IsChickenJockey", this.gwurstJockey);
      compound.putInt("EggLayTime", this.timeUntilNextEgg);
   }

   public boolean canDespawn(double distanceToClosestPlayer) {
      return this.isGwurstJockey();
   }
    ...
    */
   public boolean isGwurstJockey() {
      return this.gwurstJockey;
   }

   /**
    * Sets whether this chicken is a jockey or not.
    */
   public void setGwurstJockey(boolean jockey) {
      this.gwurstJockey = jockey;
   }
}