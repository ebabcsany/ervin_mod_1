...
import com.babcsany.minecraft.ervin_mod_1.entity.monster.ZurAttackGoal;
...
public class ViltEntity extends AnimalEntity {

    private EatGrassGoal eatGrassGoal;
    private int eatingGrassTimer;
    private Object lightningBolt;

    public ViltEntity(EntityType<ViltEntity> entityType, World world) {
        super(entityType, world);
    }

    @Override
    public AgeableEntity createChild(AgeableEntity ageable) {
        ViltEntity entity = new ViltEntity(EntityInit.VILT_ENTITY.get(), this.world);
