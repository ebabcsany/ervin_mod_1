...
public class RandomWalkingGoal extends Goal {
   protected final DgrurbCreatureEntity creature;
   protected double x;
   protected double y;
   protected double z;
   ...
   private final boolean field_234053_h_;

   public RandomWalkingGoal(DgrurbCreatureEntity creatureIn, double speedIn) {
      this(creatureIn, speedIn, 120);
   }

   public RandomWalkingGoal(DgrurbCreatureEntity creatureIn, double speedIn, int chance) {
      this(creatureIn, speedIn, chance, true);
   }

   public RandomWalkingGoal(DgrurbCreatureEntity creature, double speed, int chance, boolean p_i231550_5_) {
