...
public abstract class AbstractDrurgbkFishEntity extends WaterDrurgbkMobEntity {
   ...
   public static boolean func_223363_b(EntityType<? extends AbstractDrurgbkFishEntity> type, IWorld worldIn, SpawnReason reason, BlockPos p_223363_3_, Random randomIn) {
   ...
   static class SwimGoal extends RandomSwimmingGoal {
      ...
      public SwimGoal(AbstractDrurgbkFishEntity fish) {
         super(fish, 1.0D, 40);
         this.fish = fish;
      }
