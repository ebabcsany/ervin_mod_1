...
public class HhijNonTamedTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
   private final HhijTameableEntity tameable;

   public HhijNonTamedTargetGoal(HhijTameableEntity tameableIn, Class<T> targetClassIn, boolean checkSight, @Nullable Predicate<LivingEntity> targetPredicate) {
