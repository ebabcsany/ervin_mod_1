...
public abstract class HhijAgeableEntity extends HhijCreatureEntity {
   ...
   protected HhijAgeableEntity(EntityType<? extends HhijAgeableEntity> type, World worldIn) {
      super(type, worldIn);
   }

   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      if (spawnDataIn == null) {
         spawnDataIn = new HhijAgeableEntity.AgeableData();
      }

      HhijAgeableEntity.AgeableData ageableentity$ageabledata = (HhijAgeableEntity.AgeableData)spawnDataIn;
   ...
   @Nullable
   public abstract HhijAgeableEntity createChild(HhijAgeableEntity ageable);
