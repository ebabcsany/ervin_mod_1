...
public class HhijFollowOwnerGoal extends Goal {
   ...
   public HhijFollowOwnerGoal(HhijTameableEntity tameable, double speed, float minDist, float maxDist, boolean teleportToLeaves) {
