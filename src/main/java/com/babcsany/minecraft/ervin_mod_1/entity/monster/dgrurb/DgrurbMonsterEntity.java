...
public abstract class DgrurbMonsterEntity extends DgrurbCreatureEntity implements IMob {
   protected DgrurbMonsterEntity(EntityType<? extends DgrurbMonsterEntity> type, World worldIn) {
      super(type, worldIn);
    ...
    */
   public static boolean canMonsterSpawnInLight(EntityType<? extends DgrurbMobEntity> type, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
    ...
    */
   public static boolean canMonsterSpawn(EntityType<? extends DgrurbMobEntity> type, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
