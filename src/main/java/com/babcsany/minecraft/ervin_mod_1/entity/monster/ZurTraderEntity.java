...
public abstract class ZurTraderEntity extends AgeableEntity implements IMob {
   ...
   private final Inventory zurtraderInventory = new Inventory(8);

   protected ZurTraderEntity(EntityType<? extends ZurTraderEntity> type, World worldIn) {
      super(type, worldIn);
    ...
    */
   public static boolean canMonsterSpawnInLight(EntityType<? extends ZurTraderEntity> type, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
    ...
    */
   public static boolean canMonsterSpawn(EntityType<? extends ZurTraderEntity> type, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
