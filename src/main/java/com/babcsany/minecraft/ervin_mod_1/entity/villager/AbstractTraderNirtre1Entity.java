...
public abstract class AbstractTraderNirtre1Entity extends AgeableEntity implements INPC, IMerchant {
   private static final DataParameter<Integer> SHAKE_HEAD_TICKS = EntityDataManager.createKey(AbstractTraderNirtre1Entity.class, DataSerializers.VARINT);
   @Nullable
   ...
   public void onTrade(MerchantOffer offer) {
      ...
      this.onTraderNirtre1Trade(offer);
      if (this.customer instanceof ServerPlayerEntity) {
         ModCriteriaTriggers.TRADER_NIRTRE1_TRADE.test((ServerPlayerEntity)this.customer, this, offer.getSellingStack());
      }

   }

   protected abstract void onTraderNirtre1Trade(MerchantOffer offer);
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      compound.put("Inventory", this.traderNirtreInventory.write());
   }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      this.traderNirtreInventory.read(compound.getList("Inventory", 10));
   }
   ...
   public Inventory getTraderNirtre1Inventory() {
      return this.traderNirtreInventory;
   }
   ...
   public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
      if (super.replaceItemInInventory(inventorySlot, itemStackIn)) {
         ...
         if (i >= 0 && i < this.traderNirtreInventory.getSizeInventory()) {
            this.traderNirtreInventory.setInventorySlotContents(i, itemStackIn);
            return true;
         } else {
            return false;
         }
    ...
    */
   protected void addTrades(MerchantOffers givenMerchantOffers, TraderNirtreTrades.ITrade[] newTrades, int maxNumbers) {
      ...
      for(Integer integer : set) {
         TraderNirtreTrades.ITrade $tradertrades$itrade = newTrades[integer];
