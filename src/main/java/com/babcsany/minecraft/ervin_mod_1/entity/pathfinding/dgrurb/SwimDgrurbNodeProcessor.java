...
public class SwimDgrurbNodeProcessor extends DgrurbNodeProcessor {
   private final boolean field_205202_j;

   public SwimDgrurbNodeProcessor(boolean p_i48927_1_) {
   ...
   public PathNodeType getPathNodeType(IBlockReader blockaccessIn, int x, int y, int z, DgrurbMobEntity entityIn, int xSize, int ySize, int zSize, boolean canBreakDoorsIn, boolean canEnterDoorsIn) {
