...
public class HhijAvoidEntityGoal<T extends LivingEntity> extends Goal {
   protected final HhijCreatureEntity entity;
   ...
   public HhijAvoidEntityGoal(HhijCreatureEntity entityIn, Class<T> classToAvoidIn, float avoidDistanceIn, double farSpeedIn, double nearSpeedIn) {
      this(entityIn, classToAvoidIn, (p_200828_0_) -> true, avoidDistanceIn, farSpeedIn, nearSpeedIn, EntityPredicates.CAN_AI_TARGET::test);
   }

   public HhijAvoidEntityGoal(HhijCreatureEntity entityIn, Class<T> avoidClass, Predicate<LivingEntity> targetPredicate, float distance, double nearSpeedIn, double farSpeedIn, Predicate<LivingEntity> p_i48859_9_) {
   ...
   public HhijAvoidEntityGoal(HhijCreatureEntity entityIn, Class<T> avoidClass, float distance, double nearSpeedIn, double farSpeedIn, Predicate<LivingEntity> targetPredicate) {
   ...
   public boolean shouldExecute() {
      ...
      if (this.avoidTarget == null) {
         ...
         Vector3d vec3d = HhijRandomPositionGenerator.findRandomTargetBlockAwayFrom(this.entity, 16, 7, this.avoidTarget.getPositionVec());
         if (vec3d == null) {
            return false;
