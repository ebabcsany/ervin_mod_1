...
public abstract class DgrurbkTargetGoal extends Goal {
   ...
   public DgrurbkTargetGoal(DgrurbMobEntity mobIn, boolean checkSight) {
      this(mobIn, checkSight, false);
   }

   public DgrurbkTargetGoal(DgrurbMobEntity mobIn, boolean checkSight, boolean nearbyOnlyIn) {
   ...
   public boolean shouldContinueExecuting() {
      Entity livingentity = this.goalOwner.getAttackTarget();
   ...
   public DgrurbkTargetGoal setUnseenMemoryTicks(int unseenMemoryTicksIn) {
