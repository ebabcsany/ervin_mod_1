...
public class MeleeDgrurbkAttackGoal extends Goal {
   protected final DgrurbCreatureEntity attacker;
   ...
   public MeleeDgrurbkAttackGoal(DgrurbCreatureEntity creature, double speedIn, boolean useLongMemory) {
   ...
   public boolean shouldExecute() {
      ...
      if (i - this.field_220720_k < 20L) {
         ...
         Entity livingentity = this.attacker.getAttackTarget();
