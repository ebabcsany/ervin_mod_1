...
public abstract class AbstractTameableTraderNirtreEntity extends AnimalEntity {
   protected static final DataParameter<Byte> TAMED = EntityDataManager.createKey(AbstractTameableTraderNirtreEntity.class, DataSerializers.BYTE);
   protected static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.createKey(AbstractTameableTraderNirtreEntity.class, DataSerializers.OPTIONAL_UNIQUE_ID);
   private boolean field_233683_bw_;

   protected AbstractTameableTraderNirtreEntity(EntityType<? extends AbstractTameableTraderNirtreEntity> type, World worldIn) {
      super(type, worldIn);
      this.setupTamedAI();
   }
