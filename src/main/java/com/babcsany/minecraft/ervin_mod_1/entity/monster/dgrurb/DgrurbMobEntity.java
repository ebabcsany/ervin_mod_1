...
public abstract class DgrurbMobEntity extends LivingEntity {
   private static final DataParameter<Byte> AI_FLAGS = EntityDataManager.createKey(DgrurbMobEntity.class, DataSerializers.BYTE);
   public int livingSoundTime;
   protected int experienceValue;
   protected DgrurbLookController lookController;
   protected DgrurbMovementController moveController;
   protected DgrurbJumpController jumpController;
   private final DgrurbBodyController bodyController;
   protected DgrurbPathNavigator navigator;
   ...
   protected DgrurbPathNavigator createNavigator(World worldIn) {
      return new GroundDgrurbPathNavigator(this, worldIn);
   }
   ...
   public float getPathPriority(PathNodeType nodeType) {
      ...
      if (this.getRidingEntity() instanceof DgrurbMobEntity && ((DgrurbMobEntity)this.getRidingEntity()).func_230286_q_()) {
         mobentity = (DgrurbMobEntity)this.getRidingEntity();
      } else {
         mobentity = this;
      }
   ...
   protected DgrurbBodyController createBodyController() {
      return new DgrurbBodyController(this);
   }

   public DgrurbLookController getLookController() {
      return this.lookController;
   }

   public DgrurbMovementController getMoveHelper() {
      if (this.isPassenger() && this.getRidingEntity() instanceof DgrurbMobEntity) {
         DgrurbMobEntity mobentity = (DgrurbMobEntity)this.getRidingEntity();
   ...
   public DgrurbJumpController getJumpController() {
      return this.jumpController;
   }

   public DgrurbPathNavigator getNavigator() {
      if (this.isPassenger() && this.getRidingEntity() instanceof DgrurbMobEntity) {
         DgrurbMobEntity mobentity = (DgrurbMobEntity)this.getRidingEntity();
    ...
    */
   public DgrurbEntitySenses getEntitySenses() {
      return this.senses;
   }
   ...
   protected void updateMovementGoalFlags() {
      boolean flag = !(this.getControllingPassenger() instanceof DgrurbMobEntity);
   ...
   public void checkDespawn() {
      if (this.world.getDifficulty() == Difficulty.PEACEFUL && this.isDespawnPeaceful()) {
         ...
         net.minecraftforge.eventbus.api.Event.Result result = ForgeEventFactory.canDgrurbEntityDespawn(this);
   ...
   protected void sendDebugPackets() {
      DebugPacketSender.sendDgrurbGoal(this.world, this, this.goalSelector);
   }
    ...
    */
   public static boolean canSpawnOn(EntityType<? extends DgrurbMobEntity> typeIn, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
   ...
   private ActionResultType func_233661_c_(PlayerEntity p_233661_1_, Hand p_233661_2_) {
      ...
      if (itemstack.getItem() == Items.LEAD && this.canBeLeashedTo(p_233661_1_)) {
         ...
         if (itemstack.getItem() instanceof SpawnEggItem1) {
            if (!this.world.isRemote) {
               SpawnEggItem1 spawneggitem = (SpawnEggItem1)itemstack.getItem();
               Optional<DgrurbMobEntity> optional = spawneggitem.dgrurbMobEntity(p_233661_1_, this, (EntityType)this.getType(), this.world, this.getPositionVec(), itemstack);
   ...
   protected void onChildSpawnFromEgg(PlayerEntity playerIn, DgrurbMobEntity child) {
   }
   ...
   @Nullable
   protected <T extends DgrurbMobEntity> T func_233656_b_(EntityType<T> p_233656_1_) {
      if (this.removed) {
         return (T)null;
      } else {
