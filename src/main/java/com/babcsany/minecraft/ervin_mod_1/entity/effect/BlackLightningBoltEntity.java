...
public class BlackLightningBoltEntity extends Entity {
   ...
   public static boolean onEntityStruckByBlackLightning(Entity entity, BlackLightningBoltEntity bolt)
   {
      return MinecraftForge.EVENT_BUS.post(new EntityStruckByBlackLightningEvent(entity, bolt));
   }
