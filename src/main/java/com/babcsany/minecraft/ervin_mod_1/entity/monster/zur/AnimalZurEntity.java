...
import com.babcsany.minecraft.ervin_mod_1.entity.event.zur.BabyZurEntitySpawnEvent;
...
public abstract class AnimalZurEntity extends AgeableZurEntity {
   private int inLove;
   private UUID playerInLove;

   protected AnimalZurEntity(EntityType<? extends AnimalZurEntity> type, World worldIn) {
      super(type, worldIn);
    ...
    */
   public static boolean canAnimalSpawn(EntityType<? extends AnimalZurEntity> animal, IWorld worldIn, SpawnReason reason, BlockPos pos, Random random) {
   ...
   public ActionResultType func_231254_b_(PlayerEntity player, Hand hand) {
      ...
      return super.func_231254_b_(player, hand);
   }
   ...
   public void func_234177_a_(World world, AnimalZurEntity p_234177_2_) {
      AgeableZurEntity ageableentity = this.createChild(p_234177_2_);
       final BabyZurEntitySpawnEvent event = new BabyZurEntitySpawnEvent(this, p_234177_2_, ageableentity);
      ...
      if (ageableentity != null) {
         ...
         if (serverplayerentity != null) {
            serverplayerentity.addStat(ModStats.ZURS_BRED);
            CriteriaTriggers1.BRED_ZUR_ANIMALS_TRIGGER.trigger(serverplayerentity, this, p_234177_2_, ageableentity);
         }
