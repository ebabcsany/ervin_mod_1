...
public class ModBoatEntity extends BoatEntity {
   ...
   public ModBoatEntity(EntityType<? extends ModBoatEntity> boatEntityType, World world) {
   ...
   public Item getItemBoat() {
      switch(this.getModBoatType()) {
         default:
            return isBurnableItemInit.FIRG_BOAT.get();
         case FRIM:
   ...
   public Block getPlanks() {
      switch(this.getModBoatType()) {
         default:
            return BlockItemInit.FIRG_PLANKS.get();
         case FRIM:
            return BlockItemInit.FRIM_PLANKS.get();
      }
   }

   public ModBoatEntity.ModBoatType getModBoatType() {
      return ModBoatEntity.ModBoatType.byId(this.dataManager.get(MOD_BOAT_TYPE));
   }

   public void setModBoatType(ModBoatEntity.ModBoatType modBoatType) {
   ...
   protected void readAdditional(CompoundNBT compound) {
      if (compound.contains("Type", 8)) {
         this.setModBoatType(ModBoatEntity.ModBoatType.getTypeFromString(compound.getString("ModBoatType")));
      }
   ...
   public static enum ModBoatType {
      ...
      public static ModBoatEntity.ModBoatType byId(int id) {
         ModBoatEntity.ModBoatType[] aBYGBoatEntity$BYGType = values();
      ...
      public static ModBoatEntity.ModBoatType getTypeFromString(String nameIn) {
         ModBoatEntity.ModBoatType[] aModBoatEntity$BoatType = values();
         ModBoatEntity.ModBoatType[] var2 = aModBoatEntity$BoatType;
         int var3 = aModBoatEntity$BoatType.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            ModBoatEntity.ModBoatType BoatType = var2[var4];
