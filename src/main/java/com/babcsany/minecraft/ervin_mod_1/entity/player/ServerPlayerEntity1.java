...
public class ServerPlayerEntity1 extends ServerPlayerEntity implements IContainerListener {
   ...
   public ServerPlayerEntity1(MinecraftServer server, ServerWorld worldIn, GameProfile profile, PlayerInteractionManager interactionManagerIn) {
   ...
   private void func_205734_a(ServerWorld worldIn) {
      ...
      if (worldIn.func_230315_m_().hasSkyLight() && worldIn.getServer().func_240793_aU_().getGameType() != GameType.ADVENTURE) {
         ...
         for(int l1 = 0; l1 < i1; ++l1) {
            ...
            int j2 = i2 % (i * 2 + 1);
            int k2 = i2 / (i * 2 + 1);
            BlockPos blockpos1 = func_241092_a_(worldIn, blockpos.getX() + j2 - i, blockpos.getZ() + k2 - i, false);
            if (blockpos1 != null) {
   ...
   public boolean isSpectatedByPlayer(ServerPlayerEntity1 player) {
   ...
   public Either<SleepResult, Unit> trySleep(BlockPos at) {
      ...
      SleepResult ret = net.minecraftforge.event.ForgeEventFactory.onPlayerSleepInBed(this, optAt);
   ...
   public void copyFrom(ServerPlayerEntity1 that, boolean keepEverything) {
      if (keepEverything) {
