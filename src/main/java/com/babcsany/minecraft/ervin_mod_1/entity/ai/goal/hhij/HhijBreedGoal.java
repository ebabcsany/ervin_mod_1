...
public class HhijBreedGoal extends Goal {
   ...
   protected final HhijAnimalEntity animal;
   private final Class<? extends HhijAnimalEntity> mateClass;
   protected final World world;
   protected HhijAnimalEntity targetMate;
   private int spawnBabyDelay;
   private final double moveSpeed;

   public HhijBreedGoal(HhijAnimalEntity animal, double speedIn) {
      this(animal, speedIn, animal.getClass());
   }

   public HhijBreedGoal(HhijAnimalEntity animal, double moveSpeed, Class<? extends HhijAnimalEntity> mateClass) {
      this.animal = animal;
