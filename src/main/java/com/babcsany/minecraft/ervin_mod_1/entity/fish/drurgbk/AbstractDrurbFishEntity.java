...
public abstract class AbstractDrurbFishEntity extends WaterDrurbMobEntity {
   private static final DataParameter<Boolean> FROM_BUCKET = EntityDataManager.createKey(AbstractDrurbFishEntity.class, DataSerializers.BOOLEAN);

   public AbstractDrurbFishEntity(EntityType<? extends AbstractDrurbFishEntity> type, World worldIn) {
      super(type, worldIn);
   ...
   public static boolean func_223363_b(EntityType<? extends AbstractDrurbFishEntity> type, IWorld worldIn, SpawnReason reason, BlockPos p_223363_3_, Random randomIn) {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new AbstractDrurbFishEntity.SwimGoal(this));
   }
   ...
   static class MoveHelperController extends MovementController {
      private final AbstractDrurbFishEntity fish;

      MoveHelperController(AbstractDrurbFishEntity fish) {
         super(fish);
         this.fish = fish;
      }
   ...
   static class SwimGoal extends RandomSwimmingGoal {
      ...
      public SwimGoal(AbstractDrurbFishEntity fish) {
         super(fish, 1.0D, 40);
         this.fish = fish;
      }
