...
public abstract class DgrurbNodeProcessor {
   protected Region blockaccess;
   protected DgrurbMobEntity entity;
   ...
   public abstract PathNodeType getPathNodeType(IBlockReader blockaccessIn, int x, int y, int z, DgrurbMobEntity entitylivingIn, int xSize, int ySize, int zSize, boolean canBreakDoorsIn, boolean canEnterDoorsIn);
