package com.babcsany.minecraft.ervin_mod_1.entity.merchant.result_slot;
...
public class ZurResultSlot extends Slot {
   private final ZurInventory merchantInventory;
   private final PlayerEntity player;
   private int removeCount;
   private final IMerchant merchant;

   public ZurResultSlot(PlayerEntity player, IMerchant merchant, ZurInventory merchantInventory, int slotIndex, int xPosition, int yPosition) {
