...
/*public class SpawnGolemTask1 extends Task<ThuvrujEntity> {
   private long field_225461_a;

   public SpawnGolemTask1() {
   ...
   protected void startExecuting(ServerWorld worldIn, ThuvrujEntity entityIn, long gameTimeIn) {
      Brain<ThuvrujEntity> brain = entityIn.getBrain();
   ...
   protected void func_230251_a_(ServerWorld p_230251_1_, ThuvrujEntity p_230251_2_) {
   }
