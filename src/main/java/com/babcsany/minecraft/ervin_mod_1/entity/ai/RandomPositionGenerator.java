...
public class RandomPositionGenerator {
   ...
   @Nullable
   public static Vector3d findRandomTarget(DgrurbCreatureEntity entitycreatureIn, int xz, int y) {
      return func_226339_a_(entitycreatureIn, xz, y, 0, (Vector3d)null, true, (double)((float)Math.PI / 2F), entitycreatureIn::getBlockPathWeight, false, 0, 0, true);
   }
    ...
    */
   @Nullable
   public static Vector3d findRandomTargetBlockTowards(DgrurbCreatureEntity entitycreatureIn, int xz, int y, Vector3d targetVec3) {
   ...
   @Nullable
   public static Vector3d findRandomTargetTowardsScaled(DgrurbCreatureEntity p_203155_0_, int xz, int p_203155_2_, Vector3d p_203155_3_, double p_203155_4_) {
   ...
   @Nullable
   public static Vector3d findRandomTargetBlockAwayFrom(DgrurbCreatureEntity entitycreatureIn, int xz, int y, Vector3d targetVec3) {
      Vector3d vector3d = entitycreatureIn.getPositionVec().subtract(targetVec3);
      return func_226339_a_(entitycreatureIn, xz, y, 0, vector3d, true, (double)((float)Math.PI / 2F), entitycreatureIn::getBlockPathWeight, false, 0, 0, true);
   }
   ...
   @Nullable
   private static Vector3d func_226339_a_(DgrurbCreatureEntity p_226339_0_, int p_226339_1_, int p_226339_2_, int p_226339_3_, @Nullable Vector3d p_226339_4_, boolean p_226339_5_, double p_226339_6_, ToDoubleFunction<BlockPos> p_226339_8_, boolean p_226339_9_, int p_226339_10_, int p_226339_11_, boolean p_226339_12_) {
      DgrurbPathNavigator pathnavigator = p_226339_0_.getNavigator();
      Random random = p_226339_0_.getRNG();
      boolean flag;
      if (p_226339_0_.detachHome()) {
         flag = p_226339_0_.getHomePosition().withinDistance(p_226339_0_.getPositionVec(), (double)(p_226339_0_.getMaximumHomeDistance() + (float)p_226339_1_) + 1.0D);
