package com.babcsany.minecraft.ervin_mod_1.entity.monster.dgrurb.controller;
...
public class DgrurbLookController {
   ...
   public DgrurbLookController(DgrurbMobEntity mob) {
      this.mob = mob;
   }
