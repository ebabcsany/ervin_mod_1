...
public abstract class PatrollerEntity1 extends MonsterEntity1 {
   private BlockPos patrolTarget;
   private boolean patrolLeader;
   private boolean patrolling;

   protected PatrollerEntity1(EntityType<? extends PatrollerEntity1> p_i50201_1_, World worldIn) {
      super(p_i50201_1_, worldIn);
   }

   protected void registerGoals() {
      super.registerGoals();
      this.goalSelector.addGoal(4, new PatrollerEntity1.PatrolGoal<>(this, 0.7D, 0.595D));
   }
   ...
   public static boolean func_223330_b(EntityType<? extends PatrollerEntity1> patrollerType, IWorld worldIn, SpawnReason reason, BlockPos p_223330_3_, Random p_223330_4_) {
   ...
   public static class PatrolGoal<T extends PatrollerEntity1> extends Goal {
      ...
      public void tick() {
         ...
         if (pathnavigator.noPath()) {
            List<PatrollerEntity1> list = this.func_226544_g_();
            if (this.owner.isPatrolling() && list.isEmpty()) {
               ...
               if (!pathnavigator.tryMoveToXYZ((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ(), flag ? this.field_220841_c : this.field_220840_b)) {
                  ...
                  for(PatrollerEntity1 patrollerentity : list) {
      ...
      private List<PatrollerEntity1> func_226544_g_() {
         return this.owner.world.getEntitiesWithinAABB(PatrollerEntity1.class, this.owner.getBoundingBox().grow(16.0D), (p_226543_1_) -> {
