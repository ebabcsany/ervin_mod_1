...
public class FreinEntity extends MobEntity implements IMob {
    private static final DataParameter<Integer> FREIN_SIZE = EntityDataManager.createKey(com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.class, DataSerializers.VARINT);
    public float squishAmount;
    public float squishFactor;
    public float prevSquishFactor;
    private boolean wasOnGround;

    public FreinEntity(EntityType<? extends com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity> type, World worldIn) {
        super(type, worldIn);
        this.moveController = new com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.MoveHelperController(this);
    }

    protected void registerGoals() {
        this.goalSelector.addGoal(1, new com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.FloatGoal(this));
        this.goalSelector.addGoal(2, new com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.AttackGoal(this));
    ...
    public EntityType<? extends com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity> getType() {
        return (EntityType<? extends com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity>) super.getType();
    }
    ...
    public void remove(boolean keepData) {
        ...
        if (!this.world.isRemote && i > 1 && this.getHealth() <= 0.0F && !this.removed) {
            ...
            for(int k = 0; k < j; ++k) {
                ...
                com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity freinentity = this.getType().create(this.world);
                if (this.hasCustomName()) {
                    freinentity.setCustomName(this.getCustomName());
                }
                ...
                freinentity.setFreinSize(i / 2, true);
                freinentity.setLocationAndAngles(this.getPosX() + (double)f, this.getPosY() + 0.5D, this.getPosZ() + (double)f1, this.rand.nextFloat() * 360.0F, 0.0F);
    ...
    public static boolean func_223366_c(EntityType<com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity> p_223366_0_, IWorld p_223366_1_, SpawnReason reason, BlockPos p_223366_3_, Random randomIn) {
    ...
    static class AttackGoal extends Goal {
        private final com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity frein;
        private int growTieredTimer;

        public AttackGoal(com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity freinIn) {
            this.frein = freinIn;
        ...
        public boolean shouldExecute() {
            ...
            if (livingentity == null) {
                ...
                return livingentity instanceof PlayerEntity && ((PlayerEntity)livingentity).abilities.disableDamage ? false : this.frein.getMoveHelper() instanceof com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.MoveHelperController;
            }
        }
         ...
         */
        public void tick() {
            this.frein.faceEntity(this.frein.getAttackTarget(), 10.0F, 10.0F);
            ((com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.MoveHelperController)this.frein.getMoveHelper()).setDirection(this.frein.rotationYaw, this.frein.canDamagePlayer());
        }
    }
    ...
    static class FaceRandomGoal extends Goal {
        ...
        public FaceRandomGoal(com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity freinIn) {
            this.frein = freinIn;
            this.setMutexFlags(EnumSet.of(Goal.Flag.LOOK));
        }
         ...
         */
        public boolean shouldExecute() {
            return this.frein.getAttackTarget() == null && (this.frein.onGround || this.frein.isInWater() || this.frein.isInLava() || this.frein.isPotionActive(Effects.LEVITATION)) && this.frein.getMoveHelper() instanceof com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.MoveHelperController;
        }
        ...
        public void tick() {
            ...
            ((com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.MoveHelperController)this.frein.getMoveHelper()).setDirection(this.chosenDegrees, false);
        }
    }
    ...
    static class FloatGoal extends Goal {
        ...
        public FloatGoal(com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity freinIn) {
            this.frein = freinIn;
            this.setMutexFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
            freinIn.getNavigator().setCanSwim(true);
        }
         ...
         */
        public boolean shouldExecute() {
            return (this.frein.isInWater() || this.frein.isInLava()) && this.frein.getMoveHelper() instanceof com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.MoveHelperController;
        }
        ...
        public void tick() {
            ...
            ((com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.MoveHelperController)this.frein.getMoveHelper()).setSpeed(1.2D);
        }
    }
    ...
    static class HopGoal extends Goal {
        ...
        public HopGoal(com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity freinIn) {
            this.frein = freinIn;
            this.setMutexFlags(EnumSet.of(Goal.Flag.JUMP, Goal.Flag.MOVE));
        }
         ...
         */
        public void tick() {
            ((com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity.MoveHelperController)this.frein.getMoveHelper()).setSpeed(1.0D);
        }
    }
    ...
    static class MoveHelperController extends MovementController {
        ...
        public MoveHelperController(com.babcsany.minecraft.ervin_mod_1.entity.animal.FreinEntity freinIn) {
            super(freinIn);
            this.frein = freinIn;
            this.yRot = 180.0F * freinIn.rotationYaw / (float)Math.PI;
        }
                ...
                if (this.mob.onGround) {
                    ...
                    if (this.jumpDelay-- <= 0) {
                        ...
                        if (this.frein.makesSoundOnJump()) {
                            this.frein.playSound(this.frein.getJumpSound(), this.frein.getSoundVolume(), ((this.frein.getRNG().nextFloat() - this.frein.getRNG().nextFloat()) * 0.2F + 1.0F) * 0.8F);
                        }
                    } else {
