...
public class FreinEntity extends MobEntity implements IMob {
   ...
   static class AttackGoal extends Goal {
      private final FreinEntity slime;
      ...
      public void tick() {
         ...
         ((FreinEntity.MoveHelperController)this.slime.getMoveHelper()).setDirection(this.slime.rotationYaw, this.slime.canDamagePlayer());
      }
   }
   ...
   static class FaceRandomGoal extends Goal {
       ...
       */
      public boolean shouldExecute() {
         return this.slime.getAttackTarget() == null && (this.slime.onGround || this.slime.isInWater() || this.slime.isInLava() || this.slime.isPotionActive(Effects.LEVITATION)) && this.slime.getMoveHelper() instanceof FreinEntity.MoveHelperController;
      }
      ...
      public void tick() {
         ...
         ((FreinEntity.MoveHelperController)this.slime.getMoveHelper()).setDirection(this.chosenDegrees, false);
      }
   }
   ...
   static class FloatGoal extends Goal {
       ...
       */
      public boolean shouldExecute() {
         return (this.slime.isInWater() || this.slime.isInLava()) && this.slime.getMoveHelper() instanceof FreinEntity.MoveHelperController;
      }
      ...
      public void tick() {
         ...
         ((FreinEntity.MoveHelperController)this.slime.getMoveHelper()).setSpeed(1.2D);
      }
   }
   ...
   static class HopGoal extends Goal {
       ...
       */
      public void tick() {
         ((FreinEntity.MoveHelperController)this.slime.getMoveHelper()).setSpeed(1.0D);
      }
   }
