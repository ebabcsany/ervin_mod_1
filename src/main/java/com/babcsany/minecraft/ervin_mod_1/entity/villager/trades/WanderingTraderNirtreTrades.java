...
public class WanderingTraderNirtreTrades {
   public static final Int2ObjectMap<WanderingTraderNirtreTrades.ITrade[]> trade1 = gatAsIntMap(ImmutableMap.of(1, new WanderingTraderNirtreTrades.ITrade[]{
           ...
           new WanderingTraderNirtreTrades.ItemsForObsidiansTrade(BlockItems.TRIRIJ.get(), 10, 1, 1000, 2),
           new WanderingTraderNirtreTrades.ItemsForGrassBlocksTrade(ModSpawnEggItemInit.ZUR_SPAWN_EGG.get(), 4, 1, 9, 1),
           new WanderingTraderNirtreTrades.ItemsForDreinsTrade(ModSpawnEggItemInit.$_TRADER.get(), 10, 1, 40, 3),
           ...
           new WanderingTraderNirtreTrades.ItemsFor64NirtksAndBlocksTrade(isBurnableBlockItemInit.NIRTKB.get(), 64, BlockItemInit_.EPKIN.get(), 1, 1000, 1),
           ...
           new WanderingTraderNirtreTrades.ItemsForNirtksAndBlocksTrade(UnusedBlockItems.get("air"), 1, isBurnableBlockItemInit.NIRTKB.get(), 1, 1000, 1),
   ...
   static class ItemsFor40EpkinsAndItemsTrade implements WanderingTraderNirtreTrades.ITrade {
      ...
      @Nullable
      public MerchantOffer getOffer(Entity trader, Random rand) {
         return new MerchantOffer(new ItemStack(BlockItemInit_.EPKIN.get(), this.epkinCount), new ItemStack(this.buyingItem.getItem(), this.buyingItemCount), new ItemStack(this.sellingItem.getItem(), this.sellingItemCount), this.maxUses, this.xpValue, this.priceMultiplier);
      }
   }
   ...
   static class ItemsForFirtBlocksTrade implements WanderingTraderNirtreTrades.ITrade {
      ...
      public MerchantOffer getOffer(Entity trader, Random rand) {
         return new MerchantOffer(new ItemStack(BlockItems.FIRT_BLOCK.get(), this.firtBlockCount), new ItemStack(this.sellingItem.getItem(), this.sellingItemCount), this.maxUses, this.xpValue, this.priceMultiplier);
      }
   }
