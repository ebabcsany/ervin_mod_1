...
public abstract class MonsterEntity1 extends CreatureEntity implements IMob {
   protected MonsterEntity1(EntityType<? extends MonsterEntity1> type, World worldIn) {
      super(type, worldIn);
    ...
    */
   public static boolean canMonsterSpawn(EntityType<? extends MobEntity> type, IWorld worldIn, SpawnReason reason, BlockPos pos, Random randomIn) {
