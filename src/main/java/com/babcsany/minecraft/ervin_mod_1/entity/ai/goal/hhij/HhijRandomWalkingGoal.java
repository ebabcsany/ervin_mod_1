...
public class HhijRandomWalkingGoal extends Goal {
   protected final HhijCreatureEntity creature;
   protected double x;
   protected double y;
   protected double z;
   ...
   public HhijRandomWalkingGoal(HhijCreatureEntity creatureIn, double speedIn) {
      this(creatureIn, speedIn, 120);
   }

   public HhijRandomWalkingGoal(HhijCreatureEntity creatureIn, double speedIn, int chance) {
      this(creatureIn, speedIn, chance, true);
   }

   public HhijRandomWalkingGoal(HhijCreatureEntity creature, double speed, int chance, boolean p_i231550_5_) {
   ...
   protected Vector3d getPosition() {
      return HhijRandomPositionGenerator.findRandomTarget(this.creature, 10, 7);
   }
