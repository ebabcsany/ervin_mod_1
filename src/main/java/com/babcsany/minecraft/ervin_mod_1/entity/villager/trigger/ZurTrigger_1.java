...
public class ZurTrigger_1 extends AbstractCriterionTrigger<ZurTrigger_1.Instance> {
   ...
   public ZurTrigger_1.Instance deserializeTrigger(JsonObject json, EntityPredicate.AndPredicate entityPredicate, ConditionArrayParser conditionsParser) {
      ...
      return new ZurTrigger_1.Instance(entityPredicate, entitypredicate$andpredicate, itempredicate);
   }
   ...
   public static class Instance extends CriterionInstance {
      ...
      public static ZurTrigger_1.Instance any() {
         return new ZurTrigger_1.Instance(EntityPredicate.AndPredicate.ANY_AND, EntityPredicate.AndPredicate.ANY_AND, ItemPredicate.ANY);
      }
