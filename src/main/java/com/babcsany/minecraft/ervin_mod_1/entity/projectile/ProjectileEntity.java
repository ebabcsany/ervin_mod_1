...
public abstract class ProjectileEntity extends Entity {
   ...
   protected void func_230299_a_(BlockRayTraceResult p_230299_1_) {
      ...
      this.onProjectileCollision(this.world, blockstate, p_230299_1_, this);
   }

   public void onProjectileCollision(World worldIn, BlockState state, BlockRayTraceResult hit, com.babcsany.minecraft.ervin_mod_1.entity.projectile.ProjectileEntity projectile) {
      this.onProjectileCollision1(worldIn, state, hit, projectile);
   }

   @Deprecated
   public void onProjectileCollision1(World worldIn, BlockState state, BlockRayTraceResult hit, com.babcsany.minecraft.ervin_mod_1.entity.projectile.ProjectileEntity projectile) {
   }
