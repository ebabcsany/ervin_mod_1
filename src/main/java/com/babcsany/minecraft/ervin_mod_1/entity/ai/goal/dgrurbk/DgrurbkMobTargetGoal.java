...
public abstract class DgrurbkMobTargetGoal extends Goal {
   /** The entity that this goal belongs to */
   protected final DgrurbMobEntity goalOwner;
   ...
   public DgrurbkMobTargetGoal(DgrurbMobEntity mobIn, boolean checkSight) {
      this(mobIn, checkSight, false);
   }

   public DgrurbkMobTargetGoal(DgrurbMobEntity mobIn, boolean checkSight, boolean nearbyOnlyIn) {
   ...
   public boolean shouldContinueExecuting() {
      LivingEntity livingentity = this.goalOwner.getAttackLivingTarget();
   ...
   public DgrurbkMobTargetGoal setUnseenMemoryTicks(int unseenMemoryTicksIn) {
