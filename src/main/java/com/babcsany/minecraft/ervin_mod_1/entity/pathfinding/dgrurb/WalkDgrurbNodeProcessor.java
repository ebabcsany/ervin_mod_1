...
public class WalkDgrurbNodeProcessor extends DgrurbNodeProcessor {
   ...
   public void func_225578_a_(Region p_225578_1_, DgrurbMobEntity p_225578_2_) {
    ...
    * {@link net.minecraft.pathfinding.WalkNodeProcessor WalkNodeProcessor} uses this to change its field {@link
    * net.minecraft.pathfinding.WalkNodeProcessor#avoidsWater avoidsWater}
    */
   ...
   public PathNodeType getPathNodeType(IBlockReader blockaccessIn, int x, int y, int z, DgrurbMobEntity entitylivingIn, int xSize, int ySize, int zSize, boolean canBreakDoorsIn, boolean canEnterDoorsIn) {
   ...
   private PathNodeType getPathNodeType(DgrurbMobEntity entitylivingIn, BlockPos pos) {
      return this.func_237230_a_(entitylivingIn, pos.getX(), pos.getY(), pos.getZ());
   }

   private PathNodeType func_237230_a_(DgrurbMobEntity p_237230_1_, int p_237230_2_, int p_237230_3_, int p_237230_4_) {
