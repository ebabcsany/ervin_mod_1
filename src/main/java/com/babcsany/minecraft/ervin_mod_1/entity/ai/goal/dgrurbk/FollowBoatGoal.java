...
public class FollowBoatGoal extends Goal {
   ...
   private final DgrurbCreatureEntity swimmer;
   private PlayerEntity player;
   private BoatGoals field_205146_d;

   public FollowBoatGoal(DgrurbCreatureEntity swimmer) {
   ...
   public void tick() {
      ...
      if (--this.field_205143_a <= 0) {
         ...
         if (this.field_205146_d == BoatGoals.GO_TO_BOAT) {
            ...
            this.swimmer.getNavigator().tryMoveToXYZ(blockpos.getX(), blockpos.getY(), blockpos.getZ(), 1.0D);
            ...
            this.swimmer.getNavigator().tryMoveToXYZ(blockpos1.getX(), blockpos1.getY() - 1, blockpos1.getZ(), 1.0D);
