...
package com.babcsany.minecraft.ervin_mod_1.event.entity.living;
 ...
 * {//@link LivingEntity#setAttackTarget(EntityLivingBase)} and
 ...
 **/
public class EntitySetAttackTargetEvent extends EntityEvent
{

    private final Entity target;
    public EntitySetAttackTargetEvent(Entity entity, Entity target)
    {
        super(entity);
        this.target = target;
    }
