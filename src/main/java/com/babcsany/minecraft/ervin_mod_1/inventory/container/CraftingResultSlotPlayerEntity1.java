...
public class CraftingResultSlotPlayerEntity1 extends Slot {
   private final CraftingInventory craftMatrix;
   private final PlayerEntity1 player;
   private int amountCrafted;

   public CraftingResultSlotPlayerEntity1(PlayerEntity1 player, CraftingInventory craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
