...
public final class ModBlockTags {
    ...
    public static final ITag.INamedTag<Block> ZUR_HOLDABLE = createTag("zur_holdable");
    public static final ITag.INamedTag<Block> LIVING_GUBROV_FLUIDS = createTag("living_gubrov_fluids");
