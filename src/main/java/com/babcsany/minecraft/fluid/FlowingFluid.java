...
public abstract class FlowingFluid extends com.babcsany.minecraft.fluid.Fluid {
   ...
   public Vector3d getFlow(IBlockReader blockReader, BlockPos pos, FluidState fluidState) {
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         ...
         if (this.isSameOrEmpty(fluidstate)) {
            ...
            if (f1 != 0.0F) {
               d0 += (float)direction.getXOffset() * f1;
               d1 += (float)direction.getZOffset() * f1;
            }
         }
      }
   ...
   private boolean isSameOrEmpty(FluidState state) {
      return state.isEmpty() || state.getFluid().isEquivalentTo(fluid);
   }
   ...
   protected boolean causesDownwardCurrent(IBlockReader worldIn, BlockPos neighborPos, Direction side) {
      ...
      if (fluidstate.getFluid().isEquivalentTo(fluid)) {
         ...
         return blockstate.getMaterial() != Material.ICE && blockstate.isSolidSide(worldIn, neighborPos, side);
      }
   }
   ...
   protected FluidState calculateCorrectFlowingState(IWorldReader worldIn, BlockPos pos, BlockState blockStateIn) {
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         ...
         if (fluidstate.getFluid().isEquivalentTo(fluid) && this.doesSideHaveHoles(direction, worldIn, pos, blockStateIn, blockpos, blockstate)) {
      ...
      if (!fluidstate2.isEmpty() && fluidstate2.getFluid().isEquivalentTo(fluid) && this.doesSideHaveHoles(Direction.UP, worldIn, pos, blockStateIn, blockpos1, blockstate2)) {
   ...
   private boolean func_211759_a(IBlockReader p_211759_1_, Fluid p_211759_2_, BlockPos p_211759_3_, BlockState p_211759_4_, BlockPos p_211759_5_, BlockState p_211759_6_) {
      if (!this.doesSideHaveHoles(Direction.DOWN, p_211759_1_, p_211759_3_, p_211759_4_, p_211759_5_, p_211759_6_)) {
         ...
         return p_211759_6_.getFluidState().getFluid().isEquivalentTo(fluid) || this.isBlocked(p_211759_1_, p_211759_5_, p_211759_6_, p_211759_2_);
      }
   }
   ...
   private boolean isSameAs(FluidState stateIn) {
      return stateIn.getFluid().isEquivalentTo(fluid) && stateIn.isSource();
   }
   ...
   protected int func_215667_a(World p_215667_1_, BlockPos p_215667_2_, FluidState p_215667_3_, FluidState p_215667_4_) {
      return fluid.getTickRate(p_215667_1_);
   }
   ...
   public VoxelShape func_215664_b(FluidState p_215664_1_, IBlockReader p_215664_2_, BlockPos p_215664_3_) {
      return p_215664_1_.getLevel() == 9 && isFullHeight(p_215664_1_, p_215664_2_, p_215664_3_) ? VoxelShapes.fullCube() : this.field_215669_f.computeIfAbsent(p_215664_1_, (p_215668_2_) -> VoxelShapes.create(0.0D, 0.0D, 0.0D, 1.0D, (double)p_215668_2_.getActualHeight(p_215664_2_, p_215664_3_), 1.0D));
   }
}
