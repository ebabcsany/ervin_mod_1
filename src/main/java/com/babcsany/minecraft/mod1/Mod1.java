package com.babcsany.minecraft.mod1;

import com.babcsany.minecraft.mod1.init.*;
...
public class Mod1 {
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("mod1", "helloworld", () -> {
    ...
    public static class ForgeEvents {
        ...
        public static void onLeftClickBlock(final PlayerInteractEvent.LeftClickBlock event) {
            ...
            ResourceLocation MaterialBlocksTagId = new ResourceLocation(Mod1.MOD_ID, "material_blocks");
