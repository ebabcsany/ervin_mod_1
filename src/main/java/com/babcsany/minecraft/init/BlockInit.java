...
public class BlockInit {
    ...
    public static final RegistryObject<Block> FIRG_PLANKS_STAIRS = REGISTER_BLOCKS.register("firg_planks_stairs", () -> new StairsBlock(FIRG_PLANKS::getDefaultState, Block.Properties.from(FIRG_PLANKS)));
