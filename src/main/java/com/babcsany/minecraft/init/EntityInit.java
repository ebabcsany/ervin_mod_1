...
public class EntityInit {
    ...
    public static final EntityType<GubrovEntity> GUBROV = register("gubrov", EntityType.Builder.create(GubrovEntity::new, EntityClassification.WATER_CREATURE).size(0.7f, 0.4f).func_233606_a_(10));
