...
import static net.minecraftforge.common.ForgeHooks.createVanillaFluidAttributes;
...
public class FluidInit extends Fluids {
    ...
    /*public static final ForgeFlowingFluid.Properties MILK_PROPERTIES = new FluidAttributes.Builder(
    ...
    protected void initAtlasSprites() {
        this.atlasSpritesJurk[0] = Minecraft.getInstance().getModelManager().getBlockModelShapes().getModel(BlockInit.JURK.getDefaultState()).getParticleTexture();
     ...
     */
    protected static net.minecraftforge.fluids.FluidAttributes createAttributes()
    {
        return createVanillaFluidAttributes(fluid);
    }

    private static net.minecraftforge.fluids.FluidAttributes forgeFluidAttributes;
    public static net.minecraftforge.fluids.FluidAttributes getAttributes() {
    ...
    public boolean render(IBlockDisplayReader lightReaderIn, BlockPos posIn, IVertexBuilder vertexBuilderIn, FluidState fluidStateIn) {
        ...
        int i = getAttributes().getColor(lightReaderIn, posIn);
