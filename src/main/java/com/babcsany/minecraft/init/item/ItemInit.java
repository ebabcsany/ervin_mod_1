...
public class ItemInit {
    ...
    public static final Item FIRG_BOAT = register("firg_boat", new BoatItem(BoatEntity.Type.getTypeFromString(Ervin_mod_1.MOD_ID + "firg"), (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
    public static final Item FRIM_BOAT = register("frim_boat", new BoatItem(BoatEntity.Type.getTypeFromString(Ervin_mod_1.MOD_ID + "frim"), (new Item.Properties()).maxStackSize(1).group(ItemGroup.TRANSPORTATION)));
