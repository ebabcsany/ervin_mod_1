...
public class H_u_fBlockInit {
    ...
    public static final RegistryObject<Block> UUUUUUUUUUUUUUUUUUUUUUUU = H_U_F_BLOCKS.register("uuuuuuuuuuuuuuuuuuuuuuuu", () -> new Tririj(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).setRequiresTool().tickRandomly().hardnessAndResistance(5000000.0F)));
