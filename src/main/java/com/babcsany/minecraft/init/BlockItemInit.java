...
public class BlockItemInit {
    ...
    public static final RegistryObject<Item> FIRG_PLANKS = ITEMS.register("firg_planks", () -> new BlockItem(BlockInit.FIRG_PLANKS, (new Item.Properties()).group(ItemGroup.BUILDING_BLOCKS)));
    ...
    public static final RegistryObject<Item> TRIRIJ = ITEMS.register("tririj", () -> new BlockItem(com.babcsany.minecraft.init.BlockInit.TRIRIJ.get(), (new Item.Properties()).isImmuneToFire().group(ItemGroup.MATERIALS)));
    public static final RegistryObject<Item> REUTRIEN = ITEMS.register("reutrien", () -> new BlockItem(BlockInit.REUTRIEN.get(), (new Item.Properties()).isImmuneToFire().group(ItemGroup.MATERIALS)));
}
