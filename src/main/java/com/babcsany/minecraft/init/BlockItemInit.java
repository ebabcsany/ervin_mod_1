...
public class BlockItemInit {
    ...
    public static final RegistryObject<Item> REUTRIEN = ITEMS.register("reutrien", () -> new BlockItem(BlockInit.REUTRIEN.get(), (new Item.Properties()).isBurnable().group(ItemGroup.MATERIALS)));
}
