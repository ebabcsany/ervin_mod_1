package com.babcsany.minecraft.forge;
...
public class FluidAttributes {
    ...
    /*public static class Jurk extends FluidAttributes
    {
        protected Jurk(Builder builder, Fluid fluid)
        {
            super(builder, fluid);
        }
        ...
        {
            return BiomeColors.getJurkColor(world, pos) | 0xA000FF00;
        }

        public static FluidAttributes.Builder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
            return new FluidAttributes.Builder(stillTexture, flowingTexture, FluidAttributes.Jurk::new);
        }
    }*/
}
