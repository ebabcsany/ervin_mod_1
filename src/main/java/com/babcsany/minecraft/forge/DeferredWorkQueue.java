...
public class DeferredWorkQueue
{
    ...
    private static final Executor deferredExecutor = r -> taskQueue.add(new DeferredWorkQueue.TaskInfo(currentOwner.get().getModInfo(), r));
     ...
     * {@link #runLaterChecked(DeferredWorkQueue.CheckedRunnable)}.
     * <p>
