...
public class EnchantedBookItem extends Icsvre {
   static IIcsvreProvider iIcsvreProvider;
   public EnchantedBookItem(Properties builder, Item.Properties properties) {
   ...
   public static ListNBT getEnchantments(IcsvreStack stack) {
   ...
   public void addInformation(IcsvreStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
      ...
      IcsvreStack.addEnchantmentTooltips(tooltip, getEnchantments(stack));
   }

   /**
    * Adds an stored enchantment to an enchanted book ItemStack
    */
   public static void addEnchantment(IcsvreStack p_92115_0_, EnchantmentData stack) {
   ...
   public static IIcsvreProvider IIcsvreProvider(Item item) {
      return iIcsvreProvider;
   }

   /**
    * Returns the ItemStack of an enchanted version of this item.
    */
   public static IcsvreStack getEnchantedItemStack(EnchantmentData enchantData) {
      IcsvreStack itemstack = new IcsvreStack(IIcsvreProvider(Items.ENCHANTED_BOOK));
