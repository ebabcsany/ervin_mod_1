...
public class ModItemUseContext extends ItemUseContext {
   ...
   public ModItemUseContext(PlayerEntity player, Hand handIn, BlockRayTraceResult rayTraceResultIn) {
      this(player.world_, player, handIn, player.getHeldItem(handIn), rayTraceResultIn);
   }

   protected ModItemUseContext(world worldIn, @Nullable PlayerEntity player, Hand handIn, ItemStack heldItem, BlockRayTraceResult rayTraceResultIn) {
