package com.babcsany.minecraft.entity.ai.attributes;
...
public class AttributeModifierMap extends net.minecraft.entity.ai.attributes.AttributeModifierMap {
   ...
   public static class MutableAttribute extends net.minecraft.entity.ai.attributes.AttributeModifierMap.MutableAttribute {
