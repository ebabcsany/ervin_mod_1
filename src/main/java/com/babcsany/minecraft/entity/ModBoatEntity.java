...
public class ModBoatEntity extends Entity {
   ...
   private static final DataParameter<Boolean> LEFT_PADDLE = EntityDataManager.createKey(ModBoatEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> RIGHT_PADDLE = EntityDataManager.createKey(ModBoatEntity.class, DataSerializers.BOOLEAN);
   ...
   public ModBoatEntity(EntityType<? extends ModBoatEntity> p_i50129_1_, World world) {
   ...
   protected void registerData() {
      ...
      this.dataManager.register(BOAT_TYPE, Type.FIRG_PLANKS.ordinal());
   ...
   private ModBoatEntity.Status getBoatStatus() {
      ModBoatEntity.Status boatentity$status = this.getUnderwaterStatus();
            ...
            for(int i2 = i1; i2 < j1; ++i2) {
               ...
               if (fluidstate.isTagged(FluidTags.WATER) && d0 < (double)((float)blockpos$mutable.getY() + fluidstate.getActualHeight(this.world, blockpos$mutable))) {
                  if (!fluidstate.isSource()) {
                     return ModBoatEntity.Status.UNDER_FLOWING_WATER;
                  }
   ...
   public boolean canSwim() {
      return this.status == ModBoatEntity.Status.UNDER_WATER || this.status == ModBoatEntity.Status.UNDER_FLOWING_WATER;
   }
   ...
   public static enum Type {
      FIRG_PLANKS(BlockInit.FIRG_PLANKS, "firg_planks");
