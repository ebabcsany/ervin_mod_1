package com.babcsany.minecraft.potion;
...
public class PotionUtils extends net.minecraft.potion.PotionUtils {
   /**
   ...
   public static Potion getPotionFromItem(IcsvreStack icsvreIn) {
      return getPotionTypeFromNBT(icsvreIn.getTag());
   }
